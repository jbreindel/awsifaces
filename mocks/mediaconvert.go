...
// MediaconvertClient is an autogenerated mock type for the MediaconvertClient type
type MediaconvertClient struct {
	mock.Mock
}

// AssociateCertificate provides a mock function with given fields: ctx, params, optFns
func (_m *MediaconvertClient) AssociateCertificate(ctx context.Context, params *mediaconvert.AssociateCertificateInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.AssociateCertificateOutput, error) {
...
func (_m *MediaconvertClient) CancelJob(ctx context.Context, params *mediaconvert.CancelJobInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.CancelJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) CreateJob(ctx context.Context, params *mediaconvert.CreateJobInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.CreateJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) CreateJobTemplate(ctx context.Context, params *mediaconvert.CreateJobTemplateInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.CreateJobTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) CreatePreset(ctx context.Context, params *mediaconvert.CreatePresetInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.CreatePresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) CreateQueue(ctx context.Context, params *mediaconvert.CreateQueueInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.CreateQueueOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) DeleteJobTemplate(ctx context.Context, params *mediaconvert.DeleteJobTemplateInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.DeleteJobTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) DeletePolicy(ctx context.Context, params *mediaconvert.DeletePolicyInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.DeletePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) DeletePreset(ctx context.Context, params *mediaconvert.DeletePresetInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.DeletePresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) DeleteQueue(ctx context.Context, params *mediaconvert.DeleteQueueInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.DeleteQueueOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) DescribeEndpoints(ctx context.Context, params *mediaconvert.DescribeEndpointsInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.DescribeEndpointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) DisassociateCertificate(ctx context.Context, params *mediaconvert.DisassociateCertificateInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.DisassociateCertificateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) GetJob(ctx context.Context, params *mediaconvert.GetJobInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.GetJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) GetJobTemplate(ctx context.Context, params *mediaconvert.GetJobTemplateInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.GetJobTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) GetPolicy(ctx context.Context, params *mediaconvert.GetPolicyInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.GetPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) GetPreset(ctx context.Context, params *mediaconvert.GetPresetInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.GetPresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) GetQueue(ctx context.Context, params *mediaconvert.GetQueueInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.GetQueueOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) ListJobTemplates(ctx context.Context, params *mediaconvert.ListJobTemplatesInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.ListJobTemplatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) ListJobs(ctx context.Context, params *mediaconvert.ListJobsInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.ListJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) ListPresets(ctx context.Context, params *mediaconvert.ListPresetsInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.ListPresetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) ListQueues(ctx context.Context, params *mediaconvert.ListQueuesInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.ListQueuesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) ListTagsForResource(ctx context.Context, params *mediaconvert.ListTagsForResourceInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) Options() mediaconvert.Options {
	ret := _m.Called()
...
func (_m *MediaconvertClient) PutPolicy(ctx context.Context, params *mediaconvert.PutPolicyInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.PutPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) TagResource(ctx context.Context, params *mediaconvert.TagResourceInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) UntagResource(ctx context.Context, params *mediaconvert.UntagResourceInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) UpdateJobTemplate(ctx context.Context, params *mediaconvert.UpdateJobTemplateInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.UpdateJobTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) UpdatePreset(ctx context.Context, params *mediaconvert.UpdatePresetInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.UpdatePresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediaconvertClient) UpdateQueue(ctx context.Context, params *mediaconvert.UpdateQueueInput, optFns ...func(*mediaconvert.Options)) (*mediaconvert.UpdateQueueOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMediaconvertClient creates a new instance of MediaconvertClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMediaconvertClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MediaconvertClient {
	mock := &MediaconvertClient{}
	mock.Mock.Test(t)
