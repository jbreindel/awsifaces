...
// ElasticinferenceClient is an autogenerated mock type for the ElasticinferenceClient type
type ElasticinferenceClient struct {
	mock.Mock
}

// DescribeAcceleratorOfferings provides a mock function with given fields: ctx, params, optFns
func (_m *ElasticinferenceClient) DescribeAcceleratorOfferings(ctx context.Context, params *elasticinference.DescribeAcceleratorOfferingsInput, optFns ...func(*elasticinference.Options)) (*elasticinference.DescribeAcceleratorOfferingsOutput, error) {
...
func (_m *ElasticinferenceClient) DescribeAcceleratorTypes(ctx context.Context, params *elasticinference.DescribeAcceleratorTypesInput, optFns ...func(*elasticinference.Options)) (*elasticinference.DescribeAcceleratorTypesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticinferenceClient) DescribeAccelerators(ctx context.Context, params *elasticinference.DescribeAcceleratorsInput, optFns ...func(*elasticinference.Options)) (*elasticinference.DescribeAcceleratorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticinferenceClient) ListTagsForResource(ctx context.Context, params *elasticinference.ListTagsForResourceInput, optFns ...func(*elasticinference.Options)) (*elasticinference.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticinferenceClient) Options() elasticinference.Options {
	ret := _m.Called()
...
func (_m *ElasticinferenceClient) TagResource(ctx context.Context, params *elasticinference.TagResourceInput, optFns ...func(*elasticinference.Options)) (*elasticinference.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticinferenceClient) UntagResource(ctx context.Context, params *elasticinference.UntagResourceInput, optFns ...func(*elasticinference.Options)) (*elasticinference.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewElasticinferenceClient creates a new instance of ElasticinferenceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewElasticinferenceClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ElasticinferenceClient {
	mock := &ElasticinferenceClient{}
	mock.Mock.Test(t)
