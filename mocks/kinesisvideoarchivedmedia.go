...
// KinesisvideoarchivedmediaClient is an autogenerated mock type for the KinesisvideoarchivedmediaClient type
type KinesisvideoarchivedmediaClient struct {
	mock.Mock
}

// GetClip provides a mock function with given fields: ctx, params, optFns
func (_m *KinesisvideoarchivedmediaClient) GetClip(ctx context.Context, params *kinesisvideoarchivedmedia.GetClipInput, optFns ...func(*kinesisvideoarchivedmedia.Options)) (*kinesisvideoarchivedmedia.GetClipOutput, error) {
...
func (_m *KinesisvideoarchivedmediaClient) GetDASHStreamingSessionURL(ctx context.Context, params *kinesisvideoarchivedmedia.GetDASHStreamingSessionURLInput, optFns ...func(*kinesisvideoarchivedmedia.Options)) (*kinesisvideoarchivedmedia.GetDASHStreamingSessionURLOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisvideoarchivedmediaClient) GetHLSStreamingSessionURL(ctx context.Context, params *kinesisvideoarchivedmedia.GetHLSStreamingSessionURLInput, optFns ...func(*kinesisvideoarchivedmedia.Options)) (*kinesisvideoarchivedmedia.GetHLSStreamingSessionURLOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisvideoarchivedmediaClient) GetImages(ctx context.Context, params *kinesisvideoarchivedmedia.GetImagesInput, optFns ...func(*kinesisvideoarchivedmedia.Options)) (*kinesisvideoarchivedmedia.GetImagesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisvideoarchivedmediaClient) GetMediaForFragmentList(ctx context.Context, params *kinesisvideoarchivedmedia.GetMediaForFragmentListInput, optFns ...func(*kinesisvideoarchivedmedia.Options)) (*kinesisvideoarchivedmedia.GetMediaForFragmentListOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisvideoarchivedmediaClient) ListFragments(ctx context.Context, params *kinesisvideoarchivedmedia.ListFragmentsInput, optFns ...func(*kinesisvideoarchivedmedia.Options)) (*kinesisvideoarchivedmedia.ListFragmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisvideoarchivedmediaClient) Options() kinesisvideoarchivedmedia.Options {
	ret := _m.Called()
...
// NewKinesisvideoarchivedmediaClient creates a new instance of KinesisvideoarchivedmediaClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewKinesisvideoarchivedmediaClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *KinesisvideoarchivedmediaClient {
	mock := &KinesisvideoarchivedmediaClient{}
	mock.Mock.Test(t)
