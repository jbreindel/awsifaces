...
// IoteventsClient is an autogenerated mock type for the IoteventsClient type
type IoteventsClient struct {
	mock.Mock
}

// CreateAlarmModel provides a mock function with given fields: ctx, params, optFns
func (_m *IoteventsClient) CreateAlarmModel(ctx context.Context, params *iotevents.CreateAlarmModelInput, optFns ...func(*iotevents.Options)) (*iotevents.CreateAlarmModelOutput, error) {
...
func (_m *IoteventsClient) CreateDetectorModel(ctx context.Context, params *iotevents.CreateDetectorModelInput, optFns ...func(*iotevents.Options)) (*iotevents.CreateDetectorModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) CreateInput(ctx context.Context, params *iotevents.CreateInputInput, optFns ...func(*iotevents.Options)) (*iotevents.CreateInputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DeleteAlarmModel(ctx context.Context, params *iotevents.DeleteAlarmModelInput, optFns ...func(*iotevents.Options)) (*iotevents.DeleteAlarmModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DeleteDetectorModel(ctx context.Context, params *iotevents.DeleteDetectorModelInput, optFns ...func(*iotevents.Options)) (*iotevents.DeleteDetectorModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DeleteInput(ctx context.Context, params *iotevents.DeleteInputInput, optFns ...func(*iotevents.Options)) (*iotevents.DeleteInputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DescribeAlarmModel(ctx context.Context, params *iotevents.DescribeAlarmModelInput, optFns ...func(*iotevents.Options)) (*iotevents.DescribeAlarmModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DescribeDetectorModel(ctx context.Context, params *iotevents.DescribeDetectorModelInput, optFns ...func(*iotevents.Options)) (*iotevents.DescribeDetectorModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DescribeDetectorModelAnalysis(ctx context.Context, params *iotevents.DescribeDetectorModelAnalysisInput, optFns ...func(*iotevents.Options)) (*iotevents.DescribeDetectorModelAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DescribeInput(ctx context.Context, params *iotevents.DescribeInputInput, optFns ...func(*iotevents.Options)) (*iotevents.DescribeInputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) DescribeLoggingOptions(ctx context.Context, params *iotevents.DescribeLoggingOptionsInput, optFns ...func(*iotevents.Options)) (*iotevents.DescribeLoggingOptionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) GetDetectorModelAnalysisResults(ctx context.Context, params *iotevents.GetDetectorModelAnalysisResultsInput, optFns ...func(*iotevents.Options)) (*iotevents.GetDetectorModelAnalysisResultsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListAlarmModelVersions(ctx context.Context, params *iotevents.ListAlarmModelVersionsInput, optFns ...func(*iotevents.Options)) (*iotevents.ListAlarmModelVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListAlarmModels(ctx context.Context, params *iotevents.ListAlarmModelsInput, optFns ...func(*iotevents.Options)) (*iotevents.ListAlarmModelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListDetectorModelVersions(ctx context.Context, params *iotevents.ListDetectorModelVersionsInput, optFns ...func(*iotevents.Options)) (*iotevents.ListDetectorModelVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListDetectorModels(ctx context.Context, params *iotevents.ListDetectorModelsInput, optFns ...func(*iotevents.Options)) (*iotevents.ListDetectorModelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListInputRoutings(ctx context.Context, params *iotevents.ListInputRoutingsInput, optFns ...func(*iotevents.Options)) (*iotevents.ListInputRoutingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListInputs(ctx context.Context, params *iotevents.ListInputsInput, optFns ...func(*iotevents.Options)) (*iotevents.ListInputsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) ListTagsForResource(ctx context.Context, params *iotevents.ListTagsForResourceInput, optFns ...func(*iotevents.Options)) (*iotevents.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) Options() iotevents.Options {
	ret := _m.Called()
...
func (_m *IoteventsClient) PutLoggingOptions(ctx context.Context, params *iotevents.PutLoggingOptionsInput, optFns ...func(*iotevents.Options)) (*iotevents.PutLoggingOptionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) StartDetectorModelAnalysis(ctx context.Context, params *iotevents.StartDetectorModelAnalysisInput, optFns ...func(*iotevents.Options)) (*iotevents.StartDetectorModelAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) TagResource(ctx context.Context, params *iotevents.TagResourceInput, optFns ...func(*iotevents.Options)) (*iotevents.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) UntagResource(ctx context.Context, params *iotevents.UntagResourceInput, optFns ...func(*iotevents.Options)) (*iotevents.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) UpdateAlarmModel(ctx context.Context, params *iotevents.UpdateAlarmModelInput, optFns ...func(*iotevents.Options)) (*iotevents.UpdateAlarmModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) UpdateDetectorModel(ctx context.Context, params *iotevents.UpdateDetectorModelInput, optFns ...func(*iotevents.Options)) (*iotevents.UpdateDetectorModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsClient) UpdateInput(ctx context.Context, params *iotevents.UpdateInputInput, optFns ...func(*iotevents.Options)) (*iotevents.UpdateInputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIoteventsClient creates a new instance of IoteventsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIoteventsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IoteventsClient {
	mock := &IoteventsClient{}
	mock.Mock.Test(t)
