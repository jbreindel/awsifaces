...
// SnowdevicemanagementClient is an autogenerated mock type for the SnowdevicemanagementClient type
type SnowdevicemanagementClient struct {
	mock.Mock
}

// CancelTask provides a mock function with given fields: ctx, params, optFns
func (_m *SnowdevicemanagementClient) CancelTask(ctx context.Context, params *snowdevicemanagement.CancelTaskInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.CancelTaskOutput, error) {
...
func (_m *SnowdevicemanagementClient) CreateTask(ctx context.Context, params *snowdevicemanagement.CreateTaskInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.CreateTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) DescribeDevice(ctx context.Context, params *snowdevicemanagement.DescribeDeviceInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.DescribeDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) DescribeDeviceEc2Instances(ctx context.Context, params *snowdevicemanagement.DescribeDeviceEc2InstancesInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.DescribeDeviceEc2InstancesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) DescribeExecution(ctx context.Context, params *snowdevicemanagement.DescribeExecutionInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.DescribeExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) DescribeTask(ctx context.Context, params *snowdevicemanagement.DescribeTaskInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.DescribeTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) ListDeviceResources(ctx context.Context, params *snowdevicemanagement.ListDeviceResourcesInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.ListDeviceResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) ListDevices(ctx context.Context, params *snowdevicemanagement.ListDevicesInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.ListDevicesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) ListExecutions(ctx context.Context, params *snowdevicemanagement.ListExecutionsInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.ListExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) ListTagsForResource(ctx context.Context, params *snowdevicemanagement.ListTagsForResourceInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) ListTasks(ctx context.Context, params *snowdevicemanagement.ListTasksInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.ListTasksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) Options() snowdevicemanagement.Options {
	ret := _m.Called()
...
func (_m *SnowdevicemanagementClient) TagResource(ctx context.Context, params *snowdevicemanagement.TagResourceInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SnowdevicemanagementClient) UntagResource(ctx context.Context, params *snowdevicemanagement.UntagResourceInput, optFns ...func(*snowdevicemanagement.Options)) (*snowdevicemanagement.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSnowdevicemanagementClient creates a new instance of SnowdevicemanagementClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSnowdevicemanagementClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SnowdevicemanagementClient {
	mock := &SnowdevicemanagementClient{}
	mock.Mock.Test(t)
