...
// CodestarnotificationsClient is an autogenerated mock type for the CodestarnotificationsClient type
type CodestarnotificationsClient struct {
	mock.Mock
}

// CreateNotificationRule provides a mock function with given fields: ctx, params, optFns
func (_m *CodestarnotificationsClient) CreateNotificationRule(ctx context.Context, params *codestarnotifications.CreateNotificationRuleInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.CreateNotificationRuleOutput, error) {
...
func (_m *CodestarnotificationsClient) DeleteNotificationRule(ctx context.Context, params *codestarnotifications.DeleteNotificationRuleInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.DeleteNotificationRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) DeleteTarget(ctx context.Context, params *codestarnotifications.DeleteTargetInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.DeleteTargetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) DescribeNotificationRule(ctx context.Context, params *codestarnotifications.DescribeNotificationRuleInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.DescribeNotificationRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) ListEventTypes(ctx context.Context, params *codestarnotifications.ListEventTypesInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.ListEventTypesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) ListNotificationRules(ctx context.Context, params *codestarnotifications.ListNotificationRulesInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.ListNotificationRulesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) ListTagsForResource(ctx context.Context, params *codestarnotifications.ListTagsForResourceInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) ListTargets(ctx context.Context, params *codestarnotifications.ListTargetsInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.ListTargetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) Options() codestarnotifications.Options {
	ret := _m.Called()
...
func (_m *CodestarnotificationsClient) Subscribe(ctx context.Context, params *codestarnotifications.SubscribeInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.SubscribeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) TagResource(ctx context.Context, params *codestarnotifications.TagResourceInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) Unsubscribe(ctx context.Context, params *codestarnotifications.UnsubscribeInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.UnsubscribeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) UntagResource(ctx context.Context, params *codestarnotifications.UntagResourceInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarnotificationsClient) UpdateNotificationRule(ctx context.Context, params *codestarnotifications.UpdateNotificationRuleInput, optFns ...func(*codestarnotifications.Options)) (*codestarnotifications.UpdateNotificationRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCodestarnotificationsClient creates a new instance of CodestarnotificationsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCodestarnotificationsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CodestarnotificationsClient {
	mock := &CodestarnotificationsClient{}
	mock.Mock.Test(t)
