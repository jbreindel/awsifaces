...
// Cloud9Client is an autogenerated mock type for the Cloud9Client type
type Cloud9Client struct {
	mock.Mock
}

// CreateEnvironmentEC2 provides a mock function with given fields: ctx, params, optFns
func (_m *Cloud9Client) CreateEnvironmentEC2(ctx context.Context, params *cloud9.CreateEnvironmentEC2Input, optFns ...func(*cloud9.Options)) (*cloud9.CreateEnvironmentEC2Output, error) {
...
func (_m *Cloud9Client) CreateEnvironmentMembership(ctx context.Context, params *cloud9.CreateEnvironmentMembershipInput, optFns ...func(*cloud9.Options)) (*cloud9.CreateEnvironmentMembershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) DeleteEnvironment(ctx context.Context, params *cloud9.DeleteEnvironmentInput, optFns ...func(*cloud9.Options)) (*cloud9.DeleteEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) DeleteEnvironmentMembership(ctx context.Context, params *cloud9.DeleteEnvironmentMembershipInput, optFns ...func(*cloud9.Options)) (*cloud9.DeleteEnvironmentMembershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) DescribeEnvironmentMemberships(ctx context.Context, params *cloud9.DescribeEnvironmentMembershipsInput, optFns ...func(*cloud9.Options)) (*cloud9.DescribeEnvironmentMembershipsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) DescribeEnvironmentStatus(ctx context.Context, params *cloud9.DescribeEnvironmentStatusInput, optFns ...func(*cloud9.Options)) (*cloud9.DescribeEnvironmentStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) DescribeEnvironments(ctx context.Context, params *cloud9.DescribeEnvironmentsInput, optFns ...func(*cloud9.Options)) (*cloud9.DescribeEnvironmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) ListEnvironments(ctx context.Context, params *cloud9.ListEnvironmentsInput, optFns ...func(*cloud9.Options)) (*cloud9.ListEnvironmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) ListTagsForResource(ctx context.Context, params *cloud9.ListTagsForResourceInput, optFns ...func(*cloud9.Options)) (*cloud9.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) Options() cloud9.Options {
	ret := _m.Called()
...
func (_m *Cloud9Client) TagResource(ctx context.Context, params *cloud9.TagResourceInput, optFns ...func(*cloud9.Options)) (*cloud9.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) UntagResource(ctx context.Context, params *cloud9.UntagResourceInput, optFns ...func(*cloud9.Options)) (*cloud9.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) UpdateEnvironment(ctx context.Context, params *cloud9.UpdateEnvironmentInput, optFns ...func(*cloud9.Options)) (*cloud9.UpdateEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloud9Client) UpdateEnvironmentMembership(ctx context.Context, params *cloud9.UpdateEnvironmentMembershipInput, optFns ...func(*cloud9.Options)) (*cloud9.UpdateEnvironmentMembershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCloud9Client creates a new instance of Cloud9Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCloud9Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *Cloud9Client {
	mock := &Cloud9Client{}
