...
// ImagebuilderClient is an autogenerated mock type for the ImagebuilderClient type
type ImagebuilderClient struct {
	mock.Mock
}

// CancelImageCreation provides a mock function with given fields: ctx, params, optFns
func (_m *ImagebuilderClient) CancelImageCreation(ctx context.Context, params *imagebuilder.CancelImageCreationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CancelImageCreationOutput, error) {
...
func (_m *ImagebuilderClient) CancelLifecycleExecution(ctx context.Context, params *imagebuilder.CancelLifecycleExecutionInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CancelLifecycleExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateComponent(ctx context.Context, params *imagebuilder.CreateComponentInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateContainerRecipe(ctx context.Context, params *imagebuilder.CreateContainerRecipeInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateContainerRecipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateDistributionConfiguration(ctx context.Context, params *imagebuilder.CreateDistributionConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateDistributionConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateImage(ctx context.Context, params *imagebuilder.CreateImageInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateImageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateImagePipeline(ctx context.Context, params *imagebuilder.CreateImagePipelineInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateImagePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateImageRecipe(ctx context.Context, params *imagebuilder.CreateImageRecipeInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateImageRecipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateInfrastructureConfiguration(ctx context.Context, params *imagebuilder.CreateInfrastructureConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateInfrastructureConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateLifecyclePolicy(ctx context.Context, params *imagebuilder.CreateLifecyclePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) CreateWorkflow(ctx context.Context, params *imagebuilder.CreateWorkflowInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.CreateWorkflowOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteComponent(ctx context.Context, params *imagebuilder.DeleteComponentInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteContainerRecipe(ctx context.Context, params *imagebuilder.DeleteContainerRecipeInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteContainerRecipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteDistributionConfiguration(ctx context.Context, params *imagebuilder.DeleteDistributionConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteDistributionConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteImage(ctx context.Context, params *imagebuilder.DeleteImageInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteImageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteImagePipeline(ctx context.Context, params *imagebuilder.DeleteImagePipelineInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteImagePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteImageRecipe(ctx context.Context, params *imagebuilder.DeleteImageRecipeInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteImageRecipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteInfrastructureConfiguration(ctx context.Context, params *imagebuilder.DeleteInfrastructureConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteInfrastructureConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteLifecyclePolicy(ctx context.Context, params *imagebuilder.DeleteLifecyclePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) DeleteWorkflow(ctx context.Context, params *imagebuilder.DeleteWorkflowInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.DeleteWorkflowOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetComponent(ctx context.Context, params *imagebuilder.GetComponentInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetComponentPolicy(ctx context.Context, params *imagebuilder.GetComponentPolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetComponentPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetContainerRecipe(ctx context.Context, params *imagebuilder.GetContainerRecipeInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetContainerRecipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetContainerRecipePolicy(ctx context.Context, params *imagebuilder.GetContainerRecipePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetContainerRecipePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetDistributionConfiguration(ctx context.Context, params *imagebuilder.GetDistributionConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetDistributionConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetImage(ctx context.Context, params *imagebuilder.GetImageInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetImageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetImagePipeline(ctx context.Context, params *imagebuilder.GetImagePipelineInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetImagePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetImagePolicy(ctx context.Context, params *imagebuilder.GetImagePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetImagePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetImageRecipe(ctx context.Context, params *imagebuilder.GetImageRecipeInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetImageRecipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetImageRecipePolicy(ctx context.Context, params *imagebuilder.GetImageRecipePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetImageRecipePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetInfrastructureConfiguration(ctx context.Context, params *imagebuilder.GetInfrastructureConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetInfrastructureConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetLifecycleExecution(ctx context.Context, params *imagebuilder.GetLifecycleExecutionInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetLifecycleExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetLifecyclePolicy(ctx context.Context, params *imagebuilder.GetLifecyclePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetWorkflow(ctx context.Context, params *imagebuilder.GetWorkflowInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetWorkflowOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetWorkflowExecution(ctx context.Context, params *imagebuilder.GetWorkflowExecutionInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetWorkflowExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) GetWorkflowStepExecution(ctx context.Context, params *imagebuilder.GetWorkflowStepExecutionInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.GetWorkflowStepExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ImportComponent(ctx context.Context, params *imagebuilder.ImportComponentInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ImportComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ImportVmImage(ctx context.Context, params *imagebuilder.ImportVmImageInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ImportVmImageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListComponentBuildVersions(ctx context.Context, params *imagebuilder.ListComponentBuildVersionsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListComponentBuildVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListComponents(ctx context.Context, params *imagebuilder.ListComponentsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListComponentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListContainerRecipes(ctx context.Context, params *imagebuilder.ListContainerRecipesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListContainerRecipesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListDistributionConfigurations(ctx context.Context, params *imagebuilder.ListDistributionConfigurationsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListDistributionConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImageBuildVersions(ctx context.Context, params *imagebuilder.ListImageBuildVersionsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImageBuildVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImagePackages(ctx context.Context, params *imagebuilder.ListImagePackagesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImagePackagesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImagePipelineImages(ctx context.Context, params *imagebuilder.ListImagePipelineImagesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImagePipelineImagesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImagePipelines(ctx context.Context, params *imagebuilder.ListImagePipelinesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImagePipelinesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImageRecipes(ctx context.Context, params *imagebuilder.ListImageRecipesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImageRecipesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImageScanFindingAggregations(ctx context.Context, params *imagebuilder.ListImageScanFindingAggregationsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImageScanFindingAggregationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImageScanFindings(ctx context.Context, params *imagebuilder.ListImageScanFindingsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImageScanFindingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListImages(ctx context.Context, params *imagebuilder.ListImagesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListImagesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListInfrastructureConfigurations(ctx context.Context, params *imagebuilder.ListInfrastructureConfigurationsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListInfrastructureConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListLifecycleExecutionResources(ctx context.Context, params *imagebuilder.ListLifecycleExecutionResourcesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListLifecycleExecutionResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListLifecycleExecutions(ctx context.Context, params *imagebuilder.ListLifecycleExecutionsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListLifecycleExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListLifecyclePolicies(ctx context.Context, params *imagebuilder.ListLifecyclePoliciesInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListLifecyclePoliciesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListTagsForResource(ctx context.Context, params *imagebuilder.ListTagsForResourceInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListWaitingWorkflowSteps(ctx context.Context, params *imagebuilder.ListWaitingWorkflowStepsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListWaitingWorkflowStepsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListWorkflowBuildVersions(ctx context.Context, params *imagebuilder.ListWorkflowBuildVersionsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListWorkflowBuildVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListWorkflowExecutions(ctx context.Context, params *imagebuilder.ListWorkflowExecutionsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListWorkflowExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListWorkflowStepExecutions(ctx context.Context, params *imagebuilder.ListWorkflowStepExecutionsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListWorkflowStepExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) ListWorkflows(ctx context.Context, params *imagebuilder.ListWorkflowsInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.ListWorkflowsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) Options() imagebuilder.Options {
	ret := _m.Called()
...
func (_m *ImagebuilderClient) PutComponentPolicy(ctx context.Context, params *imagebuilder.PutComponentPolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.PutComponentPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) PutContainerRecipePolicy(ctx context.Context, params *imagebuilder.PutContainerRecipePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.PutContainerRecipePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) PutImagePolicy(ctx context.Context, params *imagebuilder.PutImagePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.PutImagePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) PutImageRecipePolicy(ctx context.Context, params *imagebuilder.PutImageRecipePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.PutImageRecipePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) SendWorkflowStepAction(ctx context.Context, params *imagebuilder.SendWorkflowStepActionInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.SendWorkflowStepActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) StartImagePipelineExecution(ctx context.Context, params *imagebuilder.StartImagePipelineExecutionInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.StartImagePipelineExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) StartResourceStateUpdate(ctx context.Context, params *imagebuilder.StartResourceStateUpdateInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.StartResourceStateUpdateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) TagResource(ctx context.Context, params *imagebuilder.TagResourceInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) UntagResource(ctx context.Context, params *imagebuilder.UntagResourceInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) UpdateDistributionConfiguration(ctx context.Context, params *imagebuilder.UpdateDistributionConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.UpdateDistributionConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) UpdateImagePipeline(ctx context.Context, params *imagebuilder.UpdateImagePipelineInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.UpdateImagePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) UpdateInfrastructureConfiguration(ctx context.Context, params *imagebuilder.UpdateInfrastructureConfigurationInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.UpdateInfrastructureConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ImagebuilderClient) UpdateLifecyclePolicy(ctx context.Context, params *imagebuilder.UpdateLifecyclePolicyInput, optFns ...func(*imagebuilder.Options)) (*imagebuilder.UpdateLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewImagebuilderClient creates a new instance of ImagebuilderClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewImagebuilderClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ImagebuilderClient {
	mock := &ImagebuilderClient{}
	mock.Mock.Test(t)
