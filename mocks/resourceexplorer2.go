...
// Resourceexplorer2Client is an autogenerated mock type for the Resourceexplorer2Client type
type Resourceexplorer2Client struct {
	mock.Mock
}

// AssociateDefaultView provides a mock function with given fields: ctx, params, optFns
func (_m *Resourceexplorer2Client) AssociateDefaultView(ctx context.Context, params *resourceexplorer2.AssociateDefaultViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.AssociateDefaultViewOutput, error) {
...
func (_m *Resourceexplorer2Client) BatchGetView(ctx context.Context, params *resourceexplorer2.BatchGetViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.BatchGetViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) CreateIndex(ctx context.Context, params *resourceexplorer2.CreateIndexInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.CreateIndexOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) CreateView(ctx context.Context, params *resourceexplorer2.CreateViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.CreateViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) DeleteIndex(ctx context.Context, params *resourceexplorer2.DeleteIndexInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.DeleteIndexOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) DeleteView(ctx context.Context, params *resourceexplorer2.DeleteViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.DeleteViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) DisassociateDefaultView(ctx context.Context, params *resourceexplorer2.DisassociateDefaultViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.DisassociateDefaultViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) GetAccountLevelServiceConfiguration(ctx context.Context, params *resourceexplorer2.GetAccountLevelServiceConfigurationInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.GetAccountLevelServiceConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) GetDefaultView(ctx context.Context, params *resourceexplorer2.GetDefaultViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.GetDefaultViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) GetIndex(ctx context.Context, params *resourceexplorer2.GetIndexInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.GetIndexOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) GetView(ctx context.Context, params *resourceexplorer2.GetViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.GetViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) ListIndexes(ctx context.Context, params *resourceexplorer2.ListIndexesInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListIndexesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) ListIndexesForMembers(ctx context.Context, params *resourceexplorer2.ListIndexesForMembersInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListIndexesForMembersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) ListSupportedResourceTypes(ctx context.Context, params *resourceexplorer2.ListSupportedResourceTypesInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListSupportedResourceTypesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) ListTagsForResource(ctx context.Context, params *resourceexplorer2.ListTagsForResourceInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) ListViews(ctx context.Context, params *resourceexplorer2.ListViewsInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.ListViewsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) Options() resourceexplorer2.Options {
	ret := _m.Called()
...
func (_m *Resourceexplorer2Client) Search(ctx context.Context, params *resourceexplorer2.SearchInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.SearchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) TagResource(ctx context.Context, params *resourceexplorer2.TagResourceInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) UntagResource(ctx context.Context, params *resourceexplorer2.UntagResourceInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) UpdateIndexType(ctx context.Context, params *resourceexplorer2.UpdateIndexTypeInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.UpdateIndexTypeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Resourceexplorer2Client) UpdateView(ctx context.Context, params *resourceexplorer2.UpdateViewInput, optFns ...func(*resourceexplorer2.Options)) (*resourceexplorer2.UpdateViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewResourceexplorer2Client creates a new instance of Resourceexplorer2Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewResourceexplorer2Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *Resourceexplorer2Client {
	mock := &Resourceexplorer2Client{}
	mock.Mock.Test(t)
