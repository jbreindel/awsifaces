...
// MigrationhubClient is an autogenerated mock type for the MigrationhubClient type
type MigrationhubClient struct {
	mock.Mock
}

// AssociateCreatedArtifact provides a mock function with given fields: ctx, params, optFns
func (_m *MigrationhubClient) AssociateCreatedArtifact(ctx context.Context, params *migrationhub.AssociateCreatedArtifactInput, optFns ...func(*migrationhub.Options)) (*migrationhub.AssociateCreatedArtifactOutput, error) {
...
func (_m *MigrationhubClient) AssociateDiscoveredResource(ctx context.Context, params *migrationhub.AssociateDiscoveredResourceInput, optFns ...func(*migrationhub.Options)) (*migrationhub.AssociateDiscoveredResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) CreateProgressUpdateStream(ctx context.Context, params *migrationhub.CreateProgressUpdateStreamInput, optFns ...func(*migrationhub.Options)) (*migrationhub.CreateProgressUpdateStreamOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) DeleteProgressUpdateStream(ctx context.Context, params *migrationhub.DeleteProgressUpdateStreamInput, optFns ...func(*migrationhub.Options)) (*migrationhub.DeleteProgressUpdateStreamOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) DescribeApplicationState(ctx context.Context, params *migrationhub.DescribeApplicationStateInput, optFns ...func(*migrationhub.Options)) (*migrationhub.DescribeApplicationStateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) DescribeMigrationTask(ctx context.Context, params *migrationhub.DescribeMigrationTaskInput, optFns ...func(*migrationhub.Options)) (*migrationhub.DescribeMigrationTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) DisassociateCreatedArtifact(ctx context.Context, params *migrationhub.DisassociateCreatedArtifactInput, optFns ...func(*migrationhub.Options)) (*migrationhub.DisassociateCreatedArtifactOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) DisassociateDiscoveredResource(ctx context.Context, params *migrationhub.DisassociateDiscoveredResourceInput, optFns ...func(*migrationhub.Options)) (*migrationhub.DisassociateDiscoveredResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) ImportMigrationTask(ctx context.Context, params *migrationhub.ImportMigrationTaskInput, optFns ...func(*migrationhub.Options)) (*migrationhub.ImportMigrationTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) ListApplicationStates(ctx context.Context, params *migrationhub.ListApplicationStatesInput, optFns ...func(*migrationhub.Options)) (*migrationhub.ListApplicationStatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) ListCreatedArtifacts(ctx context.Context, params *migrationhub.ListCreatedArtifactsInput, optFns ...func(*migrationhub.Options)) (*migrationhub.ListCreatedArtifactsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) ListDiscoveredResources(ctx context.Context, params *migrationhub.ListDiscoveredResourcesInput, optFns ...func(*migrationhub.Options)) (*migrationhub.ListDiscoveredResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) ListMigrationTasks(ctx context.Context, params *migrationhub.ListMigrationTasksInput, optFns ...func(*migrationhub.Options)) (*migrationhub.ListMigrationTasksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) ListProgressUpdateStreams(ctx context.Context, params *migrationhub.ListProgressUpdateStreamsInput, optFns ...func(*migrationhub.Options)) (*migrationhub.ListProgressUpdateStreamsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) NotifyApplicationState(ctx context.Context, params *migrationhub.NotifyApplicationStateInput, optFns ...func(*migrationhub.Options)) (*migrationhub.NotifyApplicationStateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) NotifyMigrationTaskState(ctx context.Context, params *migrationhub.NotifyMigrationTaskStateInput, optFns ...func(*migrationhub.Options)) (*migrationhub.NotifyMigrationTaskStateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MigrationhubClient) Options() migrationhub.Options {
	ret := _m.Called()
...
func (_m *MigrationhubClient) PutResourceAttributes(ctx context.Context, params *migrationhub.PutResourceAttributesInput, optFns ...func(*migrationhub.Options)) (*migrationhub.PutResourceAttributesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMigrationhubClient creates a new instance of MigrationhubClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMigrationhubClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MigrationhubClient {
	mock := &MigrationhubClient{}
	mock.Mock.Test(t)
