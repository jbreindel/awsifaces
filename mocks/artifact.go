...
// ArtifactClient is an autogenerated mock type for the ArtifactClient type
type ArtifactClient struct {
	mock.Mock
}

// GetAccountSettings provides a mock function with given fields: ctx, params, optFns
func (_m *ArtifactClient) GetAccountSettings(ctx context.Context, params *artifact.GetAccountSettingsInput, optFns ...func(*artifact.Options)) (*artifact.GetAccountSettingsOutput, error) {
...
func (_m *ArtifactClient) GetReport(ctx context.Context, params *artifact.GetReportInput, optFns ...func(*artifact.Options)) (*artifact.GetReportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArtifactClient) GetReportMetadata(ctx context.Context, params *artifact.GetReportMetadataInput, optFns ...func(*artifact.Options)) (*artifact.GetReportMetadataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArtifactClient) GetTermForReport(ctx context.Context, params *artifact.GetTermForReportInput, optFns ...func(*artifact.Options)) (*artifact.GetTermForReportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArtifactClient) ListReports(ctx context.Context, params *artifact.ListReportsInput, optFns ...func(*artifact.Options)) (*artifact.ListReportsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArtifactClient) Options() artifact.Options {
	ret := _m.Called()
...
func (_m *ArtifactClient) PutAccountSettings(ctx context.Context, params *artifact.PutAccountSettingsInput, optFns ...func(*artifact.Options)) (*artifact.PutAccountSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewArtifactClient creates a new instance of ArtifactClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewArtifactClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ArtifactClient {
	mock := &ArtifactClient{}
