...
// OpsworkscmClient is an autogenerated mock type for the OpsworkscmClient type
type OpsworkscmClient struct {
	mock.Mock
}

// AssociateNode provides a mock function with given fields: ctx, params, optFns
func (_m *OpsworkscmClient) AssociateNode(ctx context.Context, params *opsworkscm.AssociateNodeInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.AssociateNodeOutput, error) {
...
func (_m *OpsworkscmClient) CreateBackup(ctx context.Context, params *opsworkscm.CreateBackupInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.CreateBackupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) CreateServer(ctx context.Context, params *opsworkscm.CreateServerInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.CreateServerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DeleteBackup(ctx context.Context, params *opsworkscm.DeleteBackupInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DeleteBackupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DeleteServer(ctx context.Context, params *opsworkscm.DeleteServerInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DeleteServerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DescribeAccountAttributes(ctx context.Context, params *opsworkscm.DescribeAccountAttributesInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DescribeAccountAttributesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DescribeBackups(ctx context.Context, params *opsworkscm.DescribeBackupsInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DescribeBackupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DescribeEvents(ctx context.Context, params *opsworkscm.DescribeEventsInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DescribeEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DescribeNodeAssociationStatus(ctx context.Context, params *opsworkscm.DescribeNodeAssociationStatusInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DescribeNodeAssociationStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DescribeServers(ctx context.Context, params *opsworkscm.DescribeServersInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DescribeServersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) DisassociateNode(ctx context.Context, params *opsworkscm.DisassociateNodeInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.DisassociateNodeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) ExportServerEngineAttribute(ctx context.Context, params *opsworkscm.ExportServerEngineAttributeInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.ExportServerEngineAttributeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) ListTagsForResource(ctx context.Context, params *opsworkscm.ListTagsForResourceInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) Options() opsworkscm.Options {
	ret := _m.Called()
...
func (_m *OpsworkscmClient) RestoreServer(ctx context.Context, params *opsworkscm.RestoreServerInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.RestoreServerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) StartMaintenance(ctx context.Context, params *opsworkscm.StartMaintenanceInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.StartMaintenanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) TagResource(ctx context.Context, params *opsworkscm.TagResourceInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) UntagResource(ctx context.Context, params *opsworkscm.UntagResourceInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) UpdateServer(ctx context.Context, params *opsworkscm.UpdateServerInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.UpdateServerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OpsworkscmClient) UpdateServerEngineAttributes(ctx context.Context, params *opsworkscm.UpdateServerEngineAttributesInput, optFns ...func(*opsworkscm.Options)) (*opsworkscm.UpdateServerEngineAttributesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewOpsworkscmClient creates a new instance of OpsworkscmClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewOpsworkscmClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *OpsworkscmClient {
	mock := &OpsworkscmClient{}
	mock.Mock.Test(t)
