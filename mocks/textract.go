...
// TextractClient is an autogenerated mock type for the TextractClient type
type TextractClient struct {
	mock.Mock
}

// AnalyzeDocument provides a mock function with given fields: ctx, params, optFns
func (_m *TextractClient) AnalyzeDocument(ctx context.Context, params *textract.AnalyzeDocumentInput, optFns ...func(*textract.Options)) (*textract.AnalyzeDocumentOutput, error) {
...
func (_m *TextractClient) AnalyzeExpense(ctx context.Context, params *textract.AnalyzeExpenseInput, optFns ...func(*textract.Options)) (*textract.AnalyzeExpenseOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) AnalyzeID(ctx context.Context, params *textract.AnalyzeIDInput, optFns ...func(*textract.Options)) (*textract.AnalyzeIDOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) CreateAdapter(ctx context.Context, params *textract.CreateAdapterInput, optFns ...func(*textract.Options)) (*textract.CreateAdapterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) CreateAdapterVersion(ctx context.Context, params *textract.CreateAdapterVersionInput, optFns ...func(*textract.Options)) (*textract.CreateAdapterVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) DeleteAdapter(ctx context.Context, params *textract.DeleteAdapterInput, optFns ...func(*textract.Options)) (*textract.DeleteAdapterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) DeleteAdapterVersion(ctx context.Context, params *textract.DeleteAdapterVersionInput, optFns ...func(*textract.Options)) (*textract.DeleteAdapterVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) DetectDocumentText(ctx context.Context, params *textract.DetectDocumentTextInput, optFns ...func(*textract.Options)) (*textract.DetectDocumentTextOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetAdapter(ctx context.Context, params *textract.GetAdapterInput, optFns ...func(*textract.Options)) (*textract.GetAdapterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetAdapterVersion(ctx context.Context, params *textract.GetAdapterVersionInput, optFns ...func(*textract.Options)) (*textract.GetAdapterVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetDocumentAnalysis(ctx context.Context, params *textract.GetDocumentAnalysisInput, optFns ...func(*textract.Options)) (*textract.GetDocumentAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetDocumentTextDetection(ctx context.Context, params *textract.GetDocumentTextDetectionInput, optFns ...func(*textract.Options)) (*textract.GetDocumentTextDetectionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetExpenseAnalysis(ctx context.Context, params *textract.GetExpenseAnalysisInput, optFns ...func(*textract.Options)) (*textract.GetExpenseAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetLendingAnalysis(ctx context.Context, params *textract.GetLendingAnalysisInput, optFns ...func(*textract.Options)) (*textract.GetLendingAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) GetLendingAnalysisSummary(ctx context.Context, params *textract.GetLendingAnalysisSummaryInput, optFns ...func(*textract.Options)) (*textract.GetLendingAnalysisSummaryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) ListAdapterVersions(ctx context.Context, params *textract.ListAdapterVersionsInput, optFns ...func(*textract.Options)) (*textract.ListAdapterVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) ListAdapters(ctx context.Context, params *textract.ListAdaptersInput, optFns ...func(*textract.Options)) (*textract.ListAdaptersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) ListTagsForResource(ctx context.Context, params *textract.ListTagsForResourceInput, optFns ...func(*textract.Options)) (*textract.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) Options() textract.Options {
	ret := _m.Called()
...
func (_m *TextractClient) StartDocumentAnalysis(ctx context.Context, params *textract.StartDocumentAnalysisInput, optFns ...func(*textract.Options)) (*textract.StartDocumentAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) StartDocumentTextDetection(ctx context.Context, params *textract.StartDocumentTextDetectionInput, optFns ...func(*textract.Options)) (*textract.StartDocumentTextDetectionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) StartExpenseAnalysis(ctx context.Context, params *textract.StartExpenseAnalysisInput, optFns ...func(*textract.Options)) (*textract.StartExpenseAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) StartLendingAnalysis(ctx context.Context, params *textract.StartLendingAnalysisInput, optFns ...func(*textract.Options)) (*textract.StartLendingAnalysisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) TagResource(ctx context.Context, params *textract.TagResourceInput, optFns ...func(*textract.Options)) (*textract.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) UntagResource(ctx context.Context, params *textract.UntagResourceInput, optFns ...func(*textract.Options)) (*textract.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TextractClient) UpdateAdapter(ctx context.Context, params *textract.UpdateAdapterInput, optFns ...func(*textract.Options)) (*textract.UpdateAdapterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewTextractClient creates a new instance of TextractClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTextractClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *TextractClient {
	mock := &TextractClient{}
