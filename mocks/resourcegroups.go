...
// ResourcegroupsClient is an autogenerated mock type for the ResourcegroupsClient type
type ResourcegroupsClient struct {
	mock.Mock
}

// CreateGroup provides a mock function with given fields: ctx, params, optFns
func (_m *ResourcegroupsClient) CreateGroup(ctx context.Context, params *resourcegroups.CreateGroupInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.CreateGroupOutput, error) {
...
func (_m *ResourcegroupsClient) DeleteGroup(ctx context.Context, params *resourcegroups.DeleteGroupInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.DeleteGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) GetAccountSettings(ctx context.Context, params *resourcegroups.GetAccountSettingsInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.GetAccountSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) GetGroup(ctx context.Context, params *resourcegroups.GetGroupInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.GetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) GetGroupConfiguration(ctx context.Context, params *resourcegroups.GetGroupConfigurationInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.GetGroupConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) GetGroupQuery(ctx context.Context, params *resourcegroups.GetGroupQueryInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.GetGroupQueryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) GetTags(ctx context.Context, params *resourcegroups.GetTagsInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.GetTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) GroupResources(ctx context.Context, params *resourcegroups.GroupResourcesInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.GroupResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) ListGroupResources(ctx context.Context, params *resourcegroups.ListGroupResourcesInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.ListGroupResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) ListGroups(ctx context.Context, params *resourcegroups.ListGroupsInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.ListGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) Options() resourcegroups.Options {
	ret := _m.Called()
...
func (_m *ResourcegroupsClient) PutGroupConfiguration(ctx context.Context, params *resourcegroups.PutGroupConfigurationInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.PutGroupConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) SearchResources(ctx context.Context, params *resourcegroups.SearchResourcesInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.SearchResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) Tag(ctx context.Context, params *resourcegroups.TagInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.TagOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) UngroupResources(ctx context.Context, params *resourcegroups.UngroupResourcesInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.UngroupResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) Untag(ctx context.Context, params *resourcegroups.UntagInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.UntagOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) UpdateAccountSettings(ctx context.Context, params *resourcegroups.UpdateAccountSettingsInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.UpdateAccountSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) UpdateGroup(ctx context.Context, params *resourcegroups.UpdateGroupInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.UpdateGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ResourcegroupsClient) UpdateGroupQuery(ctx context.Context, params *resourcegroups.UpdateGroupQueryInput, optFns ...func(*resourcegroups.Options)) (*resourcegroups.UpdateGroupQueryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewResourcegroupsClient creates a new instance of ResourcegroupsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewResourcegroupsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ResourcegroupsClient {
	mock := &ResourcegroupsClient{}
	mock.Mock.Test(t)
