...
// MarketplacecatalogClient is an autogenerated mock type for the MarketplacecatalogClient type
type MarketplacecatalogClient struct {
	mock.Mock
}

// BatchDescribeEntities provides a mock function with given fields: ctx, params, optFns
func (_m *MarketplacecatalogClient) BatchDescribeEntities(ctx context.Context, params *marketplacecatalog.BatchDescribeEntitiesInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.BatchDescribeEntitiesOutput, error) {
...
func (_m *MarketplacecatalogClient) CancelChangeSet(ctx context.Context, params *marketplacecatalog.CancelChangeSetInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.CancelChangeSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) DeleteResourcePolicy(ctx context.Context, params *marketplacecatalog.DeleteResourcePolicyInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.DeleteResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) DescribeChangeSet(ctx context.Context, params *marketplacecatalog.DescribeChangeSetInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.DescribeChangeSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) DescribeEntity(ctx context.Context, params *marketplacecatalog.DescribeEntityInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.DescribeEntityOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) GetResourcePolicy(ctx context.Context, params *marketplacecatalog.GetResourcePolicyInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.GetResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) ListChangeSets(ctx context.Context, params *marketplacecatalog.ListChangeSetsInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.ListChangeSetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) ListEntities(ctx context.Context, params *marketplacecatalog.ListEntitiesInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.ListEntitiesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) ListTagsForResource(ctx context.Context, params *marketplacecatalog.ListTagsForResourceInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) Options() marketplacecatalog.Options {
	ret := _m.Called()
...
func (_m *MarketplacecatalogClient) PutResourcePolicy(ctx context.Context, params *marketplacecatalog.PutResourcePolicyInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.PutResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) StartChangeSet(ctx context.Context, params *marketplacecatalog.StartChangeSetInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.StartChangeSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) TagResource(ctx context.Context, params *marketplacecatalog.TagResourceInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacecatalogClient) UntagResource(ctx context.Context, params *marketplacecatalog.UntagResourceInput, optFns ...func(*marketplacecatalog.Options)) (*marketplacecatalog.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMarketplacecatalogClient creates a new instance of MarketplacecatalogClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMarketplacecatalogClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MarketplacecatalogClient {
	mock := &MarketplacecatalogClient{}
	mock.Mock.Test(t)
