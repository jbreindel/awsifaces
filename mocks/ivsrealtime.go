...
// IvsrealtimeClient is an autogenerated mock type for the IvsrealtimeClient type
type IvsrealtimeClient struct {
	mock.Mock
}

// CreateEncoderConfiguration provides a mock function with given fields: ctx, params, optFns
func (_m *IvsrealtimeClient) CreateEncoderConfiguration(ctx context.Context, params *ivsrealtime.CreateEncoderConfigurationInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.CreateEncoderConfigurationOutput, error) {
...
func (_m *IvsrealtimeClient) CreateParticipantToken(ctx context.Context, params *ivsrealtime.CreateParticipantTokenInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.CreateParticipantTokenOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) CreateStage(ctx context.Context, params *ivsrealtime.CreateStageInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.CreateStageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) CreateStorageConfiguration(ctx context.Context, params *ivsrealtime.CreateStorageConfigurationInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.CreateStorageConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) DeleteEncoderConfiguration(ctx context.Context, params *ivsrealtime.DeleteEncoderConfigurationInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.DeleteEncoderConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) DeleteStage(ctx context.Context, params *ivsrealtime.DeleteStageInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.DeleteStageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) DeleteStorageConfiguration(ctx context.Context, params *ivsrealtime.DeleteStorageConfigurationInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.DeleteStorageConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) DisconnectParticipant(ctx context.Context, params *ivsrealtime.DisconnectParticipantInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.DisconnectParticipantOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) GetComposition(ctx context.Context, params *ivsrealtime.GetCompositionInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.GetCompositionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) GetEncoderConfiguration(ctx context.Context, params *ivsrealtime.GetEncoderConfigurationInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.GetEncoderConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) GetParticipant(ctx context.Context, params *ivsrealtime.GetParticipantInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.GetParticipantOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) GetStage(ctx context.Context, params *ivsrealtime.GetStageInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.GetStageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) GetStageSession(ctx context.Context, params *ivsrealtime.GetStageSessionInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.GetStageSessionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) GetStorageConfiguration(ctx context.Context, params *ivsrealtime.GetStorageConfigurationInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.GetStorageConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListCompositions(ctx context.Context, params *ivsrealtime.ListCompositionsInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListCompositionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListEncoderConfigurations(ctx context.Context, params *ivsrealtime.ListEncoderConfigurationsInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListEncoderConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListParticipantEvents(ctx context.Context, params *ivsrealtime.ListParticipantEventsInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListParticipantEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListParticipants(ctx context.Context, params *ivsrealtime.ListParticipantsInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListParticipantsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListStageSessions(ctx context.Context, params *ivsrealtime.ListStageSessionsInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListStageSessionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListStages(ctx context.Context, params *ivsrealtime.ListStagesInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListStagesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListStorageConfigurations(ctx context.Context, params *ivsrealtime.ListStorageConfigurationsInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListStorageConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) ListTagsForResource(ctx context.Context, params *ivsrealtime.ListTagsForResourceInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) Options() ivsrealtime.Options {
	ret := _m.Called()
...
func (_m *IvsrealtimeClient) StartComposition(ctx context.Context, params *ivsrealtime.StartCompositionInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.StartCompositionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) StopComposition(ctx context.Context, params *ivsrealtime.StopCompositionInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.StopCompositionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) TagResource(ctx context.Context, params *ivsrealtime.TagResourceInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) UntagResource(ctx context.Context, params *ivsrealtime.UntagResourceInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvsrealtimeClient) UpdateStage(ctx context.Context, params *ivsrealtime.UpdateStageInput, optFns ...func(*ivsrealtime.Options)) (*ivsrealtime.UpdateStageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIvsrealtimeClient creates a new instance of IvsrealtimeClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIvsrealtimeClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IvsrealtimeClient {
	mock := &IvsrealtimeClient{}
	mock.Mock.Test(t)
