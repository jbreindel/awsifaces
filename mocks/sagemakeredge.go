...
// SagemakeredgeClient is an autogenerated mock type for the SagemakeredgeClient type
type SagemakeredgeClient struct {
	mock.Mock
}

// GetDeployments provides a mock function with given fields: ctx, params, optFns
func (_m *SagemakeredgeClient) GetDeployments(ctx context.Context, params *sagemakeredge.GetDeploymentsInput, optFns ...func(*sagemakeredge.Options)) (*sagemakeredge.GetDeploymentsOutput, error) {
...
func (_m *SagemakeredgeClient) GetDeviceRegistration(ctx context.Context, params *sagemakeredge.GetDeviceRegistrationInput, optFns ...func(*sagemakeredge.Options)) (*sagemakeredge.GetDeviceRegistrationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SagemakeredgeClient) Options() sagemakeredge.Options {
	ret := _m.Called()
...
func (_m *SagemakeredgeClient) SendHeartbeat(ctx context.Context, params *sagemakeredge.SendHeartbeatInput, optFns ...func(*sagemakeredge.Options)) (*sagemakeredge.SendHeartbeatOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSagemakeredgeClient creates a new instance of SagemakeredgeClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSagemakeredgeClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SagemakeredgeClient {
	mock := &SagemakeredgeClient{}
	mock.Mock.Test(t)
