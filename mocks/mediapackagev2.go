...
// Mediapackagev2Client is an autogenerated mock type for the Mediapackagev2Client type
type Mediapackagev2Client struct {
	mock.Mock
}

// CreateChannel provides a mock function with given fields: ctx, params, optFns
func (_m *Mediapackagev2Client) CreateChannel(ctx context.Context, params *mediapackagev2.CreateChannelInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.CreateChannelOutput, error) {
...
func (_m *Mediapackagev2Client) CreateChannelGroup(ctx context.Context, params *mediapackagev2.CreateChannelGroupInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.CreateChannelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) CreateOriginEndpoint(ctx context.Context, params *mediapackagev2.CreateOriginEndpointInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.CreateOriginEndpointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) DeleteChannel(ctx context.Context, params *mediapackagev2.DeleteChannelInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.DeleteChannelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) DeleteChannelGroup(ctx context.Context, params *mediapackagev2.DeleteChannelGroupInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.DeleteChannelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) DeleteChannelPolicy(ctx context.Context, params *mediapackagev2.DeleteChannelPolicyInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.DeleteChannelPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) DeleteOriginEndpoint(ctx context.Context, params *mediapackagev2.DeleteOriginEndpointInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.DeleteOriginEndpointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) DeleteOriginEndpointPolicy(ctx context.Context, params *mediapackagev2.DeleteOriginEndpointPolicyInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.DeleteOriginEndpointPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) GetChannel(ctx context.Context, params *mediapackagev2.GetChannelInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.GetChannelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) GetChannelGroup(ctx context.Context, params *mediapackagev2.GetChannelGroupInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.GetChannelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) GetChannelPolicy(ctx context.Context, params *mediapackagev2.GetChannelPolicyInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.GetChannelPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) GetOriginEndpoint(ctx context.Context, params *mediapackagev2.GetOriginEndpointInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.GetOriginEndpointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) GetOriginEndpointPolicy(ctx context.Context, params *mediapackagev2.GetOriginEndpointPolicyInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.GetOriginEndpointPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) ListChannelGroups(ctx context.Context, params *mediapackagev2.ListChannelGroupsInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.ListChannelGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) ListChannels(ctx context.Context, params *mediapackagev2.ListChannelsInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.ListChannelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) ListOriginEndpoints(ctx context.Context, params *mediapackagev2.ListOriginEndpointsInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.ListOriginEndpointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) ListTagsForResource(ctx context.Context, params *mediapackagev2.ListTagsForResourceInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) Options() mediapackagev2.Options {
	ret := _m.Called()
...
func (_m *Mediapackagev2Client) PutChannelPolicy(ctx context.Context, params *mediapackagev2.PutChannelPolicyInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.PutChannelPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) PutOriginEndpointPolicy(ctx context.Context, params *mediapackagev2.PutOriginEndpointPolicyInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.PutOriginEndpointPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) TagResource(ctx context.Context, params *mediapackagev2.TagResourceInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) UntagResource(ctx context.Context, params *mediapackagev2.UntagResourceInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) UpdateChannel(ctx context.Context, params *mediapackagev2.UpdateChannelInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.UpdateChannelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) UpdateChannelGroup(ctx context.Context, params *mediapackagev2.UpdateChannelGroupInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.UpdateChannelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Mediapackagev2Client) UpdateOriginEndpoint(ctx context.Context, params *mediapackagev2.UpdateOriginEndpointInput, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.UpdateOriginEndpointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMediapackagev2Client creates a new instance of Mediapackagev2Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMediapackagev2Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *Mediapackagev2Client {
	mock := &Mediapackagev2Client{}
	mock.Mock.Test(t)
