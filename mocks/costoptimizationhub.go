...
// CostoptimizationhubClient is an autogenerated mock type for the CostoptimizationhubClient type
type CostoptimizationhubClient struct {
	mock.Mock
}

// GetPreferences provides a mock function with given fields: ctx, params, optFns
func (_m *CostoptimizationhubClient) GetPreferences(ctx context.Context, params *costoptimizationhub.GetPreferencesInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.GetPreferencesOutput, error) {
...
func (_m *CostoptimizationhubClient) GetRecommendation(ctx context.Context, params *costoptimizationhub.GetRecommendationInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.GetRecommendationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostoptimizationhubClient) ListEnrollmentStatuses(ctx context.Context, params *costoptimizationhub.ListEnrollmentStatusesInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.ListEnrollmentStatusesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostoptimizationhubClient) ListRecommendationSummaries(ctx context.Context, params *costoptimizationhub.ListRecommendationSummariesInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.ListRecommendationSummariesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostoptimizationhubClient) ListRecommendations(ctx context.Context, params *costoptimizationhub.ListRecommendationsInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.ListRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostoptimizationhubClient) Options() costoptimizationhub.Options {
	ret := _m.Called()
...
func (_m *CostoptimizationhubClient) UpdateEnrollmentStatus(ctx context.Context, params *costoptimizationhub.UpdateEnrollmentStatusInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.UpdateEnrollmentStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostoptimizationhubClient) UpdatePreferences(ctx context.Context, params *costoptimizationhub.UpdatePreferencesInput, optFns ...func(*costoptimizationhub.Options)) (*costoptimizationhub.UpdatePreferencesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCostoptimizationhubClient creates a new instance of CostoptimizationhubClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCostoptimizationhubClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CostoptimizationhubClient {
	mock := &CostoptimizationhubClient{}
	mock.Mock.Test(t)
