...
// IotfleethubClient is an autogenerated mock type for the IotfleethubClient type
type IotfleethubClient struct {
	mock.Mock
}

// CreateApplication provides a mock function with given fields: ctx, params, optFns
func (_m *IotfleethubClient) CreateApplication(ctx context.Context, params *iotfleethub.CreateApplicationInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.CreateApplicationOutput, error) {
...
func (_m *IotfleethubClient) DeleteApplication(ctx context.Context, params *iotfleethub.DeleteApplicationInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.DeleteApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotfleethubClient) DescribeApplication(ctx context.Context, params *iotfleethub.DescribeApplicationInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.DescribeApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotfleethubClient) ListApplications(ctx context.Context, params *iotfleethub.ListApplicationsInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotfleethubClient) ListTagsForResource(ctx context.Context, params *iotfleethub.ListTagsForResourceInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotfleethubClient) Options() iotfleethub.Options {
	ret := _m.Called()
...
func (_m *IotfleethubClient) TagResource(ctx context.Context, params *iotfleethub.TagResourceInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotfleethubClient) UntagResource(ctx context.Context, params *iotfleethub.UntagResourceInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotfleethubClient) UpdateApplication(ctx context.Context, params *iotfleethub.UpdateApplicationInput, optFns ...func(*iotfleethub.Options)) (*iotfleethub.UpdateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIotfleethubClient creates a new instance of IotfleethubClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIotfleethubClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IotfleethubClient {
	mock := &IotfleethubClient{}
	mock.Mock.Test(t)
