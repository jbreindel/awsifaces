...
// IoteventsdataClient is an autogenerated mock type for the IoteventsdataClient type
type IoteventsdataClient struct {
	mock.Mock
}

// BatchAcknowledgeAlarm provides a mock function with given fields: ctx, params, optFns
func (_m *IoteventsdataClient) BatchAcknowledgeAlarm(ctx context.Context, params *ioteventsdata.BatchAcknowledgeAlarmInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchAcknowledgeAlarmOutput, error) {
...
func (_m *IoteventsdataClient) BatchDeleteDetector(ctx context.Context, params *ioteventsdata.BatchDeleteDetectorInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchDeleteDetectorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) BatchDisableAlarm(ctx context.Context, params *ioteventsdata.BatchDisableAlarmInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchDisableAlarmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) BatchEnableAlarm(ctx context.Context, params *ioteventsdata.BatchEnableAlarmInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchEnableAlarmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) BatchPutMessage(ctx context.Context, params *ioteventsdata.BatchPutMessageInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchPutMessageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) BatchResetAlarm(ctx context.Context, params *ioteventsdata.BatchResetAlarmInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchResetAlarmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) BatchSnoozeAlarm(ctx context.Context, params *ioteventsdata.BatchSnoozeAlarmInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchSnoozeAlarmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) BatchUpdateDetector(ctx context.Context, params *ioteventsdata.BatchUpdateDetectorInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.BatchUpdateDetectorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) DescribeAlarm(ctx context.Context, params *ioteventsdata.DescribeAlarmInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.DescribeAlarmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) DescribeDetector(ctx context.Context, params *ioteventsdata.DescribeDetectorInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.DescribeDetectorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) ListAlarms(ctx context.Context, params *ioteventsdata.ListAlarmsInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.ListAlarmsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) ListDetectors(ctx context.Context, params *ioteventsdata.ListDetectorsInput, optFns ...func(*ioteventsdata.Options)) (*ioteventsdata.ListDetectorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IoteventsdataClient) Options() ioteventsdata.Options {
	ret := _m.Called()
...
// NewIoteventsdataClient creates a new instance of IoteventsdataClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIoteventsdataClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IoteventsdataClient {
	mock := &IoteventsdataClient{}
	mock.Mock.Test(t)
