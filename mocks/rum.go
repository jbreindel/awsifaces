...
// RumClient is an autogenerated mock type for the RumClient type
type RumClient struct {
	mock.Mock
}

// BatchCreateRumMetricDefinitions provides a mock function with given fields: ctx, params, optFns
func (_m *RumClient) BatchCreateRumMetricDefinitions(ctx context.Context, params *rum.BatchCreateRumMetricDefinitionsInput, optFns ...func(*rum.Options)) (*rum.BatchCreateRumMetricDefinitionsOutput, error) {
...
func (_m *RumClient) BatchDeleteRumMetricDefinitions(ctx context.Context, params *rum.BatchDeleteRumMetricDefinitionsInput, optFns ...func(*rum.Options)) (*rum.BatchDeleteRumMetricDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) BatchGetRumMetricDefinitions(ctx context.Context, params *rum.BatchGetRumMetricDefinitionsInput, optFns ...func(*rum.Options)) (*rum.BatchGetRumMetricDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) CreateAppMonitor(ctx context.Context, params *rum.CreateAppMonitorInput, optFns ...func(*rum.Options)) (*rum.CreateAppMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) DeleteAppMonitor(ctx context.Context, params *rum.DeleteAppMonitorInput, optFns ...func(*rum.Options)) (*rum.DeleteAppMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) DeleteRumMetricsDestination(ctx context.Context, params *rum.DeleteRumMetricsDestinationInput, optFns ...func(*rum.Options)) (*rum.DeleteRumMetricsDestinationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) GetAppMonitor(ctx context.Context, params *rum.GetAppMonitorInput, optFns ...func(*rum.Options)) (*rum.GetAppMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) GetAppMonitorData(ctx context.Context, params *rum.GetAppMonitorDataInput, optFns ...func(*rum.Options)) (*rum.GetAppMonitorDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) ListAppMonitors(ctx context.Context, params *rum.ListAppMonitorsInput, optFns ...func(*rum.Options)) (*rum.ListAppMonitorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) ListRumMetricsDestinations(ctx context.Context, params *rum.ListRumMetricsDestinationsInput, optFns ...func(*rum.Options)) (*rum.ListRumMetricsDestinationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) ListTagsForResource(ctx context.Context, params *rum.ListTagsForResourceInput, optFns ...func(*rum.Options)) (*rum.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) Options() rum.Options {
	ret := _m.Called()
...
func (_m *RumClient) PutRumEvents(ctx context.Context, params *rum.PutRumEventsInput, optFns ...func(*rum.Options)) (*rum.PutRumEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) PutRumMetricsDestination(ctx context.Context, params *rum.PutRumMetricsDestinationInput, optFns ...func(*rum.Options)) (*rum.PutRumMetricsDestinationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) TagResource(ctx context.Context, params *rum.TagResourceInput, optFns ...func(*rum.Options)) (*rum.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) UntagResource(ctx context.Context, params *rum.UntagResourceInput, optFns ...func(*rum.Options)) (*rum.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) UpdateAppMonitor(ctx context.Context, params *rum.UpdateAppMonitorInput, optFns ...func(*rum.Options)) (*rum.UpdateAppMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RumClient) UpdateRumMetricDefinition(ctx context.Context, params *rum.UpdateRumMetricDefinitionInput, optFns ...func(*rum.Options)) (*rum.UpdateRumMetricDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewRumClient creates a new instance of RumClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRumClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *RumClient {
	mock := &RumClient{}
