...
// ManagedblockchainqueryClient is an autogenerated mock type for the ManagedblockchainqueryClient type
type ManagedblockchainqueryClient struct {
	mock.Mock
}

// BatchGetTokenBalance provides a mock function with given fields: ctx, params, optFns
func (_m *ManagedblockchainqueryClient) BatchGetTokenBalance(ctx context.Context, params *managedblockchainquery.BatchGetTokenBalanceInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.BatchGetTokenBalanceOutput, error) {
...
func (_m *ManagedblockchainqueryClient) GetAssetContract(ctx context.Context, params *managedblockchainquery.GetAssetContractInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.GetAssetContractOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) GetTokenBalance(ctx context.Context, params *managedblockchainquery.GetTokenBalanceInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.GetTokenBalanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) GetTransaction(ctx context.Context, params *managedblockchainquery.GetTransactionInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.GetTransactionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) ListAssetContracts(ctx context.Context, params *managedblockchainquery.ListAssetContractsInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.ListAssetContractsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) ListFilteredTransactionEvents(ctx context.Context, params *managedblockchainquery.ListFilteredTransactionEventsInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.ListFilteredTransactionEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) ListTokenBalances(ctx context.Context, params *managedblockchainquery.ListTokenBalancesInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.ListTokenBalancesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) ListTransactionEvents(ctx context.Context, params *managedblockchainquery.ListTransactionEventsInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.ListTransactionEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) ListTransactions(ctx context.Context, params *managedblockchainquery.ListTransactionsInput, optFns ...func(*managedblockchainquery.Options)) (*managedblockchainquery.ListTransactionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainqueryClient) Options() managedblockchainquery.Options {
	ret := _m.Called()
...
// NewManagedblockchainqueryClient creates a new instance of ManagedblockchainqueryClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewManagedblockchainqueryClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ManagedblockchainqueryClient {
	mock := &ManagedblockchainqueryClient{}
	mock.Mock.Test(t)
