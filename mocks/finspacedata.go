...
// FinspacedataClient is an autogenerated mock type for the FinspacedataClient type
type FinspacedataClient struct {
	mock.Mock
}

// AssociateUserToPermissionGroup provides a mock function with given fields: ctx, params, optFns
func (_m *FinspacedataClient) AssociateUserToPermissionGroup(ctx context.Context, params *finspacedata.AssociateUserToPermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.AssociateUserToPermissionGroupOutput, error) {
...
func (_m *FinspacedataClient) CreateChangeset(ctx context.Context, params *finspacedata.CreateChangesetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.CreateChangesetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) CreateDataView(ctx context.Context, params *finspacedata.CreateDataViewInput, optFns ...func(*finspacedata.Options)) (*finspacedata.CreateDataViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) CreateDataset(ctx context.Context, params *finspacedata.CreateDatasetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.CreateDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) CreatePermissionGroup(ctx context.Context, params *finspacedata.CreatePermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.CreatePermissionGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) CreateUser(ctx context.Context, params *finspacedata.CreateUserInput, optFns ...func(*finspacedata.Options)) (*finspacedata.CreateUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) DeleteDataset(ctx context.Context, params *finspacedata.DeleteDatasetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.DeleteDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) DeletePermissionGroup(ctx context.Context, params *finspacedata.DeletePermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.DeletePermissionGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) DisableUser(ctx context.Context, params *finspacedata.DisableUserInput, optFns ...func(*finspacedata.Options)) (*finspacedata.DisableUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) DisassociateUserFromPermissionGroup(ctx context.Context, params *finspacedata.DisassociateUserFromPermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.DisassociateUserFromPermissionGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) EnableUser(ctx context.Context, params *finspacedata.EnableUserInput, optFns ...func(*finspacedata.Options)) (*finspacedata.EnableUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetChangeset(ctx context.Context, params *finspacedata.GetChangesetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetChangesetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetDataView(ctx context.Context, params *finspacedata.GetDataViewInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetDataViewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetDataset(ctx context.Context, params *finspacedata.GetDatasetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetExternalDataViewAccessDetails(ctx context.Context, params *finspacedata.GetExternalDataViewAccessDetailsInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetExternalDataViewAccessDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetPermissionGroup(ctx context.Context, params *finspacedata.GetPermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetPermissionGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetProgrammaticAccessCredentials(ctx context.Context, params *finspacedata.GetProgrammaticAccessCredentialsInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetProgrammaticAccessCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetUser(ctx context.Context, params *finspacedata.GetUserInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) GetWorkingLocation(ctx context.Context, params *finspacedata.GetWorkingLocationInput, optFns ...func(*finspacedata.Options)) (*finspacedata.GetWorkingLocationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListChangesets(ctx context.Context, params *finspacedata.ListChangesetsInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListChangesetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListDataViews(ctx context.Context, params *finspacedata.ListDataViewsInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListDataViewsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListDatasets(ctx context.Context, params *finspacedata.ListDatasetsInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListDatasetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListPermissionGroups(ctx context.Context, params *finspacedata.ListPermissionGroupsInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListPermissionGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListPermissionGroupsByUser(ctx context.Context, params *finspacedata.ListPermissionGroupsByUserInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListPermissionGroupsByUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListUsers(ctx context.Context, params *finspacedata.ListUsersInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListUsersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) ListUsersByPermissionGroup(ctx context.Context, params *finspacedata.ListUsersByPermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ListUsersByPermissionGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) Options() finspacedata.Options {
	ret := _m.Called()
...
func (_m *FinspacedataClient) ResetUserPassword(ctx context.Context, params *finspacedata.ResetUserPasswordInput, optFns ...func(*finspacedata.Options)) (*finspacedata.ResetUserPasswordOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) UpdateChangeset(ctx context.Context, params *finspacedata.UpdateChangesetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.UpdateChangesetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) UpdateDataset(ctx context.Context, params *finspacedata.UpdateDatasetInput, optFns ...func(*finspacedata.Options)) (*finspacedata.UpdateDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) UpdatePermissionGroup(ctx context.Context, params *finspacedata.UpdatePermissionGroupInput, optFns ...func(*finspacedata.Options)) (*finspacedata.UpdatePermissionGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *FinspacedataClient) UpdateUser(ctx context.Context, params *finspacedata.UpdateUserInput, optFns ...func(*finspacedata.Options)) (*finspacedata.UpdateUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewFinspacedataClient creates a new instance of FinspacedataClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewFinspacedataClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *FinspacedataClient {
	mock := &FinspacedataClient{}
	mock.Mock.Test(t)
