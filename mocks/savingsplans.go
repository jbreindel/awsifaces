...
// SavingsplansClient is an autogenerated mock type for the SavingsplansClient type
type SavingsplansClient struct {
	mock.Mock
}

// CreateSavingsPlan provides a mock function with given fields: ctx, params, optFns
func (_m *SavingsplansClient) CreateSavingsPlan(ctx context.Context, params *savingsplans.CreateSavingsPlanInput, optFns ...func(*savingsplans.Options)) (*savingsplans.CreateSavingsPlanOutput, error) {
...
func (_m *SavingsplansClient) DeleteQueuedSavingsPlan(ctx context.Context, params *savingsplans.DeleteQueuedSavingsPlanInput, optFns ...func(*savingsplans.Options)) (*savingsplans.DeleteQueuedSavingsPlanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) DescribeSavingsPlanRates(ctx context.Context, params *savingsplans.DescribeSavingsPlanRatesInput, optFns ...func(*savingsplans.Options)) (*savingsplans.DescribeSavingsPlanRatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) DescribeSavingsPlans(ctx context.Context, params *savingsplans.DescribeSavingsPlansInput, optFns ...func(*savingsplans.Options)) (*savingsplans.DescribeSavingsPlansOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) DescribeSavingsPlansOfferingRates(ctx context.Context, params *savingsplans.DescribeSavingsPlansOfferingRatesInput, optFns ...func(*savingsplans.Options)) (*savingsplans.DescribeSavingsPlansOfferingRatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) DescribeSavingsPlansOfferings(ctx context.Context, params *savingsplans.DescribeSavingsPlansOfferingsInput, optFns ...func(*savingsplans.Options)) (*savingsplans.DescribeSavingsPlansOfferingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) ListTagsForResource(ctx context.Context, params *savingsplans.ListTagsForResourceInput, optFns ...func(*savingsplans.Options)) (*savingsplans.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) Options() savingsplans.Options {
	ret := _m.Called()
...
func (_m *SavingsplansClient) ReturnSavingsPlan(ctx context.Context, params *savingsplans.ReturnSavingsPlanInput, optFns ...func(*savingsplans.Options)) (*savingsplans.ReturnSavingsPlanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) TagResource(ctx context.Context, params *savingsplans.TagResourceInput, optFns ...func(*savingsplans.Options)) (*savingsplans.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SavingsplansClient) UntagResource(ctx context.Context, params *savingsplans.UntagResourceInput, optFns ...func(*savingsplans.Options)) (*savingsplans.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSavingsplansClient creates a new instance of SavingsplansClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSavingsplansClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SavingsplansClient {
	mock := &SavingsplansClient{}
	mock.Mock.Test(t)
