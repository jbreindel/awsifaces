...
// MarketplaceagreementClient is an autogenerated mock type for the MarketplaceagreementClient type
type MarketplaceagreementClient struct {
	mock.Mock
}

// DescribeAgreement provides a mock function with given fields: ctx, params, optFns
func (_m *MarketplaceagreementClient) DescribeAgreement(ctx context.Context, params *marketplaceagreement.DescribeAgreementInput, optFns ...func(*marketplaceagreement.Options)) (*marketplaceagreement.DescribeAgreementOutput, error) {
...
func (_m *MarketplaceagreementClient) GetAgreementTerms(ctx context.Context, params *marketplaceagreement.GetAgreementTermsInput, optFns ...func(*marketplaceagreement.Options)) (*marketplaceagreement.GetAgreementTermsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplaceagreementClient) Options() marketplaceagreement.Options {
	ret := _m.Called()
...
func (_m *MarketplaceagreementClient) SearchAgreements(ctx context.Context, params *marketplaceagreement.SearchAgreementsInput, optFns ...func(*marketplaceagreement.Options)) (*marketplaceagreement.SearchAgreementsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMarketplaceagreementClient creates a new instance of MarketplaceagreementClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMarketplaceagreementClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MarketplaceagreementClient {
	mock := &MarketplaceagreementClient{}
	mock.Mock.Test(t)
