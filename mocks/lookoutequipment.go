...
// LookoutequipmentClient is an autogenerated mock type for the LookoutequipmentClient type
type LookoutequipmentClient struct {
	mock.Mock
}

// CreateDataset provides a mock function with given fields: ctx, params, optFns
func (_m *LookoutequipmentClient) CreateDataset(ctx context.Context, params *lookoutequipment.CreateDatasetInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.CreateDatasetOutput, error) {
...
func (_m *LookoutequipmentClient) CreateInferenceScheduler(ctx context.Context, params *lookoutequipment.CreateInferenceSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.CreateInferenceSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) CreateLabel(ctx context.Context, params *lookoutequipment.CreateLabelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.CreateLabelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) CreateLabelGroup(ctx context.Context, params *lookoutequipment.CreateLabelGroupInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.CreateLabelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) CreateModel(ctx context.Context, params *lookoutequipment.CreateModelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.CreateModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) CreateRetrainingScheduler(ctx context.Context, params *lookoutequipment.CreateRetrainingSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.CreateRetrainingSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteDataset(ctx context.Context, params *lookoutequipment.DeleteDatasetInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteInferenceScheduler(ctx context.Context, params *lookoutequipment.DeleteInferenceSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteInferenceSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteLabel(ctx context.Context, params *lookoutequipment.DeleteLabelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteLabelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteLabelGroup(ctx context.Context, params *lookoutequipment.DeleteLabelGroupInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteLabelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteModel(ctx context.Context, params *lookoutequipment.DeleteModelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteResourcePolicy(ctx context.Context, params *lookoutequipment.DeleteResourcePolicyInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DeleteRetrainingScheduler(ctx context.Context, params *lookoutequipment.DeleteRetrainingSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DeleteRetrainingSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeDataIngestionJob(ctx context.Context, params *lookoutequipment.DescribeDataIngestionJobInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeDataIngestionJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeDataset(ctx context.Context, params *lookoutequipment.DescribeDatasetInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeInferenceScheduler(ctx context.Context, params *lookoutequipment.DescribeInferenceSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeInferenceSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeLabel(ctx context.Context, params *lookoutequipment.DescribeLabelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeLabelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeLabelGroup(ctx context.Context, params *lookoutequipment.DescribeLabelGroupInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeLabelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeModel(ctx context.Context, params *lookoutequipment.DescribeModelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeModelVersion(ctx context.Context, params *lookoutequipment.DescribeModelVersionInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeModelVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeResourcePolicy(ctx context.Context, params *lookoutequipment.DescribeResourcePolicyInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) DescribeRetrainingScheduler(ctx context.Context, params *lookoutequipment.DescribeRetrainingSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.DescribeRetrainingSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ImportDataset(ctx context.Context, params *lookoutequipment.ImportDatasetInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ImportDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ImportModelVersion(ctx context.Context, params *lookoutequipment.ImportModelVersionInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ImportModelVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListDataIngestionJobs(ctx context.Context, params *lookoutequipment.ListDataIngestionJobsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListDataIngestionJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListDatasets(ctx context.Context, params *lookoutequipment.ListDatasetsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListDatasetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListInferenceEvents(ctx context.Context, params *lookoutequipment.ListInferenceEventsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListInferenceEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListInferenceExecutions(ctx context.Context, params *lookoutequipment.ListInferenceExecutionsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListInferenceExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListInferenceSchedulers(ctx context.Context, params *lookoutequipment.ListInferenceSchedulersInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListInferenceSchedulersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListLabelGroups(ctx context.Context, params *lookoutequipment.ListLabelGroupsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListLabelGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListLabels(ctx context.Context, params *lookoutequipment.ListLabelsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListLabelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListModelVersions(ctx context.Context, params *lookoutequipment.ListModelVersionsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListModelVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListModels(ctx context.Context, params *lookoutequipment.ListModelsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListModelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListRetrainingSchedulers(ctx context.Context, params *lookoutequipment.ListRetrainingSchedulersInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListRetrainingSchedulersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListSensorStatistics(ctx context.Context, params *lookoutequipment.ListSensorStatisticsInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListSensorStatisticsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) ListTagsForResource(ctx context.Context, params *lookoutequipment.ListTagsForResourceInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) Options() lookoutequipment.Options {
	ret := _m.Called()
...
func (_m *LookoutequipmentClient) PutResourcePolicy(ctx context.Context, params *lookoutequipment.PutResourcePolicyInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.PutResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) StartDataIngestionJob(ctx context.Context, params *lookoutequipment.StartDataIngestionJobInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.StartDataIngestionJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) StartInferenceScheduler(ctx context.Context, params *lookoutequipment.StartInferenceSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.StartInferenceSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) StartRetrainingScheduler(ctx context.Context, params *lookoutequipment.StartRetrainingSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.StartRetrainingSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) StopInferenceScheduler(ctx context.Context, params *lookoutequipment.StopInferenceSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.StopInferenceSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) StopRetrainingScheduler(ctx context.Context, params *lookoutequipment.StopRetrainingSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.StopRetrainingSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) TagResource(ctx context.Context, params *lookoutequipment.TagResourceInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) UntagResource(ctx context.Context, params *lookoutequipment.UntagResourceInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) UpdateActiveModelVersion(ctx context.Context, params *lookoutequipment.UpdateActiveModelVersionInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.UpdateActiveModelVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) UpdateInferenceScheduler(ctx context.Context, params *lookoutequipment.UpdateInferenceSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.UpdateInferenceSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) UpdateLabelGroup(ctx context.Context, params *lookoutequipment.UpdateLabelGroupInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.UpdateLabelGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) UpdateModel(ctx context.Context, params *lookoutequipment.UpdateModelInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.UpdateModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LookoutequipmentClient) UpdateRetrainingScheduler(ctx context.Context, params *lookoutequipment.UpdateRetrainingSchedulerInput, optFns ...func(*lookoutequipment.Options)) (*lookoutequipment.UpdateRetrainingSchedulerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewLookoutequipmentClient creates a new instance of LookoutequipmentClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLookoutequipmentClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *LookoutequipmentClient {
	mock := &LookoutequipmentClient{}
	mock.Mock.Test(t)
