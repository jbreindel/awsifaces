...
// DatapipelineClient is an autogenerated mock type for the DatapipelineClient type
type DatapipelineClient struct {
	mock.Mock
}

// ActivatePipeline provides a mock function with given fields: ctx, params, optFns
func (_m *DatapipelineClient) ActivatePipeline(ctx context.Context, params *datapipeline.ActivatePipelineInput, optFns ...func(*datapipeline.Options)) (*datapipeline.ActivatePipelineOutput, error) {
...
func (_m *DatapipelineClient) AddTags(ctx context.Context, params *datapipeline.AddTagsInput, optFns ...func(*datapipeline.Options)) (*datapipeline.AddTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) CreatePipeline(ctx context.Context, params *datapipeline.CreatePipelineInput, optFns ...func(*datapipeline.Options)) (*datapipeline.CreatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) DeactivatePipeline(ctx context.Context, params *datapipeline.DeactivatePipelineInput, optFns ...func(*datapipeline.Options)) (*datapipeline.DeactivatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) DeletePipeline(ctx context.Context, params *datapipeline.DeletePipelineInput, optFns ...func(*datapipeline.Options)) (*datapipeline.DeletePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) DescribeObjects(ctx context.Context, params *datapipeline.DescribeObjectsInput, optFns ...func(*datapipeline.Options)) (*datapipeline.DescribeObjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) DescribePipelines(ctx context.Context, params *datapipeline.DescribePipelinesInput, optFns ...func(*datapipeline.Options)) (*datapipeline.DescribePipelinesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) EvaluateExpression(ctx context.Context, params *datapipeline.EvaluateExpressionInput, optFns ...func(*datapipeline.Options)) (*datapipeline.EvaluateExpressionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) GetPipelineDefinition(ctx context.Context, params *datapipeline.GetPipelineDefinitionInput, optFns ...func(*datapipeline.Options)) (*datapipeline.GetPipelineDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) ListPipelines(ctx context.Context, params *datapipeline.ListPipelinesInput, optFns ...func(*datapipeline.Options)) (*datapipeline.ListPipelinesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) Options() datapipeline.Options {
	ret := _m.Called()
...
func (_m *DatapipelineClient) PollForTask(ctx context.Context, params *datapipeline.PollForTaskInput, optFns ...func(*datapipeline.Options)) (*datapipeline.PollForTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) PutPipelineDefinition(ctx context.Context, params *datapipeline.PutPipelineDefinitionInput, optFns ...func(*datapipeline.Options)) (*datapipeline.PutPipelineDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) QueryObjects(ctx context.Context, params *datapipeline.QueryObjectsInput, optFns ...func(*datapipeline.Options)) (*datapipeline.QueryObjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) RemoveTags(ctx context.Context, params *datapipeline.RemoveTagsInput, optFns ...func(*datapipeline.Options)) (*datapipeline.RemoveTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) ReportTaskProgress(ctx context.Context, params *datapipeline.ReportTaskProgressInput, optFns ...func(*datapipeline.Options)) (*datapipeline.ReportTaskProgressOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) ReportTaskRunnerHeartbeat(ctx context.Context, params *datapipeline.ReportTaskRunnerHeartbeatInput, optFns ...func(*datapipeline.Options)) (*datapipeline.ReportTaskRunnerHeartbeatOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) SetStatus(ctx context.Context, params *datapipeline.SetStatusInput, optFns ...func(*datapipeline.Options)) (*datapipeline.SetStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) SetTaskStatus(ctx context.Context, params *datapipeline.SetTaskStatusInput, optFns ...func(*datapipeline.Options)) (*datapipeline.SetTaskStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DatapipelineClient) ValidatePipelineDefinition(ctx context.Context, params *datapipeline.ValidatePipelineDefinitionInput, optFns ...func(*datapipeline.Options)) (*datapipeline.ValidatePipelineDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewDatapipelineClient creates a new instance of DatapipelineClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewDatapipelineClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *DatapipelineClient {
