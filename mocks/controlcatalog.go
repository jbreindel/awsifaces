...
// ControlcatalogClient is an autogenerated mock type for the ControlcatalogClient type
type ControlcatalogClient struct {
	mock.Mock
}

// ListCommonControls provides a mock function with given fields: ctx, params, optFns
func (_m *ControlcatalogClient) ListCommonControls(ctx context.Context, params *controlcatalog.ListCommonControlsInput, optFns ...func(*controlcatalog.Options)) (*controlcatalog.ListCommonControlsOutput, error) {
...
func (_m *ControlcatalogClient) ListDomains(ctx context.Context, params *controlcatalog.ListDomainsInput, optFns ...func(*controlcatalog.Options)) (*controlcatalog.ListDomainsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ControlcatalogClient) ListObjectives(ctx context.Context, params *controlcatalog.ListObjectivesInput, optFns ...func(*controlcatalog.Options)) (*controlcatalog.ListObjectivesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ControlcatalogClient) Options() controlcatalog.Options {
	ret := _m.Called()
...
// NewControlcatalogClient creates a new instance of ControlcatalogClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewControlcatalogClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ControlcatalogClient {
	mock := &ControlcatalogClient{}
	mock.Mock.Test(t)
