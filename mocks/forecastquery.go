...
// ForecastqueryClient is an autogenerated mock type for the ForecastqueryClient type
type ForecastqueryClient struct {
	mock.Mock
}

// Options provides a mock function with given fields:
func (_m *ForecastqueryClient) Options() forecastquery.Options {
	ret := _m.Called()
...
func (_m *ForecastqueryClient) QueryForecast(ctx context.Context, params *forecastquery.QueryForecastInput, optFns ...func(*forecastquery.Options)) (*forecastquery.QueryForecastOutput, error) {
...
func (_m *ForecastqueryClient) QueryWhatIfForecast(ctx context.Context, params *forecastquery.QueryWhatIfForecastInput, optFns ...func(*forecastquery.Options)) (*forecastquery.QueryWhatIfForecastOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewForecastqueryClient creates a new instance of ForecastqueryClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewForecastqueryClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ForecastqueryClient {
	mock := &ForecastqueryClient{}
	mock.Mock.Test(t)
