...
// Iot1clickprojectsClient is an autogenerated mock type for the Iot1clickprojectsClient type
type Iot1clickprojectsClient struct {
	mock.Mock
}

// AssociateDeviceWithPlacement provides a mock function with given fields: ctx, params, optFns
func (_m *Iot1clickprojectsClient) AssociateDeviceWithPlacement(ctx context.Context, params *iot1clickprojects.AssociateDeviceWithPlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.AssociateDeviceWithPlacementOutput, error) {
...
func (_m *Iot1clickprojectsClient) CreatePlacement(ctx context.Context, params *iot1clickprojects.CreatePlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.CreatePlacementOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) CreateProject(ctx context.Context, params *iot1clickprojects.CreateProjectInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.CreateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) DeletePlacement(ctx context.Context, params *iot1clickprojects.DeletePlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.DeletePlacementOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) DeleteProject(ctx context.Context, params *iot1clickprojects.DeleteProjectInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.DeleteProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) DescribePlacement(ctx context.Context, params *iot1clickprojects.DescribePlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.DescribePlacementOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) DescribeProject(ctx context.Context, params *iot1clickprojects.DescribeProjectInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.DescribeProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) DisassociateDeviceFromPlacement(ctx context.Context, params *iot1clickprojects.DisassociateDeviceFromPlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.DisassociateDeviceFromPlacementOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) GetDevicesInPlacement(ctx context.Context, params *iot1clickprojects.GetDevicesInPlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.GetDevicesInPlacementOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) ListPlacements(ctx context.Context, params *iot1clickprojects.ListPlacementsInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.ListPlacementsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) ListProjects(ctx context.Context, params *iot1clickprojects.ListProjectsInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.ListProjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) ListTagsForResource(ctx context.Context, params *iot1clickprojects.ListTagsForResourceInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) Options() iot1clickprojects.Options {
	ret := _m.Called()
...
func (_m *Iot1clickprojectsClient) TagResource(ctx context.Context, params *iot1clickprojects.TagResourceInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) UntagResource(ctx context.Context, params *iot1clickprojects.UntagResourceInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) UpdatePlacement(ctx context.Context, params *iot1clickprojects.UpdatePlacementInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.UpdatePlacementOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Iot1clickprojectsClient) UpdateProject(ctx context.Context, params *iot1clickprojects.UpdateProjectInput, optFns ...func(*iot1clickprojects.Options)) (*iot1clickprojects.UpdateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIot1clickprojectsClient creates a new instance of Iot1clickprojectsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIot1clickprojectsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *Iot1clickprojectsClient {
	mock := &Iot1clickprojectsClient{}
	mock.Mock.Test(t)
