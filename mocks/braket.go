...
// BraketClient is an autogenerated mock type for the BraketClient type
type BraketClient struct {
	mock.Mock
}

// CancelJob provides a mock function with given fields: ctx, params, optFns
func (_m *BraketClient) CancelJob(ctx context.Context, params *braket.CancelJobInput, optFns ...func(*braket.Options)) (*braket.CancelJobOutput, error) {
...
func (_m *BraketClient) CancelQuantumTask(ctx context.Context, params *braket.CancelQuantumTaskInput, optFns ...func(*braket.Options)) (*braket.CancelQuantumTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) CreateJob(ctx context.Context, params *braket.CreateJobInput, optFns ...func(*braket.Options)) (*braket.CreateJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) CreateQuantumTask(ctx context.Context, params *braket.CreateQuantumTaskInput, optFns ...func(*braket.Options)) (*braket.CreateQuantumTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) GetDevice(ctx context.Context, params *braket.GetDeviceInput, optFns ...func(*braket.Options)) (*braket.GetDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) GetJob(ctx context.Context, params *braket.GetJobInput, optFns ...func(*braket.Options)) (*braket.GetJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) GetQuantumTask(ctx context.Context, params *braket.GetQuantumTaskInput, optFns ...func(*braket.Options)) (*braket.GetQuantumTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) ListTagsForResource(ctx context.Context, params *braket.ListTagsForResourceInput, optFns ...func(*braket.Options)) (*braket.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) Options() braket.Options {
	ret := _m.Called()
...
func (_m *BraketClient) SearchDevices(ctx context.Context, params *braket.SearchDevicesInput, optFns ...func(*braket.Options)) (*braket.SearchDevicesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) SearchJobs(ctx context.Context, params *braket.SearchJobsInput, optFns ...func(*braket.Options)) (*braket.SearchJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) SearchQuantumTasks(ctx context.Context, params *braket.SearchQuantumTasksInput, optFns ...func(*braket.Options)) (*braket.SearchQuantumTasksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) TagResource(ctx context.Context, params *braket.TagResourceInput, optFns ...func(*braket.Options)) (*braket.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BraketClient) UntagResource(ctx context.Context, params *braket.UntagResourceInput, optFns ...func(*braket.Options)) (*braket.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewBraketClient creates a new instance of BraketClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBraketClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *BraketClient {
	mock := &BraketClient{}
