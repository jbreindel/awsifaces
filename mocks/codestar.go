...
// CodestarClient is an autogenerated mock type for the CodestarClient type
type CodestarClient struct {
	mock.Mock
}

// AssociateTeamMember provides a mock function with given fields: ctx, params, optFns
func (_m *CodestarClient) AssociateTeamMember(ctx context.Context, params *codestar.AssociateTeamMemberInput, optFns ...func(*codestar.Options)) (*codestar.AssociateTeamMemberOutput, error) {
...
func (_m *CodestarClient) CreateProject(ctx context.Context, params *codestar.CreateProjectInput, optFns ...func(*codestar.Options)) (*codestar.CreateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) CreateUserProfile(ctx context.Context, params *codestar.CreateUserProfileInput, optFns ...func(*codestar.Options)) (*codestar.CreateUserProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) DeleteProject(ctx context.Context, params *codestar.DeleteProjectInput, optFns ...func(*codestar.Options)) (*codestar.DeleteProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) DeleteUserProfile(ctx context.Context, params *codestar.DeleteUserProfileInput, optFns ...func(*codestar.Options)) (*codestar.DeleteUserProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) DescribeProject(ctx context.Context, params *codestar.DescribeProjectInput, optFns ...func(*codestar.Options)) (*codestar.DescribeProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) DescribeUserProfile(ctx context.Context, params *codestar.DescribeUserProfileInput, optFns ...func(*codestar.Options)) (*codestar.DescribeUserProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) DisassociateTeamMember(ctx context.Context, params *codestar.DisassociateTeamMemberInput, optFns ...func(*codestar.Options)) (*codestar.DisassociateTeamMemberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) ListProjects(ctx context.Context, params *codestar.ListProjectsInput, optFns ...func(*codestar.Options)) (*codestar.ListProjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) ListResources(ctx context.Context, params *codestar.ListResourcesInput, optFns ...func(*codestar.Options)) (*codestar.ListResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) ListTagsForProject(ctx context.Context, params *codestar.ListTagsForProjectInput, optFns ...func(*codestar.Options)) (*codestar.ListTagsForProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) ListTeamMembers(ctx context.Context, params *codestar.ListTeamMembersInput, optFns ...func(*codestar.Options)) (*codestar.ListTeamMembersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) ListUserProfiles(ctx context.Context, params *codestar.ListUserProfilesInput, optFns ...func(*codestar.Options)) (*codestar.ListUserProfilesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) Options() codestar.Options {
	ret := _m.Called()
...
func (_m *CodestarClient) TagProject(ctx context.Context, params *codestar.TagProjectInput, optFns ...func(*codestar.Options)) (*codestar.TagProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) UntagProject(ctx context.Context, params *codestar.UntagProjectInput, optFns ...func(*codestar.Options)) (*codestar.UntagProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) UpdateProject(ctx context.Context, params *codestar.UpdateProjectInput, optFns ...func(*codestar.Options)) (*codestar.UpdateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) UpdateTeamMember(ctx context.Context, params *codestar.UpdateTeamMemberInput, optFns ...func(*codestar.Options)) (*codestar.UpdateTeamMemberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodestarClient) UpdateUserProfile(ctx context.Context, params *codestar.UpdateUserProfileInput, optFns ...func(*codestar.Options)) (*codestar.UpdateUserProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCodestarClient creates a new instance of CodestarClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCodestarClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CodestarClient {
	mock := &CodestarClient{}
