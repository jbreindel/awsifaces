...
// KafkaconnectClient is an autogenerated mock type for the KafkaconnectClient type
type KafkaconnectClient struct {
	mock.Mock
}

// CreateConnector provides a mock function with given fields: ctx, params, optFns
func (_m *KafkaconnectClient) CreateConnector(ctx context.Context, params *kafkaconnect.CreateConnectorInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.CreateConnectorOutput, error) {
...
func (_m *KafkaconnectClient) CreateCustomPlugin(ctx context.Context, params *kafkaconnect.CreateCustomPluginInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.CreateCustomPluginOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) CreateWorkerConfiguration(ctx context.Context, params *kafkaconnect.CreateWorkerConfigurationInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.CreateWorkerConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) DeleteConnector(ctx context.Context, params *kafkaconnect.DeleteConnectorInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.DeleteConnectorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) DeleteCustomPlugin(ctx context.Context, params *kafkaconnect.DeleteCustomPluginInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.DeleteCustomPluginOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) DeleteWorkerConfiguration(ctx context.Context, params *kafkaconnect.DeleteWorkerConfigurationInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.DeleteWorkerConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) DescribeConnector(ctx context.Context, params *kafkaconnect.DescribeConnectorInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.DescribeConnectorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) DescribeCustomPlugin(ctx context.Context, params *kafkaconnect.DescribeCustomPluginInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.DescribeCustomPluginOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) DescribeWorkerConfiguration(ctx context.Context, params *kafkaconnect.DescribeWorkerConfigurationInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.DescribeWorkerConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) ListConnectors(ctx context.Context, params *kafkaconnect.ListConnectorsInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.ListConnectorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) ListCustomPlugins(ctx context.Context, params *kafkaconnect.ListCustomPluginsInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.ListCustomPluginsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) ListTagsForResource(ctx context.Context, params *kafkaconnect.ListTagsForResourceInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) ListWorkerConfigurations(ctx context.Context, params *kafkaconnect.ListWorkerConfigurationsInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.ListWorkerConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) Options() kafkaconnect.Options {
	ret := _m.Called()
...
func (_m *KafkaconnectClient) TagResource(ctx context.Context, params *kafkaconnect.TagResourceInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) UntagResource(ctx context.Context, params *kafkaconnect.UntagResourceInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KafkaconnectClient) UpdateConnector(ctx context.Context, params *kafkaconnect.UpdateConnectorInput, optFns ...func(*kafkaconnect.Options)) (*kafkaconnect.UpdateConnectorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewKafkaconnectClient creates a new instance of KafkaconnectClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewKafkaconnectClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *KafkaconnectClient {
	mock := &KafkaconnectClient{}
	mock.Mock.Test(t)
