...
// Kinesisanalyticsv2Client is an autogenerated mock type for the Kinesisanalyticsv2Client type
type Kinesisanalyticsv2Client struct {
	mock.Mock
}

// AddApplicationCloudWatchLoggingOption provides a mock function with given fields: ctx, params, optFns
func (_m *Kinesisanalyticsv2Client) AddApplicationCloudWatchLoggingOption(ctx context.Context, params *kinesisanalyticsv2.AddApplicationCloudWatchLoggingOptionInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.AddApplicationCloudWatchLoggingOptionOutput, error) {
...
func (_m *Kinesisanalyticsv2Client) AddApplicationInput(ctx context.Context, params *kinesisanalyticsv2.AddApplicationInputInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.AddApplicationInputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) AddApplicationInputProcessingConfiguration(ctx context.Context, params *kinesisanalyticsv2.AddApplicationInputProcessingConfigurationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.AddApplicationInputProcessingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) AddApplicationOutput(ctx context.Context, params *kinesisanalyticsv2.AddApplicationOutputInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.AddApplicationOutputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) AddApplicationReferenceDataSource(ctx context.Context, params *kinesisanalyticsv2.AddApplicationReferenceDataSourceInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.AddApplicationReferenceDataSourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) AddApplicationVpcConfiguration(ctx context.Context, params *kinesisanalyticsv2.AddApplicationVpcConfigurationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.AddApplicationVpcConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) CreateApplication(ctx context.Context, params *kinesisanalyticsv2.CreateApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.CreateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) CreateApplicationPresignedUrl(ctx context.Context, params *kinesisanalyticsv2.CreateApplicationPresignedUrlInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.CreateApplicationPresignedUrlOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) CreateApplicationSnapshot(ctx context.Context, params *kinesisanalyticsv2.CreateApplicationSnapshotInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.CreateApplicationSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplication(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplicationCloudWatchLoggingOption(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationCloudWatchLoggingOptionInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationCloudWatchLoggingOptionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplicationInputProcessingConfiguration(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationInputProcessingConfigurationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationInputProcessingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplicationOutput(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationOutputInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationOutputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplicationReferenceDataSource(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationReferenceDataSourceInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationReferenceDataSourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplicationSnapshot(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationSnapshotInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DeleteApplicationVpcConfiguration(ctx context.Context, params *kinesisanalyticsv2.DeleteApplicationVpcConfigurationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DeleteApplicationVpcConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DescribeApplication(ctx context.Context, params *kinesisanalyticsv2.DescribeApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DescribeApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DescribeApplicationSnapshot(ctx context.Context, params *kinesisanalyticsv2.DescribeApplicationSnapshotInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DescribeApplicationSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DescribeApplicationVersion(ctx context.Context, params *kinesisanalyticsv2.DescribeApplicationVersionInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DescribeApplicationVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) DiscoverInputSchema(ctx context.Context, params *kinesisanalyticsv2.DiscoverInputSchemaInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.DiscoverInputSchemaOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) ListApplicationSnapshots(ctx context.Context, params *kinesisanalyticsv2.ListApplicationSnapshotsInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.ListApplicationSnapshotsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) ListApplicationVersions(ctx context.Context, params *kinesisanalyticsv2.ListApplicationVersionsInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.ListApplicationVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) ListApplications(ctx context.Context, params *kinesisanalyticsv2.ListApplicationsInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) ListTagsForResource(ctx context.Context, params *kinesisanalyticsv2.ListTagsForResourceInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) Options() kinesisanalyticsv2.Options {
	ret := _m.Called()
...
func (_m *Kinesisanalyticsv2Client) RollbackApplication(ctx context.Context, params *kinesisanalyticsv2.RollbackApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.RollbackApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) StartApplication(ctx context.Context, params *kinesisanalyticsv2.StartApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.StartApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) StopApplication(ctx context.Context, params *kinesisanalyticsv2.StopApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.StopApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) TagResource(ctx context.Context, params *kinesisanalyticsv2.TagResourceInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) UntagResource(ctx context.Context, params *kinesisanalyticsv2.UntagResourceInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) UpdateApplication(ctx context.Context, params *kinesisanalyticsv2.UpdateApplicationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.UpdateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Kinesisanalyticsv2Client) UpdateApplicationMaintenanceConfiguration(ctx context.Context, params *kinesisanalyticsv2.UpdateApplicationMaintenanceConfigurationInput, optFns ...func(*kinesisanalyticsv2.Options)) (*kinesisanalyticsv2.UpdateApplicationMaintenanceConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewKinesisanalyticsv2Client creates a new instance of Kinesisanalyticsv2Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewKinesisanalyticsv2Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *Kinesisanalyticsv2Client {
	mock := &Kinesisanalyticsv2Client{}
	mock.Mock.Test(t)
