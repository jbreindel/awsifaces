...
// LaunchwizardClient is an autogenerated mock type for the LaunchwizardClient type
type LaunchwizardClient struct {
	mock.Mock
}

// CreateDeployment provides a mock function with given fields: ctx, params, optFns
func (_m *LaunchwizardClient) CreateDeployment(ctx context.Context, params *launchwizard.CreateDeploymentInput, optFns ...func(*launchwizard.Options)) (*launchwizard.CreateDeploymentOutput, error) {
...
func (_m *LaunchwizardClient) DeleteDeployment(ctx context.Context, params *launchwizard.DeleteDeploymentInput, optFns ...func(*launchwizard.Options)) (*launchwizard.DeleteDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) GetDeployment(ctx context.Context, params *launchwizard.GetDeploymentInput, optFns ...func(*launchwizard.Options)) (*launchwizard.GetDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) GetWorkload(ctx context.Context, params *launchwizard.GetWorkloadInput, optFns ...func(*launchwizard.Options)) (*launchwizard.GetWorkloadOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) ListDeploymentEvents(ctx context.Context, params *launchwizard.ListDeploymentEventsInput, optFns ...func(*launchwizard.Options)) (*launchwizard.ListDeploymentEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) ListDeployments(ctx context.Context, params *launchwizard.ListDeploymentsInput, optFns ...func(*launchwizard.Options)) (*launchwizard.ListDeploymentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) ListWorkloadDeploymentPatterns(ctx context.Context, params *launchwizard.ListWorkloadDeploymentPatternsInput, optFns ...func(*launchwizard.Options)) (*launchwizard.ListWorkloadDeploymentPatternsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) ListWorkloads(ctx context.Context, params *launchwizard.ListWorkloadsInput, optFns ...func(*launchwizard.Options)) (*launchwizard.ListWorkloadsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LaunchwizardClient) Options() launchwizard.Options {
	ret := _m.Called()
...
// NewLaunchwizardClient creates a new instance of LaunchwizardClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLaunchwizardClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *LaunchwizardClient {
	mock := &LaunchwizardClient{}
	mock.Mock.Test(t)
