...
// CodegurureviewerClient is an autogenerated mock type for the CodegurureviewerClient type
type CodegurureviewerClient struct {
	mock.Mock
}

// AssociateRepository provides a mock function with given fields: ctx, params, optFns
func (_m *CodegurureviewerClient) AssociateRepository(ctx context.Context, params *codegurureviewer.AssociateRepositoryInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.AssociateRepositoryOutput, error) {
...
func (_m *CodegurureviewerClient) CreateCodeReview(ctx context.Context, params *codegurureviewer.CreateCodeReviewInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.CreateCodeReviewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) DescribeCodeReview(ctx context.Context, params *codegurureviewer.DescribeCodeReviewInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.DescribeCodeReviewOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) DescribeRecommendationFeedback(ctx context.Context, params *codegurureviewer.DescribeRecommendationFeedbackInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.DescribeRecommendationFeedbackOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) DescribeRepositoryAssociation(ctx context.Context, params *codegurureviewer.DescribeRepositoryAssociationInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.DescribeRepositoryAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) DisassociateRepository(ctx context.Context, params *codegurureviewer.DisassociateRepositoryInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.DisassociateRepositoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) ListCodeReviews(ctx context.Context, params *codegurureviewer.ListCodeReviewsInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.ListCodeReviewsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) ListRecommendationFeedback(ctx context.Context, params *codegurureviewer.ListRecommendationFeedbackInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.ListRecommendationFeedbackOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) ListRecommendations(ctx context.Context, params *codegurureviewer.ListRecommendationsInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.ListRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) ListRepositoryAssociations(ctx context.Context, params *codegurureviewer.ListRepositoryAssociationsInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.ListRepositoryAssociationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) ListTagsForResource(ctx context.Context, params *codegurureviewer.ListTagsForResourceInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) Options() codegurureviewer.Options {
	ret := _m.Called()
...
func (_m *CodegurureviewerClient) PutRecommendationFeedback(ctx context.Context, params *codegurureviewer.PutRecommendationFeedbackInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.PutRecommendationFeedbackOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) TagResource(ctx context.Context, params *codegurureviewer.TagResourceInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurureviewerClient) UntagResource(ctx context.Context, params *codegurureviewer.UntagResourceInput, optFns ...func(*codegurureviewer.Options)) (*codegurureviewer.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCodegurureviewerClient creates a new instance of CodegurureviewerClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCodegurureviewerClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CodegurureviewerClient {
	mock := &CodegurureviewerClient{}
	mock.Mock.Test(t)
