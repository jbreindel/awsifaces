...
// CleanroomsmlClient is an autogenerated mock type for the CleanroomsmlClient type
type CleanroomsmlClient struct {
	mock.Mock
}

// CreateAudienceModel provides a mock function with given fields: ctx, params, optFns
func (_m *CleanroomsmlClient) CreateAudienceModel(ctx context.Context, params *cleanroomsml.CreateAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.CreateAudienceModelOutput, error) {
...
func (_m *CleanroomsmlClient) CreateConfiguredAudienceModel(ctx context.Context, params *cleanroomsml.CreateConfiguredAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.CreateConfiguredAudienceModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) CreateTrainingDataset(ctx context.Context, params *cleanroomsml.CreateTrainingDatasetInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.CreateTrainingDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) DeleteAudienceGenerationJob(ctx context.Context, params *cleanroomsml.DeleteAudienceGenerationJobInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.DeleteAudienceGenerationJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) DeleteAudienceModel(ctx context.Context, params *cleanroomsml.DeleteAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.DeleteAudienceModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) DeleteConfiguredAudienceModel(ctx context.Context, params *cleanroomsml.DeleteConfiguredAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.DeleteConfiguredAudienceModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) DeleteConfiguredAudienceModelPolicy(ctx context.Context, params *cleanroomsml.DeleteConfiguredAudienceModelPolicyInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.DeleteConfiguredAudienceModelPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) DeleteTrainingDataset(ctx context.Context, params *cleanroomsml.DeleteTrainingDatasetInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.DeleteTrainingDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) GetAudienceGenerationJob(ctx context.Context, params *cleanroomsml.GetAudienceGenerationJobInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.GetAudienceGenerationJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) GetAudienceModel(ctx context.Context, params *cleanroomsml.GetAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.GetAudienceModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) GetConfiguredAudienceModel(ctx context.Context, params *cleanroomsml.GetConfiguredAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.GetConfiguredAudienceModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) GetConfiguredAudienceModelPolicy(ctx context.Context, params *cleanroomsml.GetConfiguredAudienceModelPolicyInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.GetConfiguredAudienceModelPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) GetTrainingDataset(ctx context.Context, params *cleanroomsml.GetTrainingDatasetInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.GetTrainingDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) ListAudienceExportJobs(ctx context.Context, params *cleanroomsml.ListAudienceExportJobsInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.ListAudienceExportJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) ListAudienceGenerationJobs(ctx context.Context, params *cleanroomsml.ListAudienceGenerationJobsInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.ListAudienceGenerationJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) ListAudienceModels(ctx context.Context, params *cleanroomsml.ListAudienceModelsInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.ListAudienceModelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) ListConfiguredAudienceModels(ctx context.Context, params *cleanroomsml.ListConfiguredAudienceModelsInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.ListConfiguredAudienceModelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) ListTagsForResource(ctx context.Context, params *cleanroomsml.ListTagsForResourceInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) ListTrainingDatasets(ctx context.Context, params *cleanroomsml.ListTrainingDatasetsInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.ListTrainingDatasetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) Options() cleanroomsml.Options {
	ret := _m.Called()
...
func (_m *CleanroomsmlClient) PutConfiguredAudienceModelPolicy(ctx context.Context, params *cleanroomsml.PutConfiguredAudienceModelPolicyInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.PutConfiguredAudienceModelPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) StartAudienceExportJob(ctx context.Context, params *cleanroomsml.StartAudienceExportJobInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.StartAudienceExportJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) StartAudienceGenerationJob(ctx context.Context, params *cleanroomsml.StartAudienceGenerationJobInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.StartAudienceGenerationJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) TagResource(ctx context.Context, params *cleanroomsml.TagResourceInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) UntagResource(ctx context.Context, params *cleanroomsml.UntagResourceInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CleanroomsmlClient) UpdateConfiguredAudienceModel(ctx context.Context, params *cleanroomsml.UpdateConfiguredAudienceModelInput, optFns ...func(*cleanroomsml.Options)) (*cleanroomsml.UpdateConfiguredAudienceModelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCleanroomsmlClient creates a new instance of CleanroomsmlClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCleanroomsmlClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CleanroomsmlClient {
	mock := &CleanroomsmlClient{}
	mock.Mock.Test(t)
