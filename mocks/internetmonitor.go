...
// InternetmonitorClient is an autogenerated mock type for the InternetmonitorClient type
type InternetmonitorClient struct {
	mock.Mock
}

// CreateMonitor provides a mock function with given fields: ctx, params, optFns
func (_m *InternetmonitorClient) CreateMonitor(ctx context.Context, params *internetmonitor.CreateMonitorInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.CreateMonitorOutput, error) {
...
func (_m *InternetmonitorClient) DeleteMonitor(ctx context.Context, params *internetmonitor.DeleteMonitorInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.DeleteMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) GetHealthEvent(ctx context.Context, params *internetmonitor.GetHealthEventInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.GetHealthEventOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) GetMonitor(ctx context.Context, params *internetmonitor.GetMonitorInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.GetMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) GetQueryResults(ctx context.Context, params *internetmonitor.GetQueryResultsInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.GetQueryResultsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) GetQueryStatus(ctx context.Context, params *internetmonitor.GetQueryStatusInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.GetQueryStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) ListHealthEvents(ctx context.Context, params *internetmonitor.ListHealthEventsInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.ListHealthEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) ListMonitors(ctx context.Context, params *internetmonitor.ListMonitorsInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.ListMonitorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) ListTagsForResource(ctx context.Context, params *internetmonitor.ListTagsForResourceInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) Options() internetmonitor.Options {
	ret := _m.Called()
...
func (_m *InternetmonitorClient) StartQuery(ctx context.Context, params *internetmonitor.StartQueryInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.StartQueryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) StopQuery(ctx context.Context, params *internetmonitor.StopQueryInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.StopQueryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) TagResource(ctx context.Context, params *internetmonitor.TagResourceInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) UntagResource(ctx context.Context, params *internetmonitor.UntagResourceInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *InternetmonitorClient) UpdateMonitor(ctx context.Context, params *internetmonitor.UpdateMonitorInput, optFns ...func(*internetmonitor.Options)) (*internetmonitor.UpdateMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewInternetmonitorClient creates a new instance of InternetmonitorClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewInternetmonitorClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *InternetmonitorClient {
	mock := &InternetmonitorClient{}
	mock.Mock.Test(t)
