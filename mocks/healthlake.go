...
// HealthlakeClient is an autogenerated mock type for the HealthlakeClient type
type HealthlakeClient struct {
	mock.Mock
}

// CreateFHIRDatastore provides a mock function with given fields: ctx, params, optFns
func (_m *HealthlakeClient) CreateFHIRDatastore(ctx context.Context, params *healthlake.CreateFHIRDatastoreInput, optFns ...func(*healthlake.Options)) (*healthlake.CreateFHIRDatastoreOutput, error) {
...
func (_m *HealthlakeClient) DeleteFHIRDatastore(ctx context.Context, params *healthlake.DeleteFHIRDatastoreInput, optFns ...func(*healthlake.Options)) (*healthlake.DeleteFHIRDatastoreOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) DescribeFHIRDatastore(ctx context.Context, params *healthlake.DescribeFHIRDatastoreInput, optFns ...func(*healthlake.Options)) (*healthlake.DescribeFHIRDatastoreOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) DescribeFHIRExportJob(ctx context.Context, params *healthlake.DescribeFHIRExportJobInput, optFns ...func(*healthlake.Options)) (*healthlake.DescribeFHIRExportJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) DescribeFHIRImportJob(ctx context.Context, params *healthlake.DescribeFHIRImportJobInput, optFns ...func(*healthlake.Options)) (*healthlake.DescribeFHIRImportJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) ListFHIRDatastores(ctx context.Context, params *healthlake.ListFHIRDatastoresInput, optFns ...func(*healthlake.Options)) (*healthlake.ListFHIRDatastoresOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) ListFHIRExportJobs(ctx context.Context, params *healthlake.ListFHIRExportJobsInput, optFns ...func(*healthlake.Options)) (*healthlake.ListFHIRExportJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) ListFHIRImportJobs(ctx context.Context, params *healthlake.ListFHIRImportJobsInput, optFns ...func(*healthlake.Options)) (*healthlake.ListFHIRImportJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) ListTagsForResource(ctx context.Context, params *healthlake.ListTagsForResourceInput, optFns ...func(*healthlake.Options)) (*healthlake.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) Options() healthlake.Options {
	ret := _m.Called()
...
func (_m *HealthlakeClient) StartFHIRExportJob(ctx context.Context, params *healthlake.StartFHIRExportJobInput, optFns ...func(*healthlake.Options)) (*healthlake.StartFHIRExportJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) StartFHIRImportJob(ctx context.Context, params *healthlake.StartFHIRImportJobInput, optFns ...func(*healthlake.Options)) (*healthlake.StartFHIRImportJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) TagResource(ctx context.Context, params *healthlake.TagResourceInput, optFns ...func(*healthlake.Options)) (*healthlake.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthlakeClient) UntagResource(ctx context.Context, params *healthlake.UntagResourceInput, optFns ...func(*healthlake.Options)) (*healthlake.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewHealthlakeClient creates a new instance of HealthlakeClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewHealthlakeClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *HealthlakeClient {
	mock := &HealthlakeClient{}
	mock.Mock.Test(t)
