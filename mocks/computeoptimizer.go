...
// ComputeoptimizerClient is an autogenerated mock type for the ComputeoptimizerClient type
type ComputeoptimizerClient struct {
	mock.Mock
}

// DeleteRecommendationPreferences provides a mock function with given fields: ctx, params, optFns
func (_m *ComputeoptimizerClient) DeleteRecommendationPreferences(ctx context.Context, params *computeoptimizer.DeleteRecommendationPreferencesInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.DeleteRecommendationPreferencesOutput, error) {
...
func (_m *ComputeoptimizerClient) DescribeRecommendationExportJobs(ctx context.Context, params *computeoptimizer.DescribeRecommendationExportJobsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.DescribeRecommendationExportJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) ExportAutoScalingGroupRecommendations(ctx context.Context, params *computeoptimizer.ExportAutoScalingGroupRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.ExportAutoScalingGroupRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) ExportEBSVolumeRecommendations(ctx context.Context, params *computeoptimizer.ExportEBSVolumeRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.ExportEBSVolumeRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) ExportEC2InstanceRecommendations(ctx context.Context, params *computeoptimizer.ExportEC2InstanceRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.ExportEC2InstanceRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) ExportECSServiceRecommendations(ctx context.Context, params *computeoptimizer.ExportECSServiceRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.ExportECSServiceRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) ExportLambdaFunctionRecommendations(ctx context.Context, params *computeoptimizer.ExportLambdaFunctionRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.ExportLambdaFunctionRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) ExportLicenseRecommendations(ctx context.Context, params *computeoptimizer.ExportLicenseRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.ExportLicenseRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetAutoScalingGroupRecommendations(ctx context.Context, params *computeoptimizer.GetAutoScalingGroupRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetAutoScalingGroupRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetEBSVolumeRecommendations(ctx context.Context, params *computeoptimizer.GetEBSVolumeRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetEBSVolumeRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetEC2InstanceRecommendations(ctx context.Context, params *computeoptimizer.GetEC2InstanceRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetEC2InstanceRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetEC2RecommendationProjectedMetrics(ctx context.Context, params *computeoptimizer.GetEC2RecommendationProjectedMetricsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetEC2RecommendationProjectedMetricsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetECSServiceRecommendationProjectedMetrics(ctx context.Context, params *computeoptimizer.GetECSServiceRecommendationProjectedMetricsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetECSServiceRecommendationProjectedMetricsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetECSServiceRecommendations(ctx context.Context, params *computeoptimizer.GetECSServiceRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetECSServiceRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetEffectiveRecommendationPreferences(ctx context.Context, params *computeoptimizer.GetEffectiveRecommendationPreferencesInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetEffectiveRecommendationPreferencesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetEnrollmentStatus(ctx context.Context, params *computeoptimizer.GetEnrollmentStatusInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetEnrollmentStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetEnrollmentStatusesForOrganization(ctx context.Context, params *computeoptimizer.GetEnrollmentStatusesForOrganizationInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetEnrollmentStatusesForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetLambdaFunctionRecommendations(ctx context.Context, params *computeoptimizer.GetLambdaFunctionRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetLambdaFunctionRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetLicenseRecommendations(ctx context.Context, params *computeoptimizer.GetLicenseRecommendationsInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetLicenseRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetRecommendationPreferences(ctx context.Context, params *computeoptimizer.GetRecommendationPreferencesInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetRecommendationPreferencesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) GetRecommendationSummaries(ctx context.Context, params *computeoptimizer.GetRecommendationSummariesInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.GetRecommendationSummariesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) Options() computeoptimizer.Options {
	ret := _m.Called()
...
func (_m *ComputeoptimizerClient) PutRecommendationPreferences(ctx context.Context, params *computeoptimizer.PutRecommendationPreferencesInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.PutRecommendationPreferencesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ComputeoptimizerClient) UpdateEnrollmentStatus(ctx context.Context, params *computeoptimizer.UpdateEnrollmentStatusInput, optFns ...func(*computeoptimizer.Options)) (*computeoptimizer.UpdateEnrollmentStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewComputeoptimizerClient creates a new instance of ComputeoptimizerClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewComputeoptimizerClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ComputeoptimizerClient {
	mock := &ComputeoptimizerClient{}
	mock.Mock.Test(t)
