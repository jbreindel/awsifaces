...
// SsoadminClient is an autogenerated mock type for the SsoadminClient type
type SsoadminClient struct {
	mock.Mock
}

// AttachCustomerManagedPolicyReferenceToPermissionSet provides a mock function with given fields: ctx, params, optFns
func (_m *SsoadminClient) AttachCustomerManagedPolicyReferenceToPermissionSet(ctx context.Context, params *ssoadmin.AttachCustomerManagedPolicyReferenceToPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.AttachCustomerManagedPolicyReferenceToPermissionSetOutput, error) {
...
func (_m *SsoadminClient) AttachManagedPolicyToPermissionSet(ctx context.Context, params *ssoadmin.AttachManagedPolicyToPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.AttachManagedPolicyToPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreateAccountAssignment(ctx context.Context, params *ssoadmin.CreateAccountAssignmentInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreateAccountAssignmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreateApplication(ctx context.Context, params *ssoadmin.CreateApplicationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreateApplicationAssignment(ctx context.Context, params *ssoadmin.CreateApplicationAssignmentInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreateApplicationAssignmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreateInstance(ctx context.Context, params *ssoadmin.CreateInstanceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreateInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreateInstanceAccessControlAttributeConfiguration(ctx context.Context, params *ssoadmin.CreateInstanceAccessControlAttributeConfigurationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreateInstanceAccessControlAttributeConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreatePermissionSet(ctx context.Context, params *ssoadmin.CreatePermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreatePermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) CreateTrustedTokenIssuer(ctx context.Context, params *ssoadmin.CreateTrustedTokenIssuerInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.CreateTrustedTokenIssuerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteAccountAssignment(ctx context.Context, params *ssoadmin.DeleteAccountAssignmentInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteAccountAssignmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteApplication(ctx context.Context, params *ssoadmin.DeleteApplicationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteApplicationAccessScope(ctx context.Context, params *ssoadmin.DeleteApplicationAccessScopeInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteApplicationAccessScopeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteApplicationAssignment(ctx context.Context, params *ssoadmin.DeleteApplicationAssignmentInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteApplicationAssignmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteApplicationAuthenticationMethod(ctx context.Context, params *ssoadmin.DeleteApplicationAuthenticationMethodInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteApplicationAuthenticationMethodOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteApplicationGrant(ctx context.Context, params *ssoadmin.DeleteApplicationGrantInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteApplicationGrantOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteInlinePolicyFromPermissionSet(ctx context.Context, params *ssoadmin.DeleteInlinePolicyFromPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteInlinePolicyFromPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteInstance(ctx context.Context, params *ssoadmin.DeleteInstanceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteInstanceAccessControlAttributeConfiguration(ctx context.Context, params *ssoadmin.DeleteInstanceAccessControlAttributeConfigurationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteInstanceAccessControlAttributeConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeletePermissionSet(ctx context.Context, params *ssoadmin.DeletePermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeletePermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeletePermissionsBoundaryFromPermissionSet(ctx context.Context, params *ssoadmin.DeletePermissionsBoundaryFromPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeletePermissionsBoundaryFromPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DeleteTrustedTokenIssuer(ctx context.Context, params *ssoadmin.DeleteTrustedTokenIssuerInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DeleteTrustedTokenIssuerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeAccountAssignmentCreationStatus(ctx context.Context, params *ssoadmin.DescribeAccountAssignmentCreationStatusInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeAccountAssignmentCreationStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeAccountAssignmentDeletionStatus(ctx context.Context, params *ssoadmin.DescribeAccountAssignmentDeletionStatusInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeAccountAssignmentDeletionStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeApplication(ctx context.Context, params *ssoadmin.DescribeApplicationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeApplicationAssignment(ctx context.Context, params *ssoadmin.DescribeApplicationAssignmentInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeApplicationAssignmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeApplicationProvider(ctx context.Context, params *ssoadmin.DescribeApplicationProviderInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeApplicationProviderOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeInstance(ctx context.Context, params *ssoadmin.DescribeInstanceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeInstanceAccessControlAttributeConfiguration(ctx context.Context, params *ssoadmin.DescribeInstanceAccessControlAttributeConfigurationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeInstanceAccessControlAttributeConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribePermissionSet(ctx context.Context, params *ssoadmin.DescribePermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribePermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribePermissionSetProvisioningStatus(ctx context.Context, params *ssoadmin.DescribePermissionSetProvisioningStatusInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribePermissionSetProvisioningStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DescribeTrustedTokenIssuer(ctx context.Context, params *ssoadmin.DescribeTrustedTokenIssuerInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DescribeTrustedTokenIssuerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DetachCustomerManagedPolicyReferenceFromPermissionSet(ctx context.Context, params *ssoadmin.DetachCustomerManagedPolicyReferenceFromPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DetachCustomerManagedPolicyReferenceFromPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) DetachManagedPolicyFromPermissionSet(ctx context.Context, params *ssoadmin.DetachManagedPolicyFromPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.DetachManagedPolicyFromPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) GetApplicationAccessScope(ctx context.Context, params *ssoadmin.GetApplicationAccessScopeInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.GetApplicationAccessScopeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) GetApplicationAssignmentConfiguration(ctx context.Context, params *ssoadmin.GetApplicationAssignmentConfigurationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.GetApplicationAssignmentConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) GetApplicationAuthenticationMethod(ctx context.Context, params *ssoadmin.GetApplicationAuthenticationMethodInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.GetApplicationAuthenticationMethodOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) GetApplicationGrant(ctx context.Context, params *ssoadmin.GetApplicationGrantInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.GetApplicationGrantOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) GetInlinePolicyForPermissionSet(ctx context.Context, params *ssoadmin.GetInlinePolicyForPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.GetInlinePolicyForPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) GetPermissionsBoundaryForPermissionSet(ctx context.Context, params *ssoadmin.GetPermissionsBoundaryForPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.GetPermissionsBoundaryForPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListAccountAssignmentCreationStatus(ctx context.Context, params *ssoadmin.ListAccountAssignmentCreationStatusInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListAccountAssignmentCreationStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListAccountAssignmentDeletionStatus(ctx context.Context, params *ssoadmin.ListAccountAssignmentDeletionStatusInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListAccountAssignmentDeletionStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListAccountAssignments(ctx context.Context, params *ssoadmin.ListAccountAssignmentsInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListAccountAssignmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListAccountAssignmentsForPrincipal(ctx context.Context, params *ssoadmin.ListAccountAssignmentsForPrincipalInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListAccountAssignmentsForPrincipalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListAccountsForProvisionedPermissionSet(ctx context.Context, params *ssoadmin.ListAccountsForProvisionedPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListAccountsForProvisionedPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplicationAccessScopes(ctx context.Context, params *ssoadmin.ListApplicationAccessScopesInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationAccessScopesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplicationAssignments(ctx context.Context, params *ssoadmin.ListApplicationAssignmentsInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationAssignmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplicationAssignmentsForPrincipal(ctx context.Context, params *ssoadmin.ListApplicationAssignmentsForPrincipalInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationAssignmentsForPrincipalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplicationAuthenticationMethods(ctx context.Context, params *ssoadmin.ListApplicationAuthenticationMethodsInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationAuthenticationMethodsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplicationGrants(ctx context.Context, params *ssoadmin.ListApplicationGrantsInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationGrantsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplicationProviders(ctx context.Context, params *ssoadmin.ListApplicationProvidersInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationProvidersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListApplications(ctx context.Context, params *ssoadmin.ListApplicationsInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListCustomerManagedPolicyReferencesInPermissionSet(ctx context.Context, params *ssoadmin.ListCustomerManagedPolicyReferencesInPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListCustomerManagedPolicyReferencesInPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListInstances(ctx context.Context, params *ssoadmin.ListInstancesInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListInstancesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListManagedPoliciesInPermissionSet(ctx context.Context, params *ssoadmin.ListManagedPoliciesInPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListManagedPoliciesInPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListPermissionSetProvisioningStatus(ctx context.Context, params *ssoadmin.ListPermissionSetProvisioningStatusInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListPermissionSetProvisioningStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListPermissionSets(ctx context.Context, params *ssoadmin.ListPermissionSetsInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListPermissionSetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListPermissionSetsProvisionedToAccount(ctx context.Context, params *ssoadmin.ListPermissionSetsProvisionedToAccountInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListPermissionSetsProvisionedToAccountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListTagsForResource(ctx context.Context, params *ssoadmin.ListTagsForResourceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) ListTrustedTokenIssuers(ctx context.Context, params *ssoadmin.ListTrustedTokenIssuersInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ListTrustedTokenIssuersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) Options() ssoadmin.Options {
	ret := _m.Called()
...
func (_m *SsoadminClient) ProvisionPermissionSet(ctx context.Context, params *ssoadmin.ProvisionPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.ProvisionPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) PutApplicationAccessScope(ctx context.Context, params *ssoadmin.PutApplicationAccessScopeInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.PutApplicationAccessScopeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) PutApplicationAssignmentConfiguration(ctx context.Context, params *ssoadmin.PutApplicationAssignmentConfigurationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.PutApplicationAssignmentConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) PutApplicationAuthenticationMethod(ctx context.Context, params *ssoadmin.PutApplicationAuthenticationMethodInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.PutApplicationAuthenticationMethodOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) PutApplicationGrant(ctx context.Context, params *ssoadmin.PutApplicationGrantInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.PutApplicationGrantOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) PutInlinePolicyToPermissionSet(ctx context.Context, params *ssoadmin.PutInlinePolicyToPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.PutInlinePolicyToPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) PutPermissionsBoundaryToPermissionSet(ctx context.Context, params *ssoadmin.PutPermissionsBoundaryToPermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.PutPermissionsBoundaryToPermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) TagResource(ctx context.Context, params *ssoadmin.TagResourceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) UntagResource(ctx context.Context, params *ssoadmin.UntagResourceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) UpdateApplication(ctx context.Context, params *ssoadmin.UpdateApplicationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.UpdateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) UpdateInstance(ctx context.Context, params *ssoadmin.UpdateInstanceInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.UpdateInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) UpdateInstanceAccessControlAttributeConfiguration(ctx context.Context, params *ssoadmin.UpdateInstanceAccessControlAttributeConfigurationInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.UpdateInstanceAccessControlAttributeConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) UpdatePermissionSet(ctx context.Context, params *ssoadmin.UpdatePermissionSetInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.UpdatePermissionSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsoadminClient) UpdateTrustedTokenIssuer(ctx context.Context, params *ssoadmin.UpdateTrustedTokenIssuerInput, optFns ...func(*ssoadmin.Options)) (*ssoadmin.UpdateTrustedTokenIssuerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSsoadminClient creates a new instance of SsoadminClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSsoadminClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SsoadminClient {
	mock := &SsoadminClient{}
