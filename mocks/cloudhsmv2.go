...
// Cloudhsmv2Client is an autogenerated mock type for the Cloudhsmv2Client type
type Cloudhsmv2Client struct {
	mock.Mock
}

// CopyBackupToRegion provides a mock function with given fields: ctx, params, optFns
func (_m *Cloudhsmv2Client) CopyBackupToRegion(ctx context.Context, params *cloudhsmv2.CopyBackupToRegionInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.CopyBackupToRegionOutput, error) {
...
func (_m *Cloudhsmv2Client) CreateCluster(ctx context.Context, params *cloudhsmv2.CreateClusterInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.CreateClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) CreateHsm(ctx context.Context, params *cloudhsmv2.CreateHsmInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.CreateHsmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) DeleteBackup(ctx context.Context, params *cloudhsmv2.DeleteBackupInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.DeleteBackupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) DeleteCluster(ctx context.Context, params *cloudhsmv2.DeleteClusterInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.DeleteClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) DeleteHsm(ctx context.Context, params *cloudhsmv2.DeleteHsmInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.DeleteHsmOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) DescribeBackups(ctx context.Context, params *cloudhsmv2.DescribeBackupsInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.DescribeBackupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) DescribeClusters(ctx context.Context, params *cloudhsmv2.DescribeClustersInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.DescribeClustersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) InitializeCluster(ctx context.Context, params *cloudhsmv2.InitializeClusterInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.InitializeClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) ListTags(ctx context.Context, params *cloudhsmv2.ListTagsInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.ListTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) ModifyBackupAttributes(ctx context.Context, params *cloudhsmv2.ModifyBackupAttributesInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.ModifyBackupAttributesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) ModifyCluster(ctx context.Context, params *cloudhsmv2.ModifyClusterInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.ModifyClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) Options() cloudhsmv2.Options {
	ret := _m.Called()
...
func (_m *Cloudhsmv2Client) RestoreBackup(ctx context.Context, params *cloudhsmv2.RestoreBackupInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.RestoreBackupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) TagResource(ctx context.Context, params *cloudhsmv2.TagResourceInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Cloudhsmv2Client) UntagResource(ctx context.Context, params *cloudhsmv2.UntagResourceInput, optFns ...func(*cloudhsmv2.Options)) (*cloudhsmv2.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCloudhsmv2Client creates a new instance of Cloudhsmv2Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCloudhsmv2Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *Cloudhsmv2Client {
	mock := &Cloudhsmv2Client{}
	mock.Mock.Test(t)
