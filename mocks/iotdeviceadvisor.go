...
// IotdeviceadvisorClient is an autogenerated mock type for the IotdeviceadvisorClient type
type IotdeviceadvisorClient struct {
	mock.Mock
}

// CreateSuiteDefinition provides a mock function with given fields: ctx, params, optFns
func (_m *IotdeviceadvisorClient) CreateSuiteDefinition(ctx context.Context, params *iotdeviceadvisor.CreateSuiteDefinitionInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.CreateSuiteDefinitionOutput, error) {
...
func (_m *IotdeviceadvisorClient) DeleteSuiteDefinition(ctx context.Context, params *iotdeviceadvisor.DeleteSuiteDefinitionInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.DeleteSuiteDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) GetEndpoint(ctx context.Context, params *iotdeviceadvisor.GetEndpointInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.GetEndpointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) GetSuiteDefinition(ctx context.Context, params *iotdeviceadvisor.GetSuiteDefinitionInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.GetSuiteDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) GetSuiteRun(ctx context.Context, params *iotdeviceadvisor.GetSuiteRunInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.GetSuiteRunOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) GetSuiteRunReport(ctx context.Context, params *iotdeviceadvisor.GetSuiteRunReportInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.GetSuiteRunReportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) ListSuiteDefinitions(ctx context.Context, params *iotdeviceadvisor.ListSuiteDefinitionsInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.ListSuiteDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) ListSuiteRuns(ctx context.Context, params *iotdeviceadvisor.ListSuiteRunsInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.ListSuiteRunsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) ListTagsForResource(ctx context.Context, params *iotdeviceadvisor.ListTagsForResourceInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) Options() iotdeviceadvisor.Options {
	ret := _m.Called()
...
func (_m *IotdeviceadvisorClient) StartSuiteRun(ctx context.Context, params *iotdeviceadvisor.StartSuiteRunInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.StartSuiteRunOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) StopSuiteRun(ctx context.Context, params *iotdeviceadvisor.StopSuiteRunInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.StopSuiteRunOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) TagResource(ctx context.Context, params *iotdeviceadvisor.TagResourceInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) UntagResource(ctx context.Context, params *iotdeviceadvisor.UntagResourceInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotdeviceadvisorClient) UpdateSuiteDefinition(ctx context.Context, params *iotdeviceadvisor.UpdateSuiteDefinitionInput, optFns ...func(*iotdeviceadvisor.Options)) (*iotdeviceadvisor.UpdateSuiteDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIotdeviceadvisorClient creates a new instance of IotdeviceadvisorClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIotdeviceadvisorClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IotdeviceadvisorClient {
	mock := &IotdeviceadvisorClient{}
	mock.Mock.Test(t)
