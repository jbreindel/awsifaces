...
// CodegurusecurityClient is an autogenerated mock type for the CodegurusecurityClient type
type CodegurusecurityClient struct {
	mock.Mock
}

// BatchGetFindings provides a mock function with given fields: ctx, params, optFns
func (_m *CodegurusecurityClient) BatchGetFindings(ctx context.Context, params *codegurusecurity.BatchGetFindingsInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.BatchGetFindingsOutput, error) {
...
func (_m *CodegurusecurityClient) CreateScan(ctx context.Context, params *codegurusecurity.CreateScanInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.CreateScanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) CreateUploadUrl(ctx context.Context, params *codegurusecurity.CreateUploadUrlInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.CreateUploadUrlOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) GetAccountConfiguration(ctx context.Context, params *codegurusecurity.GetAccountConfigurationInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.GetAccountConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) GetFindings(ctx context.Context, params *codegurusecurity.GetFindingsInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.GetFindingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) GetMetricsSummary(ctx context.Context, params *codegurusecurity.GetMetricsSummaryInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.GetMetricsSummaryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) GetScan(ctx context.Context, params *codegurusecurity.GetScanInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.GetScanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) ListFindingsMetrics(ctx context.Context, params *codegurusecurity.ListFindingsMetricsInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.ListFindingsMetricsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) ListScans(ctx context.Context, params *codegurusecurity.ListScansInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.ListScansOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) ListTagsForResource(ctx context.Context, params *codegurusecurity.ListTagsForResourceInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) Options() codegurusecurity.Options {
	ret := _m.Called()
...
func (_m *CodegurusecurityClient) TagResource(ctx context.Context, params *codegurusecurity.TagResourceInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) UntagResource(ctx context.Context, params *codegurusecurity.UntagResourceInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodegurusecurityClient) UpdateAccountConfiguration(ctx context.Context, params *codegurusecurity.UpdateAccountConfigurationInput, optFns ...func(*codegurusecurity.Options)) (*codegurusecurity.UpdateAccountConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCodegurusecurityClient creates a new instance of CodegurusecurityClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCodegurusecurityClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CodegurusecurityClient {
	mock := &CodegurusecurityClient{}
	mock.Mock.Test(t)
