...
// S3outpostsClient is an autogenerated mock type for the S3outpostsClient type
type S3outpostsClient struct {
	mock.Mock
}

// CreateEndpoint provides a mock function with given fields: ctx, params, optFns
func (_m *S3outpostsClient) CreateEndpoint(ctx context.Context, params *s3outposts.CreateEndpointInput, optFns ...func(*s3outposts.Options)) (*s3outposts.CreateEndpointOutput, error) {
...
func (_m *S3outpostsClient) DeleteEndpoint(ctx context.Context, params *s3outposts.DeleteEndpointInput, optFns ...func(*s3outposts.Options)) (*s3outposts.DeleteEndpointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *S3outpostsClient) ListEndpoints(ctx context.Context, params *s3outposts.ListEndpointsInput, optFns ...func(*s3outposts.Options)) (*s3outposts.ListEndpointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *S3outpostsClient) ListOutpostsWithS3(ctx context.Context, params *s3outposts.ListOutpostsWithS3Input, optFns ...func(*s3outposts.Options)) (*s3outposts.ListOutpostsWithS3Output, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *S3outpostsClient) ListSharedEndpoints(ctx context.Context, params *s3outposts.ListSharedEndpointsInput, optFns ...func(*s3outposts.Options)) (*s3outposts.ListSharedEndpointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *S3outpostsClient) Options() s3outposts.Options {
	ret := _m.Called()
...
// NewS3outpostsClient creates a new instance of S3outpostsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewS3outpostsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *S3outpostsClient {
	mock := &S3outpostsClient{}
	mock.Mock.Test(t)
