...
// CodeconnectionsClient is an autogenerated mock type for the CodeconnectionsClient type
type CodeconnectionsClient struct {
	mock.Mock
}

// CreateConnection provides a mock function with given fields: ctx, params, optFns
func (_m *CodeconnectionsClient) CreateConnection(ctx context.Context, params *codeconnections.CreateConnectionInput, optFns ...func(*codeconnections.Options)) (*codeconnections.CreateConnectionOutput, error) {
...
func (_m *CodeconnectionsClient) CreateHost(ctx context.Context, params *codeconnections.CreateHostInput, optFns ...func(*codeconnections.Options)) (*codeconnections.CreateHostOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) CreateRepositoryLink(ctx context.Context, params *codeconnections.CreateRepositoryLinkInput, optFns ...func(*codeconnections.Options)) (*codeconnections.CreateRepositoryLinkOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) CreateSyncConfiguration(ctx context.Context, params *codeconnections.CreateSyncConfigurationInput, optFns ...func(*codeconnections.Options)) (*codeconnections.CreateSyncConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) DeleteConnection(ctx context.Context, params *codeconnections.DeleteConnectionInput, optFns ...func(*codeconnections.Options)) (*codeconnections.DeleteConnectionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) DeleteHost(ctx context.Context, params *codeconnections.DeleteHostInput, optFns ...func(*codeconnections.Options)) (*codeconnections.DeleteHostOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) DeleteRepositoryLink(ctx context.Context, params *codeconnections.DeleteRepositoryLinkInput, optFns ...func(*codeconnections.Options)) (*codeconnections.DeleteRepositoryLinkOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) DeleteSyncConfiguration(ctx context.Context, params *codeconnections.DeleteSyncConfigurationInput, optFns ...func(*codeconnections.Options)) (*codeconnections.DeleteSyncConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetConnection(ctx context.Context, params *codeconnections.GetConnectionInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetConnectionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetHost(ctx context.Context, params *codeconnections.GetHostInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetHostOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetRepositoryLink(ctx context.Context, params *codeconnections.GetRepositoryLinkInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetRepositoryLinkOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetRepositorySyncStatus(ctx context.Context, params *codeconnections.GetRepositorySyncStatusInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetRepositorySyncStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetResourceSyncStatus(ctx context.Context, params *codeconnections.GetResourceSyncStatusInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetResourceSyncStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetSyncBlockerSummary(ctx context.Context, params *codeconnections.GetSyncBlockerSummaryInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetSyncBlockerSummaryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) GetSyncConfiguration(ctx context.Context, params *codeconnections.GetSyncConfigurationInput, optFns ...func(*codeconnections.Options)) (*codeconnections.GetSyncConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) ListConnections(ctx context.Context, params *codeconnections.ListConnectionsInput, optFns ...func(*codeconnections.Options)) (*codeconnections.ListConnectionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) ListHosts(ctx context.Context, params *codeconnections.ListHostsInput, optFns ...func(*codeconnections.Options)) (*codeconnections.ListHostsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) ListRepositoryLinks(ctx context.Context, params *codeconnections.ListRepositoryLinksInput, optFns ...func(*codeconnections.Options)) (*codeconnections.ListRepositoryLinksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) ListRepositorySyncDefinitions(ctx context.Context, params *codeconnections.ListRepositorySyncDefinitionsInput, optFns ...func(*codeconnections.Options)) (*codeconnections.ListRepositorySyncDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) ListSyncConfigurations(ctx context.Context, params *codeconnections.ListSyncConfigurationsInput, optFns ...func(*codeconnections.Options)) (*codeconnections.ListSyncConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) ListTagsForResource(ctx context.Context, params *codeconnections.ListTagsForResourceInput, optFns ...func(*codeconnections.Options)) (*codeconnections.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) Options() codeconnections.Options {
	ret := _m.Called()
...
func (_m *CodeconnectionsClient) TagResource(ctx context.Context, params *codeconnections.TagResourceInput, optFns ...func(*codeconnections.Options)) (*codeconnections.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) UntagResource(ctx context.Context, params *codeconnections.UntagResourceInput, optFns ...func(*codeconnections.Options)) (*codeconnections.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) UpdateHost(ctx context.Context, params *codeconnections.UpdateHostInput, optFns ...func(*codeconnections.Options)) (*codeconnections.UpdateHostOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) UpdateRepositoryLink(ctx context.Context, params *codeconnections.UpdateRepositoryLinkInput, optFns ...func(*codeconnections.Options)) (*codeconnections.UpdateRepositoryLinkOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) UpdateSyncBlocker(ctx context.Context, params *codeconnections.UpdateSyncBlockerInput, optFns ...func(*codeconnections.Options)) (*codeconnections.UpdateSyncBlockerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodeconnectionsClient) UpdateSyncConfiguration(ctx context.Context, params *codeconnections.UpdateSyncConfigurationInput, optFns ...func(*codeconnections.Options)) (*codeconnections.UpdateSyncConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCodeconnectionsClient creates a new instance of CodeconnectionsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCodeconnectionsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CodeconnectionsClient {
	mock := &CodeconnectionsClient{}
	mock.Mock.Test(t)
