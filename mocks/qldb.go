...
// QldbClient is an autogenerated mock type for the QldbClient type
type QldbClient struct {
	mock.Mock
}

// CancelJournalKinesisStream provides a mock function with given fields: ctx, params, optFns
func (_m *QldbClient) CancelJournalKinesisStream(ctx context.Context, params *qldb.CancelJournalKinesisStreamInput, optFns ...func(*qldb.Options)) (*qldb.CancelJournalKinesisStreamOutput, error) {
...
func (_m *QldbClient) CreateLedger(ctx context.Context, params *qldb.CreateLedgerInput, optFns ...func(*qldb.Options)) (*qldb.CreateLedgerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) DeleteLedger(ctx context.Context, params *qldb.DeleteLedgerInput, optFns ...func(*qldb.Options)) (*qldb.DeleteLedgerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) DescribeJournalKinesisStream(ctx context.Context, params *qldb.DescribeJournalKinesisStreamInput, optFns ...func(*qldb.Options)) (*qldb.DescribeJournalKinesisStreamOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) DescribeJournalS3Export(ctx context.Context, params *qldb.DescribeJournalS3ExportInput, optFns ...func(*qldb.Options)) (*qldb.DescribeJournalS3ExportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) DescribeLedger(ctx context.Context, params *qldb.DescribeLedgerInput, optFns ...func(*qldb.Options)) (*qldb.DescribeLedgerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) ExportJournalToS3(ctx context.Context, params *qldb.ExportJournalToS3Input, optFns ...func(*qldb.Options)) (*qldb.ExportJournalToS3Output, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) GetBlock(ctx context.Context, params *qldb.GetBlockInput, optFns ...func(*qldb.Options)) (*qldb.GetBlockOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) GetDigest(ctx context.Context, params *qldb.GetDigestInput, optFns ...func(*qldb.Options)) (*qldb.GetDigestOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) GetRevision(ctx context.Context, params *qldb.GetRevisionInput, optFns ...func(*qldb.Options)) (*qldb.GetRevisionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) ListJournalKinesisStreamsForLedger(ctx context.Context, params *qldb.ListJournalKinesisStreamsForLedgerInput, optFns ...func(*qldb.Options)) (*qldb.ListJournalKinesisStreamsForLedgerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) ListJournalS3Exports(ctx context.Context, params *qldb.ListJournalS3ExportsInput, optFns ...func(*qldb.Options)) (*qldb.ListJournalS3ExportsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) ListJournalS3ExportsForLedger(ctx context.Context, params *qldb.ListJournalS3ExportsForLedgerInput, optFns ...func(*qldb.Options)) (*qldb.ListJournalS3ExportsForLedgerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) ListLedgers(ctx context.Context, params *qldb.ListLedgersInput, optFns ...func(*qldb.Options)) (*qldb.ListLedgersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) ListTagsForResource(ctx context.Context, params *qldb.ListTagsForResourceInput, optFns ...func(*qldb.Options)) (*qldb.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) Options() qldb.Options {
	ret := _m.Called()
...
func (_m *QldbClient) StreamJournalToKinesis(ctx context.Context, params *qldb.StreamJournalToKinesisInput, optFns ...func(*qldb.Options)) (*qldb.StreamJournalToKinesisOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) TagResource(ctx context.Context, params *qldb.TagResourceInput, optFns ...func(*qldb.Options)) (*qldb.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) UntagResource(ctx context.Context, params *qldb.UntagResourceInput, optFns ...func(*qldb.Options)) (*qldb.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) UpdateLedger(ctx context.Context, params *qldb.UpdateLedgerInput, optFns ...func(*qldb.Options)) (*qldb.UpdateLedgerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *QldbClient) UpdateLedgerPermissionsMode(ctx context.Context, params *qldb.UpdateLedgerPermissionsModeInput, optFns ...func(*qldb.Options)) (*qldb.UpdateLedgerPermissionsModeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewQldbClient creates a new instance of QldbClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewQldbClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *QldbClient {
	mock := &QldbClient{}
