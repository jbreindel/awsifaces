...
// NetworkmonitorClient is an autogenerated mock type for the NetworkmonitorClient type
type NetworkmonitorClient struct {
	mock.Mock
}

// CreateMonitor provides a mock function with given fields: ctx, params, optFns
func (_m *NetworkmonitorClient) CreateMonitor(ctx context.Context, params *networkmonitor.CreateMonitorInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.CreateMonitorOutput, error) {
...
func (_m *NetworkmonitorClient) CreateProbe(ctx context.Context, params *networkmonitor.CreateProbeInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.CreateProbeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) DeleteMonitor(ctx context.Context, params *networkmonitor.DeleteMonitorInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.DeleteMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) DeleteProbe(ctx context.Context, params *networkmonitor.DeleteProbeInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.DeleteProbeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) GetMonitor(ctx context.Context, params *networkmonitor.GetMonitorInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.GetMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) GetProbe(ctx context.Context, params *networkmonitor.GetProbeInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.GetProbeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) ListMonitors(ctx context.Context, params *networkmonitor.ListMonitorsInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.ListMonitorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) ListTagsForResource(ctx context.Context, params *networkmonitor.ListTagsForResourceInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) Options() networkmonitor.Options {
	ret := _m.Called()
...
func (_m *NetworkmonitorClient) TagResource(ctx context.Context, params *networkmonitor.TagResourceInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) UntagResource(ctx context.Context, params *networkmonitor.UntagResourceInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) UpdateMonitor(ctx context.Context, params *networkmonitor.UpdateMonitorInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.UpdateMonitorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *NetworkmonitorClient) UpdateProbe(ctx context.Context, params *networkmonitor.UpdateProbeInput, optFns ...func(*networkmonitor.Options)) (*networkmonitor.UpdateProbeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewNetworkmonitorClient creates a new instance of NetworkmonitorClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewNetworkmonitorClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *NetworkmonitorClient {
	mock := &NetworkmonitorClient{}
	mock.Mock.Test(t)
