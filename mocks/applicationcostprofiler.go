...
// ApplicationcostprofilerClient is an autogenerated mock type for the ApplicationcostprofilerClient type
type ApplicationcostprofilerClient struct {
	mock.Mock
}

// DeleteReportDefinition provides a mock function with given fields: ctx, params, optFns
func (_m *ApplicationcostprofilerClient) DeleteReportDefinition(ctx context.Context, params *applicationcostprofiler.DeleteReportDefinitionInput, optFns ...func(*applicationcostprofiler.Options)) (*applicationcostprofiler.DeleteReportDefinitionOutput, error) {
...
func (_m *ApplicationcostprofilerClient) GetReportDefinition(ctx context.Context, params *applicationcostprofiler.GetReportDefinitionInput, optFns ...func(*applicationcostprofiler.Options)) (*applicationcostprofiler.GetReportDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ApplicationcostprofilerClient) ImportApplicationUsage(ctx context.Context, params *applicationcostprofiler.ImportApplicationUsageInput, optFns ...func(*applicationcostprofiler.Options)) (*applicationcostprofiler.ImportApplicationUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ApplicationcostprofilerClient) ListReportDefinitions(ctx context.Context, params *applicationcostprofiler.ListReportDefinitionsInput, optFns ...func(*applicationcostprofiler.Options)) (*applicationcostprofiler.ListReportDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ApplicationcostprofilerClient) Options() applicationcostprofiler.Options {
	ret := _m.Called()
...
func (_m *ApplicationcostprofilerClient) PutReportDefinition(ctx context.Context, params *applicationcostprofiler.PutReportDefinitionInput, optFns ...func(*applicationcostprofiler.Options)) (*applicationcostprofiler.PutReportDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ApplicationcostprofilerClient) UpdateReportDefinition(ctx context.Context, params *applicationcostprofiler.UpdateReportDefinitionInput, optFns ...func(*applicationcostprofiler.Options)) (*applicationcostprofiler.UpdateReportDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewApplicationcostprofilerClient creates a new instance of ApplicationcostprofilerClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewApplicationcostprofilerClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ApplicationcostprofilerClient {
	mock := &ApplicationcostprofilerClient{}
	mock.Mock.Test(t)
