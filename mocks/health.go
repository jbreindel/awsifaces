...
func (_m *HealthClient) DescribeAffectedAccountsForOrganization(ctx context.Context, params *health.DescribeAffectedAccountsForOrganizationInput, optFns ...func(*health.Options)) (*health.DescribeAffectedAccountsForOrganizationOutput, error) {
...
func (_m *HealthClient) DescribeAffectedEntities(ctx context.Context, params *health.DescribeAffectedEntitiesInput, optFns ...func(*health.Options)) (*health.DescribeAffectedEntitiesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeAffectedEntitiesForOrganization(ctx context.Context, params *health.DescribeAffectedEntitiesForOrganizationInput, optFns ...func(*health.Options)) (*health.DescribeAffectedEntitiesForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEntityAggregates(ctx context.Context, params *health.DescribeEntityAggregatesInput, optFns ...func(*health.Options)) (*health.DescribeEntityAggregatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEntityAggregatesForOrganization(ctx context.Context, params *health.DescribeEntityAggregatesForOrganizationInput, optFns ...func(*health.Options)) (*health.DescribeEntityAggregatesForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEventAggregates(ctx context.Context, params *health.DescribeEventAggregatesInput, optFns ...func(*health.Options)) (*health.DescribeEventAggregatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEventDetails(ctx context.Context, params *health.DescribeEventDetailsInput, optFns ...func(*health.Options)) (*health.DescribeEventDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEventDetailsForOrganization(ctx context.Context, params *health.DescribeEventDetailsForOrganizationInput, optFns ...func(*health.Options)) (*health.DescribeEventDetailsForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEventTypes(ctx context.Context, params *health.DescribeEventTypesInput, optFns ...func(*health.Options)) (*health.DescribeEventTypesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEvents(ctx context.Context, params *health.DescribeEventsInput, optFns ...func(*health.Options)) (*health.DescribeEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeEventsForOrganization(ctx context.Context, params *health.DescribeEventsForOrganizationInput, optFns ...func(*health.Options)) (*health.DescribeEventsForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DescribeHealthServiceStatusForOrganization(ctx context.Context, params *health.DescribeHealthServiceStatusForOrganizationInput, optFns ...func(*health.Options)) (*health.DescribeHealthServiceStatusForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) DisableHealthServiceAccessForOrganization(ctx context.Context, params *health.DisableHealthServiceAccessForOrganizationInput, optFns ...func(*health.Options)) (*health.DisableHealthServiceAccessForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) EnableHealthServiceAccessForOrganization(ctx context.Context, params *health.EnableHealthServiceAccessForOrganizationInput, optFns ...func(*health.Options)) (*health.EnableHealthServiceAccessForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *HealthClient) Options() health.Options {
	ret := _m.Called()
