...
// PersonalizeeventsClient is an autogenerated mock type for the PersonalizeeventsClient type
type PersonalizeeventsClient struct {
	mock.Mock
}

// Options provides a mock function with given fields:
func (_m *PersonalizeeventsClient) Options() personalizeevents.Options {
	ret := _m.Called()
...
func (_m *PersonalizeeventsClient) PutActionInteractions(ctx context.Context, params *personalizeevents.PutActionInteractionsInput, optFns ...func(*personalizeevents.Options)) (*personalizeevents.PutActionInteractionsOutput, error) {
...
func (_m *PersonalizeeventsClient) PutActions(ctx context.Context, params *personalizeevents.PutActionsInput, optFns ...func(*personalizeevents.Options)) (*personalizeevents.PutActionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PersonalizeeventsClient) PutEvents(ctx context.Context, params *personalizeevents.PutEventsInput, optFns ...func(*personalizeevents.Options)) (*personalizeevents.PutEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PersonalizeeventsClient) PutItems(ctx context.Context, params *personalizeevents.PutItemsInput, optFns ...func(*personalizeevents.Options)) (*personalizeevents.PutItemsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PersonalizeeventsClient) PutUsers(ctx context.Context, params *personalizeevents.PutUsersInput, optFns ...func(*personalizeevents.Options)) (*personalizeevents.PutUsersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewPersonalizeeventsClient creates a new instance of PersonalizeeventsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPersonalizeeventsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *PersonalizeeventsClient {
	mock := &PersonalizeeventsClient{}
	mock.Mock.Test(t)
