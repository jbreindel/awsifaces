...
// IotsecuretunnelingClient is an autogenerated mock type for the IotsecuretunnelingClient type
type IotsecuretunnelingClient struct {
	mock.Mock
}

// CloseTunnel provides a mock function with given fields: ctx, params, optFns
func (_m *IotsecuretunnelingClient) CloseTunnel(ctx context.Context, params *iotsecuretunneling.CloseTunnelInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.CloseTunnelOutput, error) {
...
func (_m *IotsecuretunnelingClient) DescribeTunnel(ctx context.Context, params *iotsecuretunneling.DescribeTunnelInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.DescribeTunnelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotsecuretunnelingClient) ListTagsForResource(ctx context.Context, params *iotsecuretunneling.ListTagsForResourceInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotsecuretunnelingClient) ListTunnels(ctx context.Context, params *iotsecuretunneling.ListTunnelsInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.ListTunnelsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotsecuretunnelingClient) OpenTunnel(ctx context.Context, params *iotsecuretunneling.OpenTunnelInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.OpenTunnelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotsecuretunnelingClient) Options() iotsecuretunneling.Options {
	ret := _m.Called()
...
func (_m *IotsecuretunnelingClient) RotateTunnelAccessToken(ctx context.Context, params *iotsecuretunneling.RotateTunnelAccessTokenInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.RotateTunnelAccessTokenOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotsecuretunnelingClient) TagResource(ctx context.Context, params *iotsecuretunneling.TagResourceInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotsecuretunnelingClient) UntagResource(ctx context.Context, params *iotsecuretunneling.UntagResourceInput, optFns ...func(*iotsecuretunneling.Options)) (*iotsecuretunneling.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIotsecuretunnelingClient creates a new instance of IotsecuretunnelingClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIotsecuretunnelingClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IotsecuretunnelingClient {
	mock := &IotsecuretunnelingClient{}
	mock.Mock.Test(t)
