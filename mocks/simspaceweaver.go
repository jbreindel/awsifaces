...
// SimspaceweaverClient is an autogenerated mock type for the SimspaceweaverClient type
type SimspaceweaverClient struct {
	mock.Mock
}

// CreateSnapshot provides a mock function with given fields: ctx, params, optFns
func (_m *SimspaceweaverClient) CreateSnapshot(ctx context.Context, params *simspaceweaver.CreateSnapshotInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.CreateSnapshotOutput, error) {
...
func (_m *SimspaceweaverClient) DeleteApp(ctx context.Context, params *simspaceweaver.DeleteAppInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.DeleteAppOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) DeleteSimulation(ctx context.Context, params *simspaceweaver.DeleteSimulationInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.DeleteSimulationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) DescribeApp(ctx context.Context, params *simspaceweaver.DescribeAppInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.DescribeAppOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) DescribeSimulation(ctx context.Context, params *simspaceweaver.DescribeSimulationInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.DescribeSimulationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) ListApps(ctx context.Context, params *simspaceweaver.ListAppsInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.ListAppsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) ListSimulations(ctx context.Context, params *simspaceweaver.ListSimulationsInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.ListSimulationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) ListTagsForResource(ctx context.Context, params *simspaceweaver.ListTagsForResourceInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) Options() simspaceweaver.Options {
	ret := _m.Called()
...
func (_m *SimspaceweaverClient) StartApp(ctx context.Context, params *simspaceweaver.StartAppInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.StartAppOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) StartClock(ctx context.Context, params *simspaceweaver.StartClockInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.StartClockOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) StartSimulation(ctx context.Context, params *simspaceweaver.StartSimulationInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.StartSimulationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) StopApp(ctx context.Context, params *simspaceweaver.StopAppInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.StopAppOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) StopClock(ctx context.Context, params *simspaceweaver.StopClockInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.StopClockOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) StopSimulation(ctx context.Context, params *simspaceweaver.StopSimulationInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.StopSimulationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) TagResource(ctx context.Context, params *simspaceweaver.TagResourceInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SimspaceweaverClient) UntagResource(ctx context.Context, params *simspaceweaver.UntagResourceInput, optFns ...func(*simspaceweaver.Options)) (*simspaceweaver.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSimspaceweaverClient creates a new instance of SimspaceweaverClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSimspaceweaverClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SimspaceweaverClient {
	mock := &SimspaceweaverClient{}
	mock.Mock.Test(t)
