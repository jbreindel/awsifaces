...
// DirectoryserviceClient is an autogenerated mock type for the DirectoryserviceClient type
type DirectoryserviceClient struct {
	mock.Mock
}

// AcceptSharedDirectory provides a mock function with given fields: ctx, params, optFns
func (_m *DirectoryserviceClient) AcceptSharedDirectory(ctx context.Context, params *directoryservice.AcceptSharedDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.AcceptSharedDirectoryOutput, error) {
...
func (_m *DirectoryserviceClient) AddIpRoutes(ctx context.Context, params *directoryservice.AddIpRoutesInput, optFns ...func(*directoryservice.Options)) (*directoryservice.AddIpRoutesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) AddRegion(ctx context.Context, params *directoryservice.AddRegionInput, optFns ...func(*directoryservice.Options)) (*directoryservice.AddRegionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) AddTagsToResource(ctx context.Context, params *directoryservice.AddTagsToResourceInput, optFns ...func(*directoryservice.Options)) (*directoryservice.AddTagsToResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CancelSchemaExtension(ctx context.Context, params *directoryservice.CancelSchemaExtensionInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CancelSchemaExtensionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ConnectDirectory(ctx context.Context, params *directoryservice.ConnectDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ConnectDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateAlias(ctx context.Context, params *directoryservice.CreateAliasInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateComputer(ctx context.Context, params *directoryservice.CreateComputerInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateComputerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateConditionalForwarder(ctx context.Context, params *directoryservice.CreateConditionalForwarderInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateConditionalForwarderOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateDirectory(ctx context.Context, params *directoryservice.CreateDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateLogSubscription(ctx context.Context, params *directoryservice.CreateLogSubscriptionInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateLogSubscriptionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateMicrosoftAD(ctx context.Context, params *directoryservice.CreateMicrosoftADInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateMicrosoftADOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateSnapshot(ctx context.Context, params *directoryservice.CreateSnapshotInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) CreateTrust(ctx context.Context, params *directoryservice.CreateTrustInput, optFns ...func(*directoryservice.Options)) (*directoryservice.CreateTrustOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeleteConditionalForwarder(ctx context.Context, params *directoryservice.DeleteConditionalForwarderInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeleteConditionalForwarderOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeleteDirectory(ctx context.Context, params *directoryservice.DeleteDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeleteDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeleteLogSubscription(ctx context.Context, params *directoryservice.DeleteLogSubscriptionInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeleteLogSubscriptionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeleteSnapshot(ctx context.Context, params *directoryservice.DeleteSnapshotInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeleteSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeleteTrust(ctx context.Context, params *directoryservice.DeleteTrustInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeleteTrustOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeregisterCertificate(ctx context.Context, params *directoryservice.DeregisterCertificateInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeregisterCertificateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DeregisterEventTopic(ctx context.Context, params *directoryservice.DeregisterEventTopicInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DeregisterEventTopicOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeCertificate(ctx context.Context, params *directoryservice.DescribeCertificateInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeCertificateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeClientAuthenticationSettings(ctx context.Context, params *directoryservice.DescribeClientAuthenticationSettingsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeClientAuthenticationSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeConditionalForwarders(ctx context.Context, params *directoryservice.DescribeConditionalForwardersInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeConditionalForwardersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeDirectories(ctx context.Context, params *directoryservice.DescribeDirectoriesInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeDirectoriesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeDomainControllers(ctx context.Context, params *directoryservice.DescribeDomainControllersInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeDomainControllersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeEventTopics(ctx context.Context, params *directoryservice.DescribeEventTopicsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeEventTopicsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeLDAPSSettings(ctx context.Context, params *directoryservice.DescribeLDAPSSettingsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeLDAPSSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeRegions(ctx context.Context, params *directoryservice.DescribeRegionsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeRegionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeSettings(ctx context.Context, params *directoryservice.DescribeSettingsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeSharedDirectories(ctx context.Context, params *directoryservice.DescribeSharedDirectoriesInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeSharedDirectoriesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeSnapshots(ctx context.Context, params *directoryservice.DescribeSnapshotsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeSnapshotsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeTrusts(ctx context.Context, params *directoryservice.DescribeTrustsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeTrustsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DescribeUpdateDirectory(ctx context.Context, params *directoryservice.DescribeUpdateDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DescribeUpdateDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DisableClientAuthentication(ctx context.Context, params *directoryservice.DisableClientAuthenticationInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DisableClientAuthenticationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DisableLDAPS(ctx context.Context, params *directoryservice.DisableLDAPSInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DisableLDAPSOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DisableRadius(ctx context.Context, params *directoryservice.DisableRadiusInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DisableRadiusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) DisableSso(ctx context.Context, params *directoryservice.DisableSsoInput, optFns ...func(*directoryservice.Options)) (*directoryservice.DisableSsoOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) EnableClientAuthentication(ctx context.Context, params *directoryservice.EnableClientAuthenticationInput, optFns ...func(*directoryservice.Options)) (*directoryservice.EnableClientAuthenticationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) EnableLDAPS(ctx context.Context, params *directoryservice.EnableLDAPSInput, optFns ...func(*directoryservice.Options)) (*directoryservice.EnableLDAPSOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) EnableRadius(ctx context.Context, params *directoryservice.EnableRadiusInput, optFns ...func(*directoryservice.Options)) (*directoryservice.EnableRadiusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) EnableSso(ctx context.Context, params *directoryservice.EnableSsoInput, optFns ...func(*directoryservice.Options)) (*directoryservice.EnableSsoOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) GetDirectoryLimits(ctx context.Context, params *directoryservice.GetDirectoryLimitsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.GetDirectoryLimitsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) GetSnapshotLimits(ctx context.Context, params *directoryservice.GetSnapshotLimitsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.GetSnapshotLimitsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ListCertificates(ctx context.Context, params *directoryservice.ListCertificatesInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ListCertificatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ListIpRoutes(ctx context.Context, params *directoryservice.ListIpRoutesInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ListIpRoutesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ListLogSubscriptions(ctx context.Context, params *directoryservice.ListLogSubscriptionsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ListLogSubscriptionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ListSchemaExtensions(ctx context.Context, params *directoryservice.ListSchemaExtensionsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ListSchemaExtensionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ListTagsForResource(ctx context.Context, params *directoryservice.ListTagsForResourceInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) Options() directoryservice.Options {
	ret := _m.Called()
...
func (_m *DirectoryserviceClient) RegisterCertificate(ctx context.Context, params *directoryservice.RegisterCertificateInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RegisterCertificateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) RegisterEventTopic(ctx context.Context, params *directoryservice.RegisterEventTopicInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RegisterEventTopicOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) RejectSharedDirectory(ctx context.Context, params *directoryservice.RejectSharedDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RejectSharedDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) RemoveIpRoutes(ctx context.Context, params *directoryservice.RemoveIpRoutesInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RemoveIpRoutesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) RemoveRegion(ctx context.Context, params *directoryservice.RemoveRegionInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RemoveRegionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) RemoveTagsFromResource(ctx context.Context, params *directoryservice.RemoveTagsFromResourceInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RemoveTagsFromResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ResetUserPassword(ctx context.Context, params *directoryservice.ResetUserPasswordInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ResetUserPasswordOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) RestoreFromSnapshot(ctx context.Context, params *directoryservice.RestoreFromSnapshotInput, optFns ...func(*directoryservice.Options)) (*directoryservice.RestoreFromSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) ShareDirectory(ctx context.Context, params *directoryservice.ShareDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.ShareDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) StartSchemaExtension(ctx context.Context, params *directoryservice.StartSchemaExtensionInput, optFns ...func(*directoryservice.Options)) (*directoryservice.StartSchemaExtensionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UnshareDirectory(ctx context.Context, params *directoryservice.UnshareDirectoryInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UnshareDirectoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UpdateConditionalForwarder(ctx context.Context, params *directoryservice.UpdateConditionalForwarderInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UpdateConditionalForwarderOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UpdateDirectorySetup(ctx context.Context, params *directoryservice.UpdateDirectorySetupInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UpdateDirectorySetupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UpdateNumberOfDomainControllers(ctx context.Context, params *directoryservice.UpdateNumberOfDomainControllersInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UpdateNumberOfDomainControllersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UpdateRadius(ctx context.Context, params *directoryservice.UpdateRadiusInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UpdateRadiusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UpdateSettings(ctx context.Context, params *directoryservice.UpdateSettingsInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UpdateSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) UpdateTrust(ctx context.Context, params *directoryservice.UpdateTrustInput, optFns ...func(*directoryservice.Options)) (*directoryservice.UpdateTrustOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *DirectoryserviceClient) VerifyTrust(ctx context.Context, params *directoryservice.VerifyTrustInput, optFns ...func(*directoryservice.Options)) (*directoryservice.VerifyTrustOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewDirectoryserviceClient creates a new instance of DirectoryserviceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewDirectoryserviceClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *DirectoryserviceClient {
	mock := &DirectoryserviceClient{}
	mock.Mock.Test(t)
