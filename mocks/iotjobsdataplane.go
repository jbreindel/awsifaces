...
// IotjobsdataplaneClient is an autogenerated mock type for the IotjobsdataplaneClient type
type IotjobsdataplaneClient struct {
	mock.Mock
}

// DescribeJobExecution provides a mock function with given fields: ctx, params, optFns
func (_m *IotjobsdataplaneClient) DescribeJobExecution(ctx context.Context, params *iotjobsdataplane.DescribeJobExecutionInput, optFns ...func(*iotjobsdataplane.Options)) (*iotjobsdataplane.DescribeJobExecutionOutput, error) {
...
func (_m *IotjobsdataplaneClient) GetPendingJobExecutions(ctx context.Context, params *iotjobsdataplane.GetPendingJobExecutionsInput, optFns ...func(*iotjobsdataplane.Options)) (*iotjobsdataplane.GetPendingJobExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotjobsdataplaneClient) Options() iotjobsdataplane.Options {
	ret := _m.Called()
...
func (_m *IotjobsdataplaneClient) StartNextPendingJobExecution(ctx context.Context, params *iotjobsdataplane.StartNextPendingJobExecutionInput, optFns ...func(*iotjobsdataplane.Options)) (*iotjobsdataplane.StartNextPendingJobExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotjobsdataplaneClient) UpdateJobExecution(ctx context.Context, params *iotjobsdataplane.UpdateJobExecutionInput, optFns ...func(*iotjobsdataplane.Options)) (*iotjobsdataplane.UpdateJobExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIotjobsdataplaneClient creates a new instance of IotjobsdataplaneClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIotjobsdataplaneClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IotjobsdataplaneClient {
	mock := &IotjobsdataplaneClient{}
	mock.Mock.Test(t)
