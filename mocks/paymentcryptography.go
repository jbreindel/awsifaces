...
// PaymentcryptographyClient is an autogenerated mock type for the PaymentcryptographyClient type
type PaymentcryptographyClient struct {
	mock.Mock
}

// CreateAlias provides a mock function with given fields: ctx, params, optFns
func (_m *PaymentcryptographyClient) CreateAlias(ctx context.Context, params *paymentcryptography.CreateAliasInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.CreateAliasOutput, error) {
...
func (_m *PaymentcryptographyClient) CreateKey(ctx context.Context, params *paymentcryptography.CreateKeyInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.CreateKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) DeleteAlias(ctx context.Context, params *paymentcryptography.DeleteAliasInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.DeleteAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) DeleteKey(ctx context.Context, params *paymentcryptography.DeleteKeyInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.DeleteKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) ExportKey(ctx context.Context, params *paymentcryptography.ExportKeyInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.ExportKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) GetAlias(ctx context.Context, params *paymentcryptography.GetAliasInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.GetAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) GetKey(ctx context.Context, params *paymentcryptography.GetKeyInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.GetKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) GetParametersForExport(ctx context.Context, params *paymentcryptography.GetParametersForExportInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.GetParametersForExportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) GetParametersForImport(ctx context.Context, params *paymentcryptography.GetParametersForImportInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.GetParametersForImportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) GetPublicKeyCertificate(ctx context.Context, params *paymentcryptography.GetPublicKeyCertificateInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.GetPublicKeyCertificateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) ImportKey(ctx context.Context, params *paymentcryptography.ImportKeyInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.ImportKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) ListAliases(ctx context.Context, params *paymentcryptography.ListAliasesInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.ListAliasesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) ListKeys(ctx context.Context, params *paymentcryptography.ListKeysInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.ListKeysOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) ListTagsForResource(ctx context.Context, params *paymentcryptography.ListTagsForResourceInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) Options() paymentcryptography.Options {
	ret := _m.Called()
...
func (_m *PaymentcryptographyClient) RestoreKey(ctx context.Context, params *paymentcryptography.RestoreKeyInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.RestoreKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) StartKeyUsage(ctx context.Context, params *paymentcryptography.StartKeyUsageInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.StartKeyUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) StopKeyUsage(ctx context.Context, params *paymentcryptography.StopKeyUsageInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.StopKeyUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) TagResource(ctx context.Context, params *paymentcryptography.TagResourceInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) UntagResource(ctx context.Context, params *paymentcryptography.UntagResourceInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographyClient) UpdateAlias(ctx context.Context, params *paymentcryptography.UpdateAliasInput, optFns ...func(*paymentcryptography.Options)) (*paymentcryptography.UpdateAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewPaymentcryptographyClient creates a new instance of PaymentcryptographyClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPaymentcryptographyClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *PaymentcryptographyClient {
	mock := &PaymentcryptographyClient{}
	mock.Mock.Test(t)
