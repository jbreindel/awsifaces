...
// TimestreamwriteClient is an autogenerated mock type for the TimestreamwriteClient type
type TimestreamwriteClient struct {
	mock.Mock
}

// CreateBatchLoadTask provides a mock function with given fields: ctx, params, optFns
func (_m *TimestreamwriteClient) CreateBatchLoadTask(ctx context.Context, params *timestreamwrite.CreateBatchLoadTaskInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.CreateBatchLoadTaskOutput, error) {
...
func (_m *TimestreamwriteClient) CreateDatabase(ctx context.Context, params *timestreamwrite.CreateDatabaseInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.CreateDatabaseOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) CreateTable(ctx context.Context, params *timestreamwrite.CreateTableInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.CreateTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) DeleteDatabase(ctx context.Context, params *timestreamwrite.DeleteDatabaseInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.DeleteDatabaseOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) DeleteTable(ctx context.Context, params *timestreamwrite.DeleteTableInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.DeleteTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) DescribeBatchLoadTask(ctx context.Context, params *timestreamwrite.DescribeBatchLoadTaskInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.DescribeBatchLoadTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) DescribeDatabase(ctx context.Context, params *timestreamwrite.DescribeDatabaseInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.DescribeDatabaseOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) DescribeEndpoints(ctx context.Context, params *timestreamwrite.DescribeEndpointsInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.DescribeEndpointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) DescribeTable(ctx context.Context, params *timestreamwrite.DescribeTableInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.DescribeTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) ListBatchLoadTasks(ctx context.Context, params *timestreamwrite.ListBatchLoadTasksInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.ListBatchLoadTasksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) ListDatabases(ctx context.Context, params *timestreamwrite.ListDatabasesInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.ListDatabasesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) ListTables(ctx context.Context, params *timestreamwrite.ListTablesInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.ListTablesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) ListTagsForResource(ctx context.Context, params *timestreamwrite.ListTagsForResourceInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) Options() timestreamwrite.Options {
	ret := _m.Called()
...
func (_m *TimestreamwriteClient) ResumeBatchLoadTask(ctx context.Context, params *timestreamwrite.ResumeBatchLoadTaskInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.ResumeBatchLoadTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) TagResource(ctx context.Context, params *timestreamwrite.TagResourceInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) UntagResource(ctx context.Context, params *timestreamwrite.UntagResourceInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) UpdateDatabase(ctx context.Context, params *timestreamwrite.UpdateDatabaseInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.UpdateDatabaseOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) UpdateTable(ctx context.Context, params *timestreamwrite.UpdateTableInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.UpdateTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreamwriteClient) WriteRecords(ctx context.Context, params *timestreamwrite.WriteRecordsInput, optFns ...func(*timestreamwrite.Options)) (*timestreamwrite.WriteRecordsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewTimestreamwriteClient creates a new instance of TimestreamwriteClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTimestreamwriteClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *TimestreamwriteClient {
	mock := &TimestreamwriteClient{}
	mock.Mock.Test(t)
