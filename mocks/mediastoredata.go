...
// MediastoredataClient is an autogenerated mock type for the MediastoredataClient type
type MediastoredataClient struct {
	mock.Mock
}

// DeleteObject provides a mock function with given fields: ctx, params, optFns
func (_m *MediastoredataClient) DeleteObject(ctx context.Context, params *mediastoredata.DeleteObjectInput, optFns ...func(*mediastoredata.Options)) (*mediastoredata.DeleteObjectOutput, error) {
...
func (_m *MediastoredataClient) DescribeObject(ctx context.Context, params *mediastoredata.DescribeObjectInput, optFns ...func(*mediastoredata.Options)) (*mediastoredata.DescribeObjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoredataClient) GetObject(ctx context.Context, params *mediastoredata.GetObjectInput, optFns ...func(*mediastoredata.Options)) (*mediastoredata.GetObjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoredataClient) ListItems(ctx context.Context, params *mediastoredata.ListItemsInput, optFns ...func(*mediastoredata.Options)) (*mediastoredata.ListItemsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoredataClient) Options() mediastoredata.Options {
	ret := _m.Called()
...
func (_m *MediastoredataClient) PutObject(ctx context.Context, params *mediastoredata.PutObjectInput, optFns ...func(*mediastoredata.Options)) (*mediastoredata.PutObjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMediastoredataClient creates a new instance of MediastoredataClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMediastoredataClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MediastoredataClient {
	mock := &MediastoredataClient{}
	mock.Mock.Test(t)
