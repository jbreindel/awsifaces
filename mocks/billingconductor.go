...
// BillingconductorClient is an autogenerated mock type for the BillingconductorClient type
type BillingconductorClient struct {
	mock.Mock
}

// AssociateAccounts provides a mock function with given fields: ctx, params, optFns
func (_m *BillingconductorClient) AssociateAccounts(ctx context.Context, params *billingconductor.AssociateAccountsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.AssociateAccountsOutput, error) {
...
func (_m *BillingconductorClient) AssociatePricingRules(ctx context.Context, params *billingconductor.AssociatePricingRulesInput, optFns ...func(*billingconductor.Options)) (*billingconductor.AssociatePricingRulesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) BatchAssociateResourcesToCustomLineItem(ctx context.Context, params *billingconductor.BatchAssociateResourcesToCustomLineItemInput, optFns ...func(*billingconductor.Options)) (*billingconductor.BatchAssociateResourcesToCustomLineItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) BatchDisassociateResourcesFromCustomLineItem(ctx context.Context, params *billingconductor.BatchDisassociateResourcesFromCustomLineItemInput, optFns ...func(*billingconductor.Options)) (*billingconductor.BatchDisassociateResourcesFromCustomLineItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) CreateBillingGroup(ctx context.Context, params *billingconductor.CreateBillingGroupInput, optFns ...func(*billingconductor.Options)) (*billingconductor.CreateBillingGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) CreateCustomLineItem(ctx context.Context, params *billingconductor.CreateCustomLineItemInput, optFns ...func(*billingconductor.Options)) (*billingconductor.CreateCustomLineItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) CreatePricingPlan(ctx context.Context, params *billingconductor.CreatePricingPlanInput, optFns ...func(*billingconductor.Options)) (*billingconductor.CreatePricingPlanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) CreatePricingRule(ctx context.Context, params *billingconductor.CreatePricingRuleInput, optFns ...func(*billingconductor.Options)) (*billingconductor.CreatePricingRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) DeleteBillingGroup(ctx context.Context, params *billingconductor.DeleteBillingGroupInput, optFns ...func(*billingconductor.Options)) (*billingconductor.DeleteBillingGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) DeleteCustomLineItem(ctx context.Context, params *billingconductor.DeleteCustomLineItemInput, optFns ...func(*billingconductor.Options)) (*billingconductor.DeleteCustomLineItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) DeletePricingPlan(ctx context.Context, params *billingconductor.DeletePricingPlanInput, optFns ...func(*billingconductor.Options)) (*billingconductor.DeletePricingPlanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) DeletePricingRule(ctx context.Context, params *billingconductor.DeletePricingRuleInput, optFns ...func(*billingconductor.Options)) (*billingconductor.DeletePricingRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) DisassociateAccounts(ctx context.Context, params *billingconductor.DisassociateAccountsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.DisassociateAccountsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) DisassociatePricingRules(ctx context.Context, params *billingconductor.DisassociatePricingRulesInput, optFns ...func(*billingconductor.Options)) (*billingconductor.DisassociatePricingRulesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) GetBillingGroupCostReport(ctx context.Context, params *billingconductor.GetBillingGroupCostReportInput, optFns ...func(*billingconductor.Options)) (*billingconductor.GetBillingGroupCostReportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListAccountAssociations(ctx context.Context, params *billingconductor.ListAccountAssociationsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListAccountAssociationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListBillingGroupCostReports(ctx context.Context, params *billingconductor.ListBillingGroupCostReportsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListBillingGroupCostReportsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListBillingGroups(ctx context.Context, params *billingconductor.ListBillingGroupsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListBillingGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListCustomLineItemVersions(ctx context.Context, params *billingconductor.ListCustomLineItemVersionsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListCustomLineItemVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListCustomLineItems(ctx context.Context, params *billingconductor.ListCustomLineItemsInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListCustomLineItemsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListPricingPlans(ctx context.Context, params *billingconductor.ListPricingPlansInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListPricingPlansOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListPricingPlansAssociatedWithPricingRule(ctx context.Context, params *billingconductor.ListPricingPlansAssociatedWithPricingRuleInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListPricingPlansAssociatedWithPricingRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListPricingRules(ctx context.Context, params *billingconductor.ListPricingRulesInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListPricingRulesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListPricingRulesAssociatedToPricingPlan(ctx context.Context, params *billingconductor.ListPricingRulesAssociatedToPricingPlanInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListPricingRulesAssociatedToPricingPlanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListResourcesAssociatedToCustomLineItem(ctx context.Context, params *billingconductor.ListResourcesAssociatedToCustomLineItemInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListResourcesAssociatedToCustomLineItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) ListTagsForResource(ctx context.Context, params *billingconductor.ListTagsForResourceInput, optFns ...func(*billingconductor.Options)) (*billingconductor.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) Options() billingconductor.Options {
	ret := _m.Called()
...
func (_m *BillingconductorClient) TagResource(ctx context.Context, params *billingconductor.TagResourceInput, optFns ...func(*billingconductor.Options)) (*billingconductor.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) UntagResource(ctx context.Context, params *billingconductor.UntagResourceInput, optFns ...func(*billingconductor.Options)) (*billingconductor.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) UpdateBillingGroup(ctx context.Context, params *billingconductor.UpdateBillingGroupInput, optFns ...func(*billingconductor.Options)) (*billingconductor.UpdateBillingGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) UpdateCustomLineItem(ctx context.Context, params *billingconductor.UpdateCustomLineItemInput, optFns ...func(*billingconductor.Options)) (*billingconductor.UpdateCustomLineItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) UpdatePricingPlan(ctx context.Context, params *billingconductor.UpdatePricingPlanInput, optFns ...func(*billingconductor.Options)) (*billingconductor.UpdatePricingPlanOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BillingconductorClient) UpdatePricingRule(ctx context.Context, params *billingconductor.UpdatePricingRuleInput, optFns ...func(*billingconductor.Options)) (*billingconductor.UpdatePricingRuleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewBillingconductorClient creates a new instance of BillingconductorClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBillingconductorClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *BillingconductorClient {
	mock := &BillingconductorClient{}
	mock.Mock.Test(t)
