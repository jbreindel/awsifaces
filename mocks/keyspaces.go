...
// KeyspacesClient is an autogenerated mock type for the KeyspacesClient type
type KeyspacesClient struct {
	mock.Mock
}

// CreateKeyspace provides a mock function with given fields: ctx, params, optFns
func (_m *KeyspacesClient) CreateKeyspace(ctx context.Context, params *keyspaces.CreateKeyspaceInput, optFns ...func(*keyspaces.Options)) (*keyspaces.CreateKeyspaceOutput, error) {
...
func (_m *KeyspacesClient) CreateTable(ctx context.Context, params *keyspaces.CreateTableInput, optFns ...func(*keyspaces.Options)) (*keyspaces.CreateTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) DeleteKeyspace(ctx context.Context, params *keyspaces.DeleteKeyspaceInput, optFns ...func(*keyspaces.Options)) (*keyspaces.DeleteKeyspaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) DeleteTable(ctx context.Context, params *keyspaces.DeleteTableInput, optFns ...func(*keyspaces.Options)) (*keyspaces.DeleteTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) GetKeyspace(ctx context.Context, params *keyspaces.GetKeyspaceInput, optFns ...func(*keyspaces.Options)) (*keyspaces.GetKeyspaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) GetTable(ctx context.Context, params *keyspaces.GetTableInput, optFns ...func(*keyspaces.Options)) (*keyspaces.GetTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) GetTableAutoScalingSettings(ctx context.Context, params *keyspaces.GetTableAutoScalingSettingsInput, optFns ...func(*keyspaces.Options)) (*keyspaces.GetTableAutoScalingSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) ListKeyspaces(ctx context.Context, params *keyspaces.ListKeyspacesInput, optFns ...func(*keyspaces.Options)) (*keyspaces.ListKeyspacesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) ListTables(ctx context.Context, params *keyspaces.ListTablesInput, optFns ...func(*keyspaces.Options)) (*keyspaces.ListTablesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) ListTagsForResource(ctx context.Context, params *keyspaces.ListTagsForResourceInput, optFns ...func(*keyspaces.Options)) (*keyspaces.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) Options() keyspaces.Options {
	ret := _m.Called()
...
func (_m *KeyspacesClient) RestoreTable(ctx context.Context, params *keyspaces.RestoreTableInput, optFns ...func(*keyspaces.Options)) (*keyspaces.RestoreTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) TagResource(ctx context.Context, params *keyspaces.TagResourceInput, optFns ...func(*keyspaces.Options)) (*keyspaces.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) UntagResource(ctx context.Context, params *keyspaces.UntagResourceInput, optFns ...func(*keyspaces.Options)) (*keyspaces.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KeyspacesClient) UpdateTable(ctx context.Context, params *keyspaces.UpdateTableInput, optFns ...func(*keyspaces.Options)) (*keyspaces.UpdateTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewKeyspacesClient creates a new instance of KeyspacesClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewKeyspacesClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *KeyspacesClient {
	mock := &KeyspacesClient{}
	mock.Mock.Test(t)
