...
// StoragegatewayClient is an autogenerated mock type for the StoragegatewayClient type
type StoragegatewayClient struct {
	mock.Mock
}

// ActivateGateway provides a mock function with given fields: ctx, params, optFns
func (_m *StoragegatewayClient) ActivateGateway(ctx context.Context, params *storagegateway.ActivateGatewayInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ActivateGatewayOutput, error) {
...
func (_m *StoragegatewayClient) AddCache(ctx context.Context, params *storagegateway.AddCacheInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AddCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) AddTagsToResource(ctx context.Context, params *storagegateway.AddTagsToResourceInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AddTagsToResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) AddUploadBuffer(ctx context.Context, params *storagegateway.AddUploadBufferInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AddUploadBufferOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) AddWorkingStorage(ctx context.Context, params *storagegateway.AddWorkingStorageInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AddWorkingStorageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) AssignTapePool(ctx context.Context, params *storagegateway.AssignTapePoolInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AssignTapePoolOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) AssociateFileSystem(ctx context.Context, params *storagegateway.AssociateFileSystemInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AssociateFileSystemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) AttachVolume(ctx context.Context, params *storagegateway.AttachVolumeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.AttachVolumeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CancelArchival(ctx context.Context, params *storagegateway.CancelArchivalInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CancelArchivalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CancelRetrieval(ctx context.Context, params *storagegateway.CancelRetrievalInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CancelRetrievalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateCachediSCSIVolume(ctx context.Context, params *storagegateway.CreateCachediSCSIVolumeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateCachediSCSIVolumeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateNFSFileShare(ctx context.Context, params *storagegateway.CreateNFSFileShareInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateNFSFileShareOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateSMBFileShare(ctx context.Context, params *storagegateway.CreateSMBFileShareInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateSMBFileShareOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateSnapshot(ctx context.Context, params *storagegateway.CreateSnapshotInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateSnapshotFromVolumeRecoveryPoint(ctx context.Context, params *storagegateway.CreateSnapshotFromVolumeRecoveryPointInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateSnapshotFromVolumeRecoveryPointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateStorediSCSIVolume(ctx context.Context, params *storagegateway.CreateStorediSCSIVolumeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateStorediSCSIVolumeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateTapePool(ctx context.Context, params *storagegateway.CreateTapePoolInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateTapePoolOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateTapeWithBarcode(ctx context.Context, params *storagegateway.CreateTapeWithBarcodeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateTapeWithBarcodeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) CreateTapes(ctx context.Context, params *storagegateway.CreateTapesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.CreateTapesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteAutomaticTapeCreationPolicy(ctx context.Context, params *storagegateway.DeleteAutomaticTapeCreationPolicyInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteAutomaticTapeCreationPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteBandwidthRateLimit(ctx context.Context, params *storagegateway.DeleteBandwidthRateLimitInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteBandwidthRateLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteChapCredentials(ctx context.Context, params *storagegateway.DeleteChapCredentialsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteChapCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteFileShare(ctx context.Context, params *storagegateway.DeleteFileShareInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteFileShareOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteGateway(ctx context.Context, params *storagegateway.DeleteGatewayInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteGatewayOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteSnapshotSchedule(ctx context.Context, params *storagegateway.DeleteSnapshotScheduleInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteSnapshotScheduleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteTape(ctx context.Context, params *storagegateway.DeleteTapeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteTapeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteTapeArchive(ctx context.Context, params *storagegateway.DeleteTapeArchiveInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteTapeArchiveOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteTapePool(ctx context.Context, params *storagegateway.DeleteTapePoolInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteTapePoolOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DeleteVolume(ctx context.Context, params *storagegateway.DeleteVolumeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DeleteVolumeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeAvailabilityMonitorTest(ctx context.Context, params *storagegateway.DescribeAvailabilityMonitorTestInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeAvailabilityMonitorTestOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeBandwidthRateLimit(ctx context.Context, params *storagegateway.DescribeBandwidthRateLimitInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeBandwidthRateLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeBandwidthRateLimitSchedule(ctx context.Context, params *storagegateway.DescribeBandwidthRateLimitScheduleInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeBandwidthRateLimitScheduleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeCache(ctx context.Context, params *storagegateway.DescribeCacheInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeCachediSCSIVolumes(ctx context.Context, params *storagegateway.DescribeCachediSCSIVolumesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeCachediSCSIVolumesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeChapCredentials(ctx context.Context, params *storagegateway.DescribeChapCredentialsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeChapCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeFileSystemAssociations(ctx context.Context, params *storagegateway.DescribeFileSystemAssociationsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeFileSystemAssociationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeGatewayInformation(ctx context.Context, params *storagegateway.DescribeGatewayInformationInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeGatewayInformationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeMaintenanceStartTime(ctx context.Context, params *storagegateway.DescribeMaintenanceStartTimeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeMaintenanceStartTimeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeNFSFileShares(ctx context.Context, params *storagegateway.DescribeNFSFileSharesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeNFSFileSharesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeSMBFileShares(ctx context.Context, params *storagegateway.DescribeSMBFileSharesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeSMBFileSharesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeSMBSettings(ctx context.Context, params *storagegateway.DescribeSMBSettingsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeSMBSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeSnapshotSchedule(ctx context.Context, params *storagegateway.DescribeSnapshotScheduleInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeSnapshotScheduleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeStorediSCSIVolumes(ctx context.Context, params *storagegateway.DescribeStorediSCSIVolumesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeStorediSCSIVolumesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeTapeArchives(ctx context.Context, params *storagegateway.DescribeTapeArchivesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeTapeArchivesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeTapeRecoveryPoints(ctx context.Context, params *storagegateway.DescribeTapeRecoveryPointsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeTapeRecoveryPointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeTapes(ctx context.Context, params *storagegateway.DescribeTapesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeTapesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeUploadBuffer(ctx context.Context, params *storagegateway.DescribeUploadBufferInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeUploadBufferOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeVTLDevices(ctx context.Context, params *storagegateway.DescribeVTLDevicesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeVTLDevicesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DescribeWorkingStorage(ctx context.Context, params *storagegateway.DescribeWorkingStorageInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DescribeWorkingStorageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DetachVolume(ctx context.Context, params *storagegateway.DetachVolumeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DetachVolumeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DisableGateway(ctx context.Context, params *storagegateway.DisableGatewayInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DisableGatewayOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) DisassociateFileSystem(ctx context.Context, params *storagegateway.DisassociateFileSystemInput, optFns ...func(*storagegateway.Options)) (*storagegateway.DisassociateFileSystemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) JoinDomain(ctx context.Context, params *storagegateway.JoinDomainInput, optFns ...func(*storagegateway.Options)) (*storagegateway.JoinDomainOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListAutomaticTapeCreationPolicies(ctx context.Context, params *storagegateway.ListAutomaticTapeCreationPoliciesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListAutomaticTapeCreationPoliciesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListFileShares(ctx context.Context, params *storagegateway.ListFileSharesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListFileSharesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListFileSystemAssociations(ctx context.Context, params *storagegateway.ListFileSystemAssociationsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListFileSystemAssociationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListGateways(ctx context.Context, params *storagegateway.ListGatewaysInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListGatewaysOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListLocalDisks(ctx context.Context, params *storagegateway.ListLocalDisksInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListLocalDisksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListTagsForResource(ctx context.Context, params *storagegateway.ListTagsForResourceInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListTapePools(ctx context.Context, params *storagegateway.ListTapePoolsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListTapePoolsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListTapes(ctx context.Context, params *storagegateway.ListTapesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListTapesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListVolumeInitiators(ctx context.Context, params *storagegateway.ListVolumeInitiatorsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListVolumeInitiatorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListVolumeRecoveryPoints(ctx context.Context, params *storagegateway.ListVolumeRecoveryPointsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListVolumeRecoveryPointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ListVolumes(ctx context.Context, params *storagegateway.ListVolumesInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ListVolumesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) NotifyWhenUploaded(ctx context.Context, params *storagegateway.NotifyWhenUploadedInput, optFns ...func(*storagegateway.Options)) (*storagegateway.NotifyWhenUploadedOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) Options() storagegateway.Options {
	ret := _m.Called()
...
func (_m *StoragegatewayClient) RefreshCache(ctx context.Context, params *storagegateway.RefreshCacheInput, optFns ...func(*storagegateway.Options)) (*storagegateway.RefreshCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) RemoveTagsFromResource(ctx context.Context, params *storagegateway.RemoveTagsFromResourceInput, optFns ...func(*storagegateway.Options)) (*storagegateway.RemoveTagsFromResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ResetCache(ctx context.Context, params *storagegateway.ResetCacheInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ResetCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) RetrieveTapeArchive(ctx context.Context, params *storagegateway.RetrieveTapeArchiveInput, optFns ...func(*storagegateway.Options)) (*storagegateway.RetrieveTapeArchiveOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) RetrieveTapeRecoveryPoint(ctx context.Context, params *storagegateway.RetrieveTapeRecoveryPointInput, optFns ...func(*storagegateway.Options)) (*storagegateway.RetrieveTapeRecoveryPointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) SetLocalConsolePassword(ctx context.Context, params *storagegateway.SetLocalConsolePasswordInput, optFns ...func(*storagegateway.Options)) (*storagegateway.SetLocalConsolePasswordOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) SetSMBGuestPassword(ctx context.Context, params *storagegateway.SetSMBGuestPasswordInput, optFns ...func(*storagegateway.Options)) (*storagegateway.SetSMBGuestPasswordOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) ShutdownGateway(ctx context.Context, params *storagegateway.ShutdownGatewayInput, optFns ...func(*storagegateway.Options)) (*storagegateway.ShutdownGatewayOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) StartAvailabilityMonitorTest(ctx context.Context, params *storagegateway.StartAvailabilityMonitorTestInput, optFns ...func(*storagegateway.Options)) (*storagegateway.StartAvailabilityMonitorTestOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) StartGateway(ctx context.Context, params *storagegateway.StartGatewayInput, optFns ...func(*storagegateway.Options)) (*storagegateway.StartGatewayOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateAutomaticTapeCreationPolicy(ctx context.Context, params *storagegateway.UpdateAutomaticTapeCreationPolicyInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateAutomaticTapeCreationPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateBandwidthRateLimit(ctx context.Context, params *storagegateway.UpdateBandwidthRateLimitInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateBandwidthRateLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateBandwidthRateLimitSchedule(ctx context.Context, params *storagegateway.UpdateBandwidthRateLimitScheduleInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateBandwidthRateLimitScheduleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateChapCredentials(ctx context.Context, params *storagegateway.UpdateChapCredentialsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateChapCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateFileSystemAssociation(ctx context.Context, params *storagegateway.UpdateFileSystemAssociationInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateFileSystemAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateGatewayInformation(ctx context.Context, params *storagegateway.UpdateGatewayInformationInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateGatewayInformationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateGatewaySoftwareNow(ctx context.Context, params *storagegateway.UpdateGatewaySoftwareNowInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateGatewaySoftwareNowOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateMaintenanceStartTime(ctx context.Context, params *storagegateway.UpdateMaintenanceStartTimeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateMaintenanceStartTimeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateNFSFileShare(ctx context.Context, params *storagegateway.UpdateNFSFileShareInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateNFSFileShareOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateSMBFileShare(ctx context.Context, params *storagegateway.UpdateSMBFileShareInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateSMBFileShareOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateSMBFileShareVisibility(ctx context.Context, params *storagegateway.UpdateSMBFileShareVisibilityInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateSMBFileShareVisibilityOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateSMBLocalGroups(ctx context.Context, params *storagegateway.UpdateSMBLocalGroupsInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateSMBLocalGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateSMBSecurityStrategy(ctx context.Context, params *storagegateway.UpdateSMBSecurityStrategyInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateSMBSecurityStrategyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateSnapshotSchedule(ctx context.Context, params *storagegateway.UpdateSnapshotScheduleInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateSnapshotScheduleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *StoragegatewayClient) UpdateVTLDeviceType(ctx context.Context, params *storagegateway.UpdateVTLDeviceTypeInput, optFns ...func(*storagegateway.Options)) (*storagegateway.UpdateVTLDeviceTypeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewStoragegatewayClient creates a new instance of StoragegatewayClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewStoragegatewayClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *StoragegatewayClient {
	mock := &StoragegatewayClient{}
	mock.Mock.Test(t)
