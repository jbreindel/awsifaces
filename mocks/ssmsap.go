...
// SsmsapClient is an autogenerated mock type for the SsmsapClient type
type SsmsapClient struct {
	mock.Mock
}

// DeleteResourcePermission provides a mock function with given fields: ctx, params, optFns
func (_m *SsmsapClient) DeleteResourcePermission(ctx context.Context, params *ssmsap.DeleteResourcePermissionInput, optFns ...func(*ssmsap.Options)) (*ssmsap.DeleteResourcePermissionOutput, error) {
...
func (_m *SsmsapClient) DeregisterApplication(ctx context.Context, params *ssmsap.DeregisterApplicationInput, optFns ...func(*ssmsap.Options)) (*ssmsap.DeregisterApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) GetApplication(ctx context.Context, params *ssmsap.GetApplicationInput, optFns ...func(*ssmsap.Options)) (*ssmsap.GetApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) GetComponent(ctx context.Context, params *ssmsap.GetComponentInput, optFns ...func(*ssmsap.Options)) (*ssmsap.GetComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) GetDatabase(ctx context.Context, params *ssmsap.GetDatabaseInput, optFns ...func(*ssmsap.Options)) (*ssmsap.GetDatabaseOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) GetOperation(ctx context.Context, params *ssmsap.GetOperationInput, optFns ...func(*ssmsap.Options)) (*ssmsap.GetOperationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) GetResourcePermission(ctx context.Context, params *ssmsap.GetResourcePermissionInput, optFns ...func(*ssmsap.Options)) (*ssmsap.GetResourcePermissionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) ListApplications(ctx context.Context, params *ssmsap.ListApplicationsInput, optFns ...func(*ssmsap.Options)) (*ssmsap.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) ListComponents(ctx context.Context, params *ssmsap.ListComponentsInput, optFns ...func(*ssmsap.Options)) (*ssmsap.ListComponentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) ListDatabases(ctx context.Context, params *ssmsap.ListDatabasesInput, optFns ...func(*ssmsap.Options)) (*ssmsap.ListDatabasesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) ListOperations(ctx context.Context, params *ssmsap.ListOperationsInput, optFns ...func(*ssmsap.Options)) (*ssmsap.ListOperationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) ListTagsForResource(ctx context.Context, params *ssmsap.ListTagsForResourceInput, optFns ...func(*ssmsap.Options)) (*ssmsap.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) Options() ssmsap.Options {
	ret := _m.Called()
...
func (_m *SsmsapClient) PutResourcePermission(ctx context.Context, params *ssmsap.PutResourcePermissionInput, optFns ...func(*ssmsap.Options)) (*ssmsap.PutResourcePermissionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) RegisterApplication(ctx context.Context, params *ssmsap.RegisterApplicationInput, optFns ...func(*ssmsap.Options)) (*ssmsap.RegisterApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) StartApplicationRefresh(ctx context.Context, params *ssmsap.StartApplicationRefreshInput, optFns ...func(*ssmsap.Options)) (*ssmsap.StartApplicationRefreshOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) TagResource(ctx context.Context, params *ssmsap.TagResourceInput, optFns ...func(*ssmsap.Options)) (*ssmsap.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) UntagResource(ctx context.Context, params *ssmsap.UntagResourceInput, optFns ...func(*ssmsap.Options)) (*ssmsap.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SsmsapClient) UpdateApplicationSettings(ctx context.Context, params *ssmsap.UpdateApplicationSettingsInput, optFns ...func(*ssmsap.Options)) (*ssmsap.UpdateApplicationSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSsmsapClient creates a new instance of SsmsapClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSsmsapClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SsmsapClient {
	mock := &SsmsapClient{}
