...
// IotthingsgraphClient is an autogenerated mock type for the IotthingsgraphClient type
type IotthingsgraphClient struct {
	mock.Mock
}

// AssociateEntityToThing provides a mock function with given fields: ctx, params, optFns
func (_m *IotthingsgraphClient) AssociateEntityToThing(ctx context.Context, params *iotthingsgraph.AssociateEntityToThingInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.AssociateEntityToThingOutput, error) {
...
func (_m *IotthingsgraphClient) CreateFlowTemplate(ctx context.Context, params *iotthingsgraph.CreateFlowTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.CreateFlowTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) CreateSystemInstance(ctx context.Context, params *iotthingsgraph.CreateSystemInstanceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.CreateSystemInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) CreateSystemTemplate(ctx context.Context, params *iotthingsgraph.CreateSystemTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.CreateSystemTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeleteFlowTemplate(ctx context.Context, params *iotthingsgraph.DeleteFlowTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeleteFlowTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeleteNamespace(ctx context.Context, params *iotthingsgraph.DeleteNamespaceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeleteNamespaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeleteSystemInstance(ctx context.Context, params *iotthingsgraph.DeleteSystemInstanceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeleteSystemInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeleteSystemTemplate(ctx context.Context, params *iotthingsgraph.DeleteSystemTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeleteSystemTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeploySystemInstance(ctx context.Context, params *iotthingsgraph.DeploySystemInstanceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeploySystemInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeprecateFlowTemplate(ctx context.Context, params *iotthingsgraph.DeprecateFlowTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeprecateFlowTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DeprecateSystemTemplate(ctx context.Context, params *iotthingsgraph.DeprecateSystemTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DeprecateSystemTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DescribeNamespace(ctx context.Context, params *iotthingsgraph.DescribeNamespaceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DescribeNamespaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) DissociateEntityFromThing(ctx context.Context, params *iotthingsgraph.DissociateEntityFromThingInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.DissociateEntityFromThingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetEntities(ctx context.Context, params *iotthingsgraph.GetEntitiesInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetEntitiesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetFlowTemplate(ctx context.Context, params *iotthingsgraph.GetFlowTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetFlowTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetFlowTemplateRevisions(ctx context.Context, params *iotthingsgraph.GetFlowTemplateRevisionsInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetFlowTemplateRevisionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetNamespaceDeletionStatus(ctx context.Context, params *iotthingsgraph.GetNamespaceDeletionStatusInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetNamespaceDeletionStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetSystemInstance(ctx context.Context, params *iotthingsgraph.GetSystemInstanceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetSystemInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetSystemTemplate(ctx context.Context, params *iotthingsgraph.GetSystemTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetSystemTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetSystemTemplateRevisions(ctx context.Context, params *iotthingsgraph.GetSystemTemplateRevisionsInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetSystemTemplateRevisionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) GetUploadStatus(ctx context.Context, params *iotthingsgraph.GetUploadStatusInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.GetUploadStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) ListFlowExecutionMessages(ctx context.Context, params *iotthingsgraph.ListFlowExecutionMessagesInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.ListFlowExecutionMessagesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) ListTagsForResource(ctx context.Context, params *iotthingsgraph.ListTagsForResourceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) Options() iotthingsgraph.Options {
	ret := _m.Called()
...
func (_m *IotthingsgraphClient) SearchEntities(ctx context.Context, params *iotthingsgraph.SearchEntitiesInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.SearchEntitiesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) SearchFlowExecutions(ctx context.Context, params *iotthingsgraph.SearchFlowExecutionsInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.SearchFlowExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) SearchFlowTemplates(ctx context.Context, params *iotthingsgraph.SearchFlowTemplatesInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.SearchFlowTemplatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) SearchSystemInstances(ctx context.Context, params *iotthingsgraph.SearchSystemInstancesInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.SearchSystemInstancesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) SearchSystemTemplates(ctx context.Context, params *iotthingsgraph.SearchSystemTemplatesInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.SearchSystemTemplatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) SearchThings(ctx context.Context, params *iotthingsgraph.SearchThingsInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.SearchThingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) TagResource(ctx context.Context, params *iotthingsgraph.TagResourceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) UndeploySystemInstance(ctx context.Context, params *iotthingsgraph.UndeploySystemInstanceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.UndeploySystemInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) UntagResource(ctx context.Context, params *iotthingsgraph.UntagResourceInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) UpdateFlowTemplate(ctx context.Context, params *iotthingsgraph.UpdateFlowTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.UpdateFlowTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) UpdateSystemTemplate(ctx context.Context, params *iotthingsgraph.UpdateSystemTemplateInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.UpdateSystemTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IotthingsgraphClient) UploadEntityDefinitions(ctx context.Context, params *iotthingsgraph.UploadEntityDefinitionsInput, optFns ...func(*iotthingsgraph.Options)) (*iotthingsgraph.UploadEntityDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIotthingsgraphClient creates a new instance of IotthingsgraphClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIotthingsgraphClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IotthingsgraphClient {
	mock := &IotthingsgraphClient{}
	mock.Mock.Test(t)
