...
// OsisClient is an autogenerated mock type for the OsisClient type
type OsisClient struct {
	mock.Mock
}

// CreatePipeline provides a mock function with given fields: ctx, params, optFns
func (_m *OsisClient) CreatePipeline(ctx context.Context, params *osis.CreatePipelineInput, optFns ...func(*osis.Options)) (*osis.CreatePipelineOutput, error) {
...
func (_m *OsisClient) DeletePipeline(ctx context.Context, params *osis.DeletePipelineInput, optFns ...func(*osis.Options)) (*osis.DeletePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) GetPipeline(ctx context.Context, params *osis.GetPipelineInput, optFns ...func(*osis.Options)) (*osis.GetPipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) GetPipelineBlueprint(ctx context.Context, params *osis.GetPipelineBlueprintInput, optFns ...func(*osis.Options)) (*osis.GetPipelineBlueprintOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) GetPipelineChangeProgress(ctx context.Context, params *osis.GetPipelineChangeProgressInput, optFns ...func(*osis.Options)) (*osis.GetPipelineChangeProgressOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) ListPipelineBlueprints(ctx context.Context, params *osis.ListPipelineBlueprintsInput, optFns ...func(*osis.Options)) (*osis.ListPipelineBlueprintsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) ListPipelines(ctx context.Context, params *osis.ListPipelinesInput, optFns ...func(*osis.Options)) (*osis.ListPipelinesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) ListTagsForResource(ctx context.Context, params *osis.ListTagsForResourceInput, optFns ...func(*osis.Options)) (*osis.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) Options() osis.Options {
	ret := _m.Called()
...
func (_m *OsisClient) StartPipeline(ctx context.Context, params *osis.StartPipelineInput, optFns ...func(*osis.Options)) (*osis.StartPipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) StopPipeline(ctx context.Context, params *osis.StopPipelineInput, optFns ...func(*osis.Options)) (*osis.StopPipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) TagResource(ctx context.Context, params *osis.TagResourceInput, optFns ...func(*osis.Options)) (*osis.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) UntagResource(ctx context.Context, params *osis.UntagResourceInput, optFns ...func(*osis.Options)) (*osis.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) UpdatePipeline(ctx context.Context, params *osis.UpdatePipelineInput, optFns ...func(*osis.Options)) (*osis.UpdatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *OsisClient) ValidatePipeline(ctx context.Context, params *osis.ValidatePipelineInput, optFns ...func(*osis.Options)) (*osis.ValidatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewOsisClient creates a new instance of OsisClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewOsisClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *OsisClient {
	mock := &OsisClient{}
