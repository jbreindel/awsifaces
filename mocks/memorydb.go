...
// MemorydbClient is an autogenerated mock type for the MemorydbClient type
type MemorydbClient struct {
	mock.Mock
}

// BatchUpdateCluster provides a mock function with given fields: ctx, params, optFns
func (_m *MemorydbClient) BatchUpdateCluster(ctx context.Context, params *memorydb.BatchUpdateClusterInput, optFns ...func(*memorydb.Options)) (*memorydb.BatchUpdateClusterOutput, error) {
...
func (_m *MemorydbClient) CopySnapshot(ctx context.Context, params *memorydb.CopySnapshotInput, optFns ...func(*memorydb.Options)) (*memorydb.CopySnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) CreateACL(ctx context.Context, params *memorydb.CreateACLInput, optFns ...func(*memorydb.Options)) (*memorydb.CreateACLOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) CreateCluster(ctx context.Context, params *memorydb.CreateClusterInput, optFns ...func(*memorydb.Options)) (*memorydb.CreateClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) CreateParameterGroup(ctx context.Context, params *memorydb.CreateParameterGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.CreateParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) CreateSnapshot(ctx context.Context, params *memorydb.CreateSnapshotInput, optFns ...func(*memorydb.Options)) (*memorydb.CreateSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) CreateSubnetGroup(ctx context.Context, params *memorydb.CreateSubnetGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.CreateSubnetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) CreateUser(ctx context.Context, params *memorydb.CreateUserInput, optFns ...func(*memorydb.Options)) (*memorydb.CreateUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DeleteACL(ctx context.Context, params *memorydb.DeleteACLInput, optFns ...func(*memorydb.Options)) (*memorydb.DeleteACLOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DeleteCluster(ctx context.Context, params *memorydb.DeleteClusterInput, optFns ...func(*memorydb.Options)) (*memorydb.DeleteClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DeleteParameterGroup(ctx context.Context, params *memorydb.DeleteParameterGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.DeleteParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DeleteSnapshot(ctx context.Context, params *memorydb.DeleteSnapshotInput, optFns ...func(*memorydb.Options)) (*memorydb.DeleteSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DeleteSubnetGroup(ctx context.Context, params *memorydb.DeleteSubnetGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.DeleteSubnetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DeleteUser(ctx context.Context, params *memorydb.DeleteUserInput, optFns ...func(*memorydb.Options)) (*memorydb.DeleteUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeACLs(ctx context.Context, params *memorydb.DescribeACLsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeACLsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeClusters(ctx context.Context, params *memorydb.DescribeClustersInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeClustersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeEngineVersions(ctx context.Context, params *memorydb.DescribeEngineVersionsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeEngineVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeEvents(ctx context.Context, params *memorydb.DescribeEventsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeParameterGroups(ctx context.Context, params *memorydb.DescribeParameterGroupsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeParameterGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeParameters(ctx context.Context, params *memorydb.DescribeParametersInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeParametersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeReservedNodes(ctx context.Context, params *memorydb.DescribeReservedNodesInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeReservedNodesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeReservedNodesOfferings(ctx context.Context, params *memorydb.DescribeReservedNodesOfferingsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeReservedNodesOfferingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeServiceUpdates(ctx context.Context, params *memorydb.DescribeServiceUpdatesInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeServiceUpdatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeSnapshots(ctx context.Context, params *memorydb.DescribeSnapshotsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeSnapshotsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeSubnetGroups(ctx context.Context, params *memorydb.DescribeSubnetGroupsInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeSubnetGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) DescribeUsers(ctx context.Context, params *memorydb.DescribeUsersInput, optFns ...func(*memorydb.Options)) (*memorydb.DescribeUsersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) FailoverShard(ctx context.Context, params *memorydb.FailoverShardInput, optFns ...func(*memorydb.Options)) (*memorydb.FailoverShardOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) ListAllowedNodeTypeUpdates(ctx context.Context, params *memorydb.ListAllowedNodeTypeUpdatesInput, optFns ...func(*memorydb.Options)) (*memorydb.ListAllowedNodeTypeUpdatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) ListTags(ctx context.Context, params *memorydb.ListTagsInput, optFns ...func(*memorydb.Options)) (*memorydb.ListTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) Options() memorydb.Options {
	ret := _m.Called()
...
func (_m *MemorydbClient) PurchaseReservedNodesOffering(ctx context.Context, params *memorydb.PurchaseReservedNodesOfferingInput, optFns ...func(*memorydb.Options)) (*memorydb.PurchaseReservedNodesOfferingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) ResetParameterGroup(ctx context.Context, params *memorydb.ResetParameterGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.ResetParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) TagResource(ctx context.Context, params *memorydb.TagResourceInput, optFns ...func(*memorydb.Options)) (*memorydb.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) UntagResource(ctx context.Context, params *memorydb.UntagResourceInput, optFns ...func(*memorydb.Options)) (*memorydb.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) UpdateACL(ctx context.Context, params *memorydb.UpdateACLInput, optFns ...func(*memorydb.Options)) (*memorydb.UpdateACLOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) UpdateCluster(ctx context.Context, params *memorydb.UpdateClusterInput, optFns ...func(*memorydb.Options)) (*memorydb.UpdateClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) UpdateParameterGroup(ctx context.Context, params *memorydb.UpdateParameterGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.UpdateParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) UpdateSubnetGroup(ctx context.Context, params *memorydb.UpdateSubnetGroupInput, optFns ...func(*memorydb.Options)) (*memorydb.UpdateSubnetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MemorydbClient) UpdateUser(ctx context.Context, params *memorydb.UpdateUserInput, optFns ...func(*memorydb.Options)) (*memorydb.UpdateUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMemorydbClient creates a new instance of MemorydbClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMemorydbClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MemorydbClient {
	mock := &MemorydbClient{}
