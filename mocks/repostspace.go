...
// RepostspaceClient is an autogenerated mock type for the RepostspaceClient type
type RepostspaceClient struct {
	mock.Mock
}

// CreateSpace provides a mock function with given fields: ctx, params, optFns
func (_m *RepostspaceClient) CreateSpace(ctx context.Context, params *repostspace.CreateSpaceInput, optFns ...func(*repostspace.Options)) (*repostspace.CreateSpaceOutput, error) {
...
func (_m *RepostspaceClient) DeleteSpace(ctx context.Context, params *repostspace.DeleteSpaceInput, optFns ...func(*repostspace.Options)) (*repostspace.DeleteSpaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) DeregisterAdmin(ctx context.Context, params *repostspace.DeregisterAdminInput, optFns ...func(*repostspace.Options)) (*repostspace.DeregisterAdminOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) GetSpace(ctx context.Context, params *repostspace.GetSpaceInput, optFns ...func(*repostspace.Options)) (*repostspace.GetSpaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) ListSpaces(ctx context.Context, params *repostspace.ListSpacesInput, optFns ...func(*repostspace.Options)) (*repostspace.ListSpacesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) ListTagsForResource(ctx context.Context, params *repostspace.ListTagsForResourceInput, optFns ...func(*repostspace.Options)) (*repostspace.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) Options() repostspace.Options {
	ret := _m.Called()
...
func (_m *RepostspaceClient) RegisterAdmin(ctx context.Context, params *repostspace.RegisterAdminInput, optFns ...func(*repostspace.Options)) (*repostspace.RegisterAdminOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) SendInvites(ctx context.Context, params *repostspace.SendInvitesInput, optFns ...func(*repostspace.Options)) (*repostspace.SendInvitesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) TagResource(ctx context.Context, params *repostspace.TagResourceInput, optFns ...func(*repostspace.Options)) (*repostspace.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) UntagResource(ctx context.Context, params *repostspace.UntagResourceInput, optFns ...func(*repostspace.Options)) (*repostspace.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RepostspaceClient) UpdateSpace(ctx context.Context, params *repostspace.UpdateSpaceInput, optFns ...func(*repostspace.Options)) (*repostspace.UpdateSpaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewRepostspaceClient creates a new instance of RepostspaceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRepostspaceClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *RepostspaceClient {
	mock := &RepostspaceClient{}
	mock.Mock.Test(t)
