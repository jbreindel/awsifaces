...
// BcmdataexportsClient is an autogenerated mock type for the BcmdataexportsClient type
type BcmdataexportsClient struct {
	mock.Mock
}

// CreateExport provides a mock function with given fields: ctx, params, optFns
func (_m *BcmdataexportsClient) CreateExport(ctx context.Context, params *bcmdataexports.CreateExportInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.CreateExportOutput, error) {
...
func (_m *BcmdataexportsClient) DeleteExport(ctx context.Context, params *bcmdataexports.DeleteExportInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.DeleteExportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) GetExecution(ctx context.Context, params *bcmdataexports.GetExecutionInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.GetExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) GetExport(ctx context.Context, params *bcmdataexports.GetExportInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.GetExportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) GetTable(ctx context.Context, params *bcmdataexports.GetTableInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.GetTableOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) ListExecutions(ctx context.Context, params *bcmdataexports.ListExecutionsInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.ListExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) ListExports(ctx context.Context, params *bcmdataexports.ListExportsInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.ListExportsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) ListTables(ctx context.Context, params *bcmdataexports.ListTablesInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.ListTablesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) ListTagsForResource(ctx context.Context, params *bcmdataexports.ListTagsForResourceInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) Options() bcmdataexports.Options {
	ret := _m.Called()
...
func (_m *BcmdataexportsClient) TagResource(ctx context.Context, params *bcmdataexports.TagResourceInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) UntagResource(ctx context.Context, params *bcmdataexports.UntagResourceInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BcmdataexportsClient) UpdateExport(ctx context.Context, params *bcmdataexports.UpdateExportInput, optFns ...func(*bcmdataexports.Options)) (*bcmdataexports.UpdateExportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewBcmdataexportsClient creates a new instance of BcmdataexportsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBcmdataexportsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *BcmdataexportsClient {
	mock := &BcmdataexportsClient{}
	mock.Mock.Test(t)
