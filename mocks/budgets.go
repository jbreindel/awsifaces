...
// BudgetsClient is an autogenerated mock type for the BudgetsClient type
type BudgetsClient struct {
	mock.Mock
}

// CreateBudget provides a mock function with given fields: ctx, params, optFns
func (_m *BudgetsClient) CreateBudget(ctx context.Context, params *budgets.CreateBudgetInput, optFns ...func(*budgets.Options)) (*budgets.CreateBudgetOutput, error) {
...
func (_m *BudgetsClient) CreateBudgetAction(ctx context.Context, params *budgets.CreateBudgetActionInput, optFns ...func(*budgets.Options)) (*budgets.CreateBudgetActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) CreateNotification(ctx context.Context, params *budgets.CreateNotificationInput, optFns ...func(*budgets.Options)) (*budgets.CreateNotificationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) CreateSubscriber(ctx context.Context, params *budgets.CreateSubscriberInput, optFns ...func(*budgets.Options)) (*budgets.CreateSubscriberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DeleteBudget(ctx context.Context, params *budgets.DeleteBudgetInput, optFns ...func(*budgets.Options)) (*budgets.DeleteBudgetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DeleteBudgetAction(ctx context.Context, params *budgets.DeleteBudgetActionInput, optFns ...func(*budgets.Options)) (*budgets.DeleteBudgetActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DeleteNotification(ctx context.Context, params *budgets.DeleteNotificationInput, optFns ...func(*budgets.Options)) (*budgets.DeleteNotificationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DeleteSubscriber(ctx context.Context, params *budgets.DeleteSubscriberInput, optFns ...func(*budgets.Options)) (*budgets.DeleteSubscriberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudget(ctx context.Context, params *budgets.DescribeBudgetInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgetAction(ctx context.Context, params *budgets.DescribeBudgetActionInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgetActionHistories(ctx context.Context, params *budgets.DescribeBudgetActionHistoriesInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetActionHistoriesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgetActionsForAccount(ctx context.Context, params *budgets.DescribeBudgetActionsForAccountInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetActionsForAccountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgetActionsForBudget(ctx context.Context, params *budgets.DescribeBudgetActionsForBudgetInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetActionsForBudgetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgetNotificationsForAccount(ctx context.Context, params *budgets.DescribeBudgetNotificationsForAccountInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetNotificationsForAccountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgetPerformanceHistory(ctx context.Context, params *budgets.DescribeBudgetPerformanceHistoryInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetPerformanceHistoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeBudgets(ctx context.Context, params *budgets.DescribeBudgetsInput, optFns ...func(*budgets.Options)) (*budgets.DescribeBudgetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeNotificationsForBudget(ctx context.Context, params *budgets.DescribeNotificationsForBudgetInput, optFns ...func(*budgets.Options)) (*budgets.DescribeNotificationsForBudgetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) DescribeSubscribersForNotification(ctx context.Context, params *budgets.DescribeSubscribersForNotificationInput, optFns ...func(*budgets.Options)) (*budgets.DescribeSubscribersForNotificationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) ExecuteBudgetAction(ctx context.Context, params *budgets.ExecuteBudgetActionInput, optFns ...func(*budgets.Options)) (*budgets.ExecuteBudgetActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) Options() budgets.Options {
	ret := _m.Called()
...
func (_m *BudgetsClient) UpdateBudget(ctx context.Context, params *budgets.UpdateBudgetInput, optFns ...func(*budgets.Options)) (*budgets.UpdateBudgetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) UpdateBudgetAction(ctx context.Context, params *budgets.UpdateBudgetActionInput, optFns ...func(*budgets.Options)) (*budgets.UpdateBudgetActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) UpdateNotification(ctx context.Context, params *budgets.UpdateNotificationInput, optFns ...func(*budgets.Options)) (*budgets.UpdateNotificationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *BudgetsClient) UpdateSubscriber(ctx context.Context, params *budgets.UpdateSubscriberInput, optFns ...func(*budgets.Options)) (*budgets.UpdateSubscriberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewBudgetsClient creates a new instance of BudgetsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBudgetsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *BudgetsClient {
	mock := &BudgetsClient{}
