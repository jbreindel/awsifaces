...
// CloudfrontkeyvaluestoreClient is an autogenerated mock type for the CloudfrontkeyvaluestoreClient type
type CloudfrontkeyvaluestoreClient struct {
	mock.Mock
}

// DeleteKey provides a mock function with given fields: ctx, params, optFns
func (_m *CloudfrontkeyvaluestoreClient) DeleteKey(ctx context.Context, params *cloudfrontkeyvaluestore.DeleteKeyInput, optFns ...func(*cloudfrontkeyvaluestore.Options)) (*cloudfrontkeyvaluestore.DeleteKeyOutput, error) {
...
func (_m *CloudfrontkeyvaluestoreClient) DescribeKeyValueStore(ctx context.Context, params *cloudfrontkeyvaluestore.DescribeKeyValueStoreInput, optFns ...func(*cloudfrontkeyvaluestore.Options)) (*cloudfrontkeyvaluestore.DescribeKeyValueStoreOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CloudfrontkeyvaluestoreClient) GetKey(ctx context.Context, params *cloudfrontkeyvaluestore.GetKeyInput, optFns ...func(*cloudfrontkeyvaluestore.Options)) (*cloudfrontkeyvaluestore.GetKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CloudfrontkeyvaluestoreClient) ListKeys(ctx context.Context, params *cloudfrontkeyvaluestore.ListKeysInput, optFns ...func(*cloudfrontkeyvaluestore.Options)) (*cloudfrontkeyvaluestore.ListKeysOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CloudfrontkeyvaluestoreClient) Options() cloudfrontkeyvaluestore.Options {
	ret := _m.Called()
...
func (_m *CloudfrontkeyvaluestoreClient) PutKey(ctx context.Context, params *cloudfrontkeyvaluestore.PutKeyInput, optFns ...func(*cloudfrontkeyvaluestore.Options)) (*cloudfrontkeyvaluestore.PutKeyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CloudfrontkeyvaluestoreClient) UpdateKeys(ctx context.Context, params *cloudfrontkeyvaluestore.UpdateKeysInput, optFns ...func(*cloudfrontkeyvaluestore.Options)) (*cloudfrontkeyvaluestore.UpdateKeysOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCloudfrontkeyvaluestoreClient creates a new instance of CloudfrontkeyvaluestoreClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCloudfrontkeyvaluestoreClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CloudfrontkeyvaluestoreClient {
	mock := &CloudfrontkeyvaluestoreClient{}
	mock.Mock.Test(t)
