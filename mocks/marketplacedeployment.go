...
// MarketplacedeploymentClient is an autogenerated mock type for the MarketplacedeploymentClient type
type MarketplacedeploymentClient struct {
	mock.Mock
}

// ListTagsForResource provides a mock function with given fields: ctx, params, optFns
func (_m *MarketplacedeploymentClient) ListTagsForResource(ctx context.Context, params *marketplacedeployment.ListTagsForResourceInput, optFns ...func(*marketplacedeployment.Options)) (*marketplacedeployment.ListTagsForResourceOutput, error) {
...
func (_m *MarketplacedeploymentClient) Options() marketplacedeployment.Options {
	ret := _m.Called()
...
func (_m *MarketplacedeploymentClient) PutDeploymentParameter(ctx context.Context, params *marketplacedeployment.PutDeploymentParameterInput, optFns ...func(*marketplacedeployment.Options)) (*marketplacedeployment.PutDeploymentParameterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacedeploymentClient) TagResource(ctx context.Context, params *marketplacedeployment.TagResourceInput, optFns ...func(*marketplacedeployment.Options)) (*marketplacedeployment.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacedeploymentClient) UntagResource(ctx context.Context, params *marketplacedeployment.UntagResourceInput, optFns ...func(*marketplacedeployment.Options)) (*marketplacedeployment.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMarketplacedeploymentClient creates a new instance of MarketplacedeploymentClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMarketplacedeploymentClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MarketplacedeploymentClient {
	mock := &MarketplacedeploymentClient{}
	mock.Mock.Test(t)
