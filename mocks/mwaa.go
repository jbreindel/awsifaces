...
// MwaaClient is an autogenerated mock type for the MwaaClient type
type MwaaClient struct {
	mock.Mock
}

// CreateCliToken provides a mock function with given fields: ctx, params, optFns
func (_m *MwaaClient) CreateCliToken(ctx context.Context, params *mwaa.CreateCliTokenInput, optFns ...func(*mwaa.Options)) (*mwaa.CreateCliTokenOutput, error) {
...
func (_m *MwaaClient) CreateEnvironment(ctx context.Context, params *mwaa.CreateEnvironmentInput, optFns ...func(*mwaa.Options)) (*mwaa.CreateEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) CreateWebLoginToken(ctx context.Context, params *mwaa.CreateWebLoginTokenInput, optFns ...func(*mwaa.Options)) (*mwaa.CreateWebLoginTokenOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) DeleteEnvironment(ctx context.Context, params *mwaa.DeleteEnvironmentInput, optFns ...func(*mwaa.Options)) (*mwaa.DeleteEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) GetEnvironment(ctx context.Context, params *mwaa.GetEnvironmentInput, optFns ...func(*mwaa.Options)) (*mwaa.GetEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) ListEnvironments(ctx context.Context, params *mwaa.ListEnvironmentsInput, optFns ...func(*mwaa.Options)) (*mwaa.ListEnvironmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) ListTagsForResource(ctx context.Context, params *mwaa.ListTagsForResourceInput, optFns ...func(*mwaa.Options)) (*mwaa.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) Options() mwaa.Options {
	ret := _m.Called()
...
func (_m *MwaaClient) PublishMetrics(ctx context.Context, params *mwaa.PublishMetricsInput, optFns ...func(*mwaa.Options)) (*mwaa.PublishMetricsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) TagResource(ctx context.Context, params *mwaa.TagResourceInput, optFns ...func(*mwaa.Options)) (*mwaa.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) UntagResource(ctx context.Context, params *mwaa.UntagResourceInput, optFns ...func(*mwaa.Options)) (*mwaa.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MwaaClient) UpdateEnvironment(ctx context.Context, params *mwaa.UpdateEnvironmentInput, optFns ...func(*mwaa.Options)) (*mwaa.UpdateEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMwaaClient creates a new instance of MwaaClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMwaaClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MwaaClient {
	mock := &MwaaClient{}
