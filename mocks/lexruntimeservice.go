...
// LexruntimeserviceClient is an autogenerated mock type for the LexruntimeserviceClient type
type LexruntimeserviceClient struct {
	mock.Mock
}

// DeleteSession provides a mock function with given fields: ctx, params, optFns
func (_m *LexruntimeserviceClient) DeleteSession(ctx context.Context, params *lexruntimeservice.DeleteSessionInput, optFns ...func(*lexruntimeservice.Options)) (*lexruntimeservice.DeleteSessionOutput, error) {
...
func (_m *LexruntimeserviceClient) GetSession(ctx context.Context, params *lexruntimeservice.GetSessionInput, optFns ...func(*lexruntimeservice.Options)) (*lexruntimeservice.GetSessionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LexruntimeserviceClient) Options() lexruntimeservice.Options {
	ret := _m.Called()
...
func (_m *LexruntimeserviceClient) PostContent(ctx context.Context, params *lexruntimeservice.PostContentInput, optFns ...func(*lexruntimeservice.Options)) (*lexruntimeservice.PostContentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LexruntimeserviceClient) PostText(ctx context.Context, params *lexruntimeservice.PostTextInput, optFns ...func(*lexruntimeservice.Options)) (*lexruntimeservice.PostTextOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LexruntimeserviceClient) PutSession(ctx context.Context, params *lexruntimeservice.PutSessionInput, optFns ...func(*lexruntimeservice.Options)) (*lexruntimeservice.PutSessionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewLexruntimeserviceClient creates a new instance of LexruntimeserviceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLexruntimeserviceClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *LexruntimeserviceClient {
	mock := &LexruntimeserviceClient{}
	mock.Mock.Test(t)
