...
// TrustedadvisorClient is an autogenerated mock type for the TrustedadvisorClient type
type TrustedadvisorClient struct {
	mock.Mock
}

// GetOrganizationRecommendation provides a mock function with given fields: ctx, params, optFns
func (_m *TrustedadvisorClient) GetOrganizationRecommendation(ctx context.Context, params *trustedadvisor.GetOrganizationRecommendationInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.GetOrganizationRecommendationOutput, error) {
...
func (_m *TrustedadvisorClient) GetRecommendation(ctx context.Context, params *trustedadvisor.GetRecommendationInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.GetRecommendationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) ListChecks(ctx context.Context, params *trustedadvisor.ListChecksInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListChecksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) ListOrganizationRecommendationAccounts(ctx context.Context, params *trustedadvisor.ListOrganizationRecommendationAccountsInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListOrganizationRecommendationAccountsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) ListOrganizationRecommendationResources(ctx context.Context, params *trustedadvisor.ListOrganizationRecommendationResourcesInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListOrganizationRecommendationResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) ListOrganizationRecommendations(ctx context.Context, params *trustedadvisor.ListOrganizationRecommendationsInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListOrganizationRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) ListRecommendationResources(ctx context.Context, params *trustedadvisor.ListRecommendationResourcesInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListRecommendationResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) ListRecommendations(ctx context.Context, params *trustedadvisor.ListRecommendationsInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.ListRecommendationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) Options() trustedadvisor.Options {
	ret := _m.Called()
...
func (_m *TrustedadvisorClient) UpdateOrganizationRecommendationLifecycle(ctx context.Context, params *trustedadvisor.UpdateOrganizationRecommendationLifecycleInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.UpdateOrganizationRecommendationLifecycleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TrustedadvisorClient) UpdateRecommendationLifecycle(ctx context.Context, params *trustedadvisor.UpdateRecommendationLifecycleInput, optFns ...func(*trustedadvisor.Options)) (*trustedadvisor.UpdateRecommendationLifecycleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewTrustedadvisorClient creates a new instance of TrustedadvisorClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTrustedadvisorClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *TrustedadvisorClient {
	mock := &TrustedadvisorClient{}
	mock.Mock.Test(t)
