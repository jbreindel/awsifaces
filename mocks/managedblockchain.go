...
// ManagedblockchainClient is an autogenerated mock type for the ManagedblockchainClient type
type ManagedblockchainClient struct {
	mock.Mock
}

// CreateAccessor provides a mock function with given fields: ctx, params, optFns
func (_m *ManagedblockchainClient) CreateAccessor(ctx context.Context, params *managedblockchain.CreateAccessorInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.CreateAccessorOutput, error) {
...
func (_m *ManagedblockchainClient) CreateMember(ctx context.Context, params *managedblockchain.CreateMemberInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.CreateMemberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) CreateNetwork(ctx context.Context, params *managedblockchain.CreateNetworkInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.CreateNetworkOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) CreateNode(ctx context.Context, params *managedblockchain.CreateNodeInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.CreateNodeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) CreateProposal(ctx context.Context, params *managedblockchain.CreateProposalInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.CreateProposalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) DeleteAccessor(ctx context.Context, params *managedblockchain.DeleteAccessorInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.DeleteAccessorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) DeleteMember(ctx context.Context, params *managedblockchain.DeleteMemberInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.DeleteMemberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) DeleteNode(ctx context.Context, params *managedblockchain.DeleteNodeInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.DeleteNodeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) GetAccessor(ctx context.Context, params *managedblockchain.GetAccessorInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.GetAccessorOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) GetMember(ctx context.Context, params *managedblockchain.GetMemberInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.GetMemberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) GetNetwork(ctx context.Context, params *managedblockchain.GetNetworkInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.GetNetworkOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) GetNode(ctx context.Context, params *managedblockchain.GetNodeInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.GetNodeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) GetProposal(ctx context.Context, params *managedblockchain.GetProposalInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.GetProposalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListAccessors(ctx context.Context, params *managedblockchain.ListAccessorsInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListAccessorsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListInvitations(ctx context.Context, params *managedblockchain.ListInvitationsInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListInvitationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListMembers(ctx context.Context, params *managedblockchain.ListMembersInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListMembersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListNetworks(ctx context.Context, params *managedblockchain.ListNetworksInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListNetworksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListNodes(ctx context.Context, params *managedblockchain.ListNodesInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListNodesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListProposalVotes(ctx context.Context, params *managedblockchain.ListProposalVotesInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListProposalVotesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListProposals(ctx context.Context, params *managedblockchain.ListProposalsInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListProposalsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) ListTagsForResource(ctx context.Context, params *managedblockchain.ListTagsForResourceInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) Options() managedblockchain.Options {
	ret := _m.Called()
...
func (_m *ManagedblockchainClient) RejectInvitation(ctx context.Context, params *managedblockchain.RejectInvitationInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.RejectInvitationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) TagResource(ctx context.Context, params *managedblockchain.TagResourceInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) UntagResource(ctx context.Context, params *managedblockchain.UntagResourceInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) UpdateMember(ctx context.Context, params *managedblockchain.UpdateMemberInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.UpdateMemberOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) UpdateNode(ctx context.Context, params *managedblockchain.UpdateNodeInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.UpdateNodeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ManagedblockchainClient) VoteOnProposal(ctx context.Context, params *managedblockchain.VoteOnProposalInput, optFns ...func(*managedblockchain.Options)) (*managedblockchain.VoteOnProposalOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewManagedblockchainClient creates a new instance of ManagedblockchainClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewManagedblockchainClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ManagedblockchainClient {
	mock := &ManagedblockchainClient{}
	mock.Mock.Test(t)
