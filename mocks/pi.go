...
// PiClient is an autogenerated mock type for the PiClient type
type PiClient struct {
	mock.Mock
}

// CreatePerformanceAnalysisReport provides a mock function with given fields: ctx, params, optFns
func (_m *PiClient) CreatePerformanceAnalysisReport(ctx context.Context, params *pi.CreatePerformanceAnalysisReportInput, optFns ...func(*pi.Options)) (*pi.CreatePerformanceAnalysisReportOutput, error) {
...
func (_m *PiClient) DeletePerformanceAnalysisReport(ctx context.Context, params *pi.DeletePerformanceAnalysisReportInput, optFns ...func(*pi.Options)) (*pi.DeletePerformanceAnalysisReportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) DescribeDimensionKeys(ctx context.Context, params *pi.DescribeDimensionKeysInput, optFns ...func(*pi.Options)) (*pi.DescribeDimensionKeysOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) GetDimensionKeyDetails(ctx context.Context, params *pi.GetDimensionKeyDetailsInput, optFns ...func(*pi.Options)) (*pi.GetDimensionKeyDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) GetPerformanceAnalysisReport(ctx context.Context, params *pi.GetPerformanceAnalysisReportInput, optFns ...func(*pi.Options)) (*pi.GetPerformanceAnalysisReportOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) GetResourceMetadata(ctx context.Context, params *pi.GetResourceMetadataInput, optFns ...func(*pi.Options)) (*pi.GetResourceMetadataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) GetResourceMetrics(ctx context.Context, params *pi.GetResourceMetricsInput, optFns ...func(*pi.Options)) (*pi.GetResourceMetricsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) ListAvailableResourceDimensions(ctx context.Context, params *pi.ListAvailableResourceDimensionsInput, optFns ...func(*pi.Options)) (*pi.ListAvailableResourceDimensionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) ListAvailableResourceMetrics(ctx context.Context, params *pi.ListAvailableResourceMetricsInput, optFns ...func(*pi.Options)) (*pi.ListAvailableResourceMetricsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) ListPerformanceAnalysisReports(ctx context.Context, params *pi.ListPerformanceAnalysisReportsInput, optFns ...func(*pi.Options)) (*pi.ListPerformanceAnalysisReportsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) ListTagsForResource(ctx context.Context, params *pi.ListTagsForResourceInput, optFns ...func(*pi.Options)) (*pi.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) Options() pi.Options {
	ret := _m.Called()
...
func (_m *PiClient) TagResource(ctx context.Context, params *pi.TagResourceInput, optFns ...func(*pi.Options)) (*pi.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PiClient) UntagResource(ctx context.Context, params *pi.UntagResourceInput, optFns ...func(*pi.Options)) (*pi.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewPiClient creates a new instance of PiClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPiClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *PiClient {
	mock := &PiClient{}
