...
// ElastictranscoderClient is an autogenerated mock type for the ElastictranscoderClient type
type ElastictranscoderClient struct {
	mock.Mock
}

// CancelJob provides a mock function with given fields: ctx, params, optFns
func (_m *ElastictranscoderClient) CancelJob(ctx context.Context, params *elastictranscoder.CancelJobInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.CancelJobOutput, error) {
...
func (_m *ElastictranscoderClient) CreateJob(ctx context.Context, params *elastictranscoder.CreateJobInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.CreateJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) CreatePipeline(ctx context.Context, params *elastictranscoder.CreatePipelineInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.CreatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) CreatePreset(ctx context.Context, params *elastictranscoder.CreatePresetInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.CreatePresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) DeletePipeline(ctx context.Context, params *elastictranscoder.DeletePipelineInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.DeletePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) DeletePreset(ctx context.Context, params *elastictranscoder.DeletePresetInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.DeletePresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) ListJobsByPipeline(ctx context.Context, params *elastictranscoder.ListJobsByPipelineInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ListJobsByPipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) ListJobsByStatus(ctx context.Context, params *elastictranscoder.ListJobsByStatusInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ListJobsByStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) ListPipelines(ctx context.Context, params *elastictranscoder.ListPipelinesInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ListPipelinesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) ListPresets(ctx context.Context, params *elastictranscoder.ListPresetsInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ListPresetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) Options() elastictranscoder.Options {
	ret := _m.Called()
...
func (_m *ElastictranscoderClient) ReadJob(ctx context.Context, params *elastictranscoder.ReadJobInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ReadJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) ReadPipeline(ctx context.Context, params *elastictranscoder.ReadPipelineInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ReadPipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) ReadPreset(ctx context.Context, params *elastictranscoder.ReadPresetInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.ReadPresetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) TestRole(ctx context.Context, params *elastictranscoder.TestRoleInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.TestRoleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) UpdatePipeline(ctx context.Context, params *elastictranscoder.UpdatePipelineInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.UpdatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) UpdatePipelineNotifications(ctx context.Context, params *elastictranscoder.UpdatePipelineNotificationsInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.UpdatePipelineNotificationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElastictranscoderClient) UpdatePipelineStatus(ctx context.Context, params *elastictranscoder.UpdatePipelineStatusInput, optFns ...func(*elastictranscoder.Options)) (*elastictranscoder.UpdatePipelineStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewElastictranscoderClient creates a new instance of ElastictranscoderClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewElastictranscoderClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ElastictranscoderClient {
	mock := &ElastictranscoderClient{}
	mock.Mock.Test(t)
