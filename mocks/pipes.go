...
// PipesClient is an autogenerated mock type for the PipesClient type
type PipesClient struct {
	mock.Mock
}

// CreatePipe provides a mock function with given fields: ctx, params, optFns
func (_m *PipesClient) CreatePipe(ctx context.Context, params *pipes.CreatePipeInput, optFns ...func(*pipes.Options)) (*pipes.CreatePipeOutput, error) {
...
func (_m *PipesClient) DeletePipe(ctx context.Context, params *pipes.DeletePipeInput, optFns ...func(*pipes.Options)) (*pipes.DeletePipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) DescribePipe(ctx context.Context, params *pipes.DescribePipeInput, optFns ...func(*pipes.Options)) (*pipes.DescribePipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) ListPipes(ctx context.Context, params *pipes.ListPipesInput, optFns ...func(*pipes.Options)) (*pipes.ListPipesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) ListTagsForResource(ctx context.Context, params *pipes.ListTagsForResourceInput, optFns ...func(*pipes.Options)) (*pipes.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) Options() pipes.Options {
	ret := _m.Called()
...
func (_m *PipesClient) StartPipe(ctx context.Context, params *pipes.StartPipeInput, optFns ...func(*pipes.Options)) (*pipes.StartPipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) StopPipe(ctx context.Context, params *pipes.StopPipeInput, optFns ...func(*pipes.Options)) (*pipes.StopPipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) TagResource(ctx context.Context, params *pipes.TagResourceInput, optFns ...func(*pipes.Options)) (*pipes.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) UntagResource(ctx context.Context, params *pipes.UntagResourceInput, optFns ...func(*pipes.Options)) (*pipes.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PipesClient) UpdatePipe(ctx context.Context, params *pipes.UpdatePipeInput, optFns ...func(*pipes.Options)) (*pipes.UpdatePipeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewPipesClient creates a new instance of PipesClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPipesClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *PipesClient {
	mock := &PipesClient{}
