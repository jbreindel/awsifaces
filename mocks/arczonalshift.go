...
// ArczonalshiftClient is an autogenerated mock type for the ArczonalshiftClient type
type ArczonalshiftClient struct {
	mock.Mock
}

// CancelZonalShift provides a mock function with given fields: ctx, params, optFns
func (_m *ArczonalshiftClient) CancelZonalShift(ctx context.Context, params *arczonalshift.CancelZonalShiftInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.CancelZonalShiftOutput, error) {
...
func (_m *ArczonalshiftClient) CreatePracticeRunConfiguration(ctx context.Context, params *arczonalshift.CreatePracticeRunConfigurationInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.CreatePracticeRunConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) DeletePracticeRunConfiguration(ctx context.Context, params *arczonalshift.DeletePracticeRunConfigurationInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.DeletePracticeRunConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) GetManagedResource(ctx context.Context, params *arczonalshift.GetManagedResourceInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.GetManagedResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) ListAutoshifts(ctx context.Context, params *arczonalshift.ListAutoshiftsInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.ListAutoshiftsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) ListManagedResources(ctx context.Context, params *arczonalshift.ListManagedResourcesInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.ListManagedResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) ListZonalShifts(ctx context.Context, params *arczonalshift.ListZonalShiftsInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.ListZonalShiftsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) Options() arczonalshift.Options {
	ret := _m.Called()
...
func (_m *ArczonalshiftClient) StartZonalShift(ctx context.Context, params *arczonalshift.StartZonalShiftInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.StartZonalShiftOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) UpdatePracticeRunConfiguration(ctx context.Context, params *arczonalshift.UpdatePracticeRunConfigurationInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.UpdatePracticeRunConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) UpdateZonalAutoshiftConfiguration(ctx context.Context, params *arczonalshift.UpdateZonalAutoshiftConfigurationInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.UpdateZonalAutoshiftConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ArczonalshiftClient) UpdateZonalShift(ctx context.Context, params *arczonalshift.UpdateZonalShiftInput, optFns ...func(*arczonalshift.Options)) (*arczonalshift.UpdateZonalShiftOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewArczonalshiftClient creates a new instance of ArczonalshiftClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewArczonalshiftClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ArczonalshiftClient {
	mock := &ArczonalshiftClient{}
	mock.Mock.Test(t)
