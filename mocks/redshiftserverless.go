...
// RedshiftserverlessClient is an autogenerated mock type for the RedshiftserverlessClient type
...
func (_m *RedshiftserverlessClient) ConvertRecoveryPointToSnapshot(ctx context.Context, params *redshiftserverless.ConvertRecoveryPointToSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ConvertRecoveryPointToSnapshotOutput, error) {
...
func (_m *RedshiftserverlessClient) CreateCustomDomainAssociation(ctx context.Context, params *redshiftserverless.CreateCustomDomainAssociationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateCustomDomainAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateEndpointAccess(ctx context.Context, params *redshiftserverless.CreateEndpointAccessInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateEndpointAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateNamespace(ctx context.Context, params *redshiftserverless.CreateNamespaceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateNamespaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateScheduledAction(ctx context.Context, params *redshiftserverless.CreateScheduledActionInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateScheduledActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateSnapshot(ctx context.Context, params *redshiftserverless.CreateSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateSnapshotCopyConfiguration(ctx context.Context, params *redshiftserverless.CreateSnapshotCopyConfigurationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateSnapshotCopyConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateUsageLimit(ctx context.Context, params *redshiftserverless.CreateUsageLimitInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateUsageLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) CreateWorkgroup(ctx context.Context, params *redshiftserverless.CreateWorkgroupInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.CreateWorkgroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteCustomDomainAssociation(ctx context.Context, params *redshiftserverless.DeleteCustomDomainAssociationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteCustomDomainAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteEndpointAccess(ctx context.Context, params *redshiftserverless.DeleteEndpointAccessInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteEndpointAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteNamespace(ctx context.Context, params *redshiftserverless.DeleteNamespaceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteNamespaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteResourcePolicy(ctx context.Context, params *redshiftserverless.DeleteResourcePolicyInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteScheduledAction(ctx context.Context, params *redshiftserverless.DeleteScheduledActionInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteScheduledActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteSnapshot(ctx context.Context, params *redshiftserverless.DeleteSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteSnapshotCopyConfiguration(ctx context.Context, params *redshiftserverless.DeleteSnapshotCopyConfigurationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteSnapshotCopyConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteUsageLimit(ctx context.Context, params *redshiftserverless.DeleteUsageLimitInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteUsageLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) DeleteWorkgroup(ctx context.Context, params *redshiftserverless.DeleteWorkgroupInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.DeleteWorkgroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetCredentials(ctx context.Context, params *redshiftserverless.GetCredentialsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetCustomDomainAssociation(ctx context.Context, params *redshiftserverless.GetCustomDomainAssociationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetCustomDomainAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetEndpointAccess(ctx context.Context, params *redshiftserverless.GetEndpointAccessInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetEndpointAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetNamespace(ctx context.Context, params *redshiftserverless.GetNamespaceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetNamespaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetRecoveryPoint(ctx context.Context, params *redshiftserverless.GetRecoveryPointInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetRecoveryPointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetResourcePolicy(ctx context.Context, params *redshiftserverless.GetResourcePolicyInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetScheduledAction(ctx context.Context, params *redshiftserverless.GetScheduledActionInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetScheduledActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetSnapshot(ctx context.Context, params *redshiftserverless.GetSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetTableRestoreStatus(ctx context.Context, params *redshiftserverless.GetTableRestoreStatusInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetTableRestoreStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetUsageLimit(ctx context.Context, params *redshiftserverless.GetUsageLimitInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetUsageLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) GetWorkgroup(ctx context.Context, params *redshiftserverless.GetWorkgroupInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.GetWorkgroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListCustomDomainAssociations(ctx context.Context, params *redshiftserverless.ListCustomDomainAssociationsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListCustomDomainAssociationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListEndpointAccess(ctx context.Context, params *redshiftserverless.ListEndpointAccessInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListEndpointAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListNamespaces(ctx context.Context, params *redshiftserverless.ListNamespacesInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListNamespacesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListRecoveryPoints(ctx context.Context, params *redshiftserverless.ListRecoveryPointsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListRecoveryPointsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListScheduledActions(ctx context.Context, params *redshiftserverless.ListScheduledActionsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListScheduledActionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListSnapshotCopyConfigurations(ctx context.Context, params *redshiftserverless.ListSnapshotCopyConfigurationsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListSnapshotCopyConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListSnapshots(ctx context.Context, params *redshiftserverless.ListSnapshotsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListSnapshotsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListTableRestoreStatus(ctx context.Context, params *redshiftserverless.ListTableRestoreStatusInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListTableRestoreStatusOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListTagsForResource(ctx context.Context, params *redshiftserverless.ListTagsForResourceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListUsageLimits(ctx context.Context, params *redshiftserverless.ListUsageLimitsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListUsageLimitsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) ListWorkgroups(ctx context.Context, params *redshiftserverless.ListWorkgroupsInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.ListWorkgroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) Options() redshiftserverless.Options {
	ret := _m.Called()
...
func (_m *RedshiftserverlessClient) PutResourcePolicy(ctx context.Context, params *redshiftserverless.PutResourcePolicyInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.PutResourcePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) RestoreFromRecoveryPoint(ctx context.Context, params *redshiftserverless.RestoreFromRecoveryPointInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.RestoreFromRecoveryPointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) RestoreFromSnapshot(ctx context.Context, params *redshiftserverless.RestoreFromSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.RestoreFromSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) RestoreTableFromRecoveryPoint(ctx context.Context, params *redshiftserverless.RestoreTableFromRecoveryPointInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.RestoreTableFromRecoveryPointOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) RestoreTableFromSnapshot(ctx context.Context, params *redshiftserverless.RestoreTableFromSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.RestoreTableFromSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) TagResource(ctx context.Context, params *redshiftserverless.TagResourceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UntagResource(ctx context.Context, params *redshiftserverless.UntagResourceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateCustomDomainAssociation(ctx context.Context, params *redshiftserverless.UpdateCustomDomainAssociationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateCustomDomainAssociationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateEndpointAccess(ctx context.Context, params *redshiftserverless.UpdateEndpointAccessInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateEndpointAccessOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateNamespace(ctx context.Context, params *redshiftserverless.UpdateNamespaceInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateNamespaceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateScheduledAction(ctx context.Context, params *redshiftserverless.UpdateScheduledActionInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateScheduledActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateSnapshot(ctx context.Context, params *redshiftserverless.UpdateSnapshotInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateSnapshotCopyConfiguration(ctx context.Context, params *redshiftserverless.UpdateSnapshotCopyConfigurationInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateSnapshotCopyConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateUsageLimit(ctx context.Context, params *redshiftserverless.UpdateUsageLimitInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateUsageLimitOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *RedshiftserverlessClient) UpdateWorkgroup(ctx context.Context, params *redshiftserverless.UpdateWorkgroupInput, optFns ...func(*redshiftserverless.Options)) (*redshiftserverless.UpdateWorkgroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewRedshiftserverlessClient creates a new instance of RedshiftserverlessClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRedshiftserverlessClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *RedshiftserverlessClient {
	mock := &RedshiftserverlessClient{}
	mock.Mock.Test(t)
