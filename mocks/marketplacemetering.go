...
// MarketplacemeteringClient is an autogenerated mock type for the MarketplacemeteringClient type
type MarketplacemeteringClient struct {
	mock.Mock
}

// BatchMeterUsage provides a mock function with given fields: ctx, params, optFns
func (_m *MarketplacemeteringClient) BatchMeterUsage(ctx context.Context, params *marketplacemetering.BatchMeterUsageInput, optFns ...func(*marketplacemetering.Options)) (*marketplacemetering.BatchMeterUsageOutput, error) {
...
func (_m *MarketplacemeteringClient) MeterUsage(ctx context.Context, params *marketplacemetering.MeterUsageInput, optFns ...func(*marketplacemetering.Options)) (*marketplacemetering.MeterUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacemeteringClient) Options() marketplacemetering.Options {
	ret := _m.Called()
...
func (_m *MarketplacemeteringClient) RegisterUsage(ctx context.Context, params *marketplacemetering.RegisterUsageInput, optFns ...func(*marketplacemetering.Options)) (*marketplacemetering.RegisterUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MarketplacemeteringClient) ResolveCustomer(ctx context.Context, params *marketplacemetering.ResolveCustomerInput, optFns ...func(*marketplacemetering.Options)) (*marketplacemetering.ResolveCustomerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMarketplacemeteringClient creates a new instance of MarketplacemeteringClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMarketplacemeteringClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MarketplacemeteringClient {
	mock := &MarketplacemeteringClient{}
	mock.Mock.Test(t)
