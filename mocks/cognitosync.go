...
// CognitosyncClient is an autogenerated mock type for the CognitosyncClient type
type CognitosyncClient struct {
	mock.Mock
}

// BulkPublish provides a mock function with given fields: ctx, params, optFns
func (_m *CognitosyncClient) BulkPublish(ctx context.Context, params *cognitosync.BulkPublishInput, optFns ...func(*cognitosync.Options)) (*cognitosync.BulkPublishOutput, error) {
...
func (_m *CognitosyncClient) DeleteDataset(ctx context.Context, params *cognitosync.DeleteDatasetInput, optFns ...func(*cognitosync.Options)) (*cognitosync.DeleteDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) DescribeDataset(ctx context.Context, params *cognitosync.DescribeDatasetInput, optFns ...func(*cognitosync.Options)) (*cognitosync.DescribeDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) DescribeIdentityPoolUsage(ctx context.Context, params *cognitosync.DescribeIdentityPoolUsageInput, optFns ...func(*cognitosync.Options)) (*cognitosync.DescribeIdentityPoolUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) DescribeIdentityUsage(ctx context.Context, params *cognitosync.DescribeIdentityUsageInput, optFns ...func(*cognitosync.Options)) (*cognitosync.DescribeIdentityUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) GetBulkPublishDetails(ctx context.Context, params *cognitosync.GetBulkPublishDetailsInput, optFns ...func(*cognitosync.Options)) (*cognitosync.GetBulkPublishDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) GetCognitoEvents(ctx context.Context, params *cognitosync.GetCognitoEventsInput, optFns ...func(*cognitosync.Options)) (*cognitosync.GetCognitoEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) GetIdentityPoolConfiguration(ctx context.Context, params *cognitosync.GetIdentityPoolConfigurationInput, optFns ...func(*cognitosync.Options)) (*cognitosync.GetIdentityPoolConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) ListDatasets(ctx context.Context, params *cognitosync.ListDatasetsInput, optFns ...func(*cognitosync.Options)) (*cognitosync.ListDatasetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) ListIdentityPoolUsage(ctx context.Context, params *cognitosync.ListIdentityPoolUsageInput, optFns ...func(*cognitosync.Options)) (*cognitosync.ListIdentityPoolUsageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) ListRecords(ctx context.Context, params *cognitosync.ListRecordsInput, optFns ...func(*cognitosync.Options)) (*cognitosync.ListRecordsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) Options() cognitosync.Options {
	ret := _m.Called()
...
func (_m *CognitosyncClient) RegisterDevice(ctx context.Context, params *cognitosync.RegisterDeviceInput, optFns ...func(*cognitosync.Options)) (*cognitosync.RegisterDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) SetCognitoEvents(ctx context.Context, params *cognitosync.SetCognitoEventsInput, optFns ...func(*cognitosync.Options)) (*cognitosync.SetCognitoEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) SetIdentityPoolConfiguration(ctx context.Context, params *cognitosync.SetIdentityPoolConfigurationInput, optFns ...func(*cognitosync.Options)) (*cognitosync.SetIdentityPoolConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) SubscribeToDataset(ctx context.Context, params *cognitosync.SubscribeToDatasetInput, optFns ...func(*cognitosync.Options)) (*cognitosync.SubscribeToDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) UnsubscribeFromDataset(ctx context.Context, params *cognitosync.UnsubscribeFromDatasetInput, optFns ...func(*cognitosync.Options)) (*cognitosync.UnsubscribeFromDatasetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CognitosyncClient) UpdateRecords(ctx context.Context, params *cognitosync.UpdateRecordsInput, optFns ...func(*cognitosync.Options)) (*cognitosync.UpdateRecordsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCognitosyncClient creates a new instance of CognitosyncClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCognitosyncClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CognitosyncClient {
	mock := &CognitosyncClient{}
	mock.Mock.Test(t)
