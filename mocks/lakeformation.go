...
// LakeformationClient is an autogenerated mock type for the LakeformationClient type
type LakeformationClient struct {
	mock.Mock
}

// AddLFTagsToResource provides a mock function with given fields: ctx, params, optFns
func (_m *LakeformationClient) AddLFTagsToResource(ctx context.Context, params *lakeformation.AddLFTagsToResourceInput, optFns ...func(*lakeformation.Options)) (*lakeformation.AddLFTagsToResourceOutput, error) {
...
func (_m *LakeformationClient) AssumeDecoratedRoleWithSAML(ctx context.Context, params *lakeformation.AssumeDecoratedRoleWithSAMLInput, optFns ...func(*lakeformation.Options)) (*lakeformation.AssumeDecoratedRoleWithSAMLOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) BatchGrantPermissions(ctx context.Context, params *lakeformation.BatchGrantPermissionsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.BatchGrantPermissionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) BatchRevokePermissions(ctx context.Context, params *lakeformation.BatchRevokePermissionsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.BatchRevokePermissionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) CancelTransaction(ctx context.Context, params *lakeformation.CancelTransactionInput, optFns ...func(*lakeformation.Options)) (*lakeformation.CancelTransactionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) CommitTransaction(ctx context.Context, params *lakeformation.CommitTransactionInput, optFns ...func(*lakeformation.Options)) (*lakeformation.CommitTransactionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) CreateDataCellsFilter(ctx context.Context, params *lakeformation.CreateDataCellsFilterInput, optFns ...func(*lakeformation.Options)) (*lakeformation.CreateDataCellsFilterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) CreateLFTag(ctx context.Context, params *lakeformation.CreateLFTagInput, optFns ...func(*lakeformation.Options)) (*lakeformation.CreateLFTagOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) CreateLakeFormationIdentityCenterConfiguration(ctx context.Context, params *lakeformation.CreateLakeFormationIdentityCenterConfigurationInput, optFns ...func(*lakeformation.Options)) (*lakeformation.CreateLakeFormationIdentityCenterConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) CreateLakeFormationOptIn(ctx context.Context, params *lakeformation.CreateLakeFormationOptInInput, optFns ...func(*lakeformation.Options)) (*lakeformation.CreateLakeFormationOptInOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DeleteDataCellsFilter(ctx context.Context, params *lakeformation.DeleteDataCellsFilterInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DeleteDataCellsFilterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DeleteLFTag(ctx context.Context, params *lakeformation.DeleteLFTagInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DeleteLFTagOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DeleteLakeFormationIdentityCenterConfiguration(ctx context.Context, params *lakeformation.DeleteLakeFormationIdentityCenterConfigurationInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DeleteLakeFormationIdentityCenterConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DeleteLakeFormationOptIn(ctx context.Context, params *lakeformation.DeleteLakeFormationOptInInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DeleteLakeFormationOptInOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DeleteObjectsOnCancel(ctx context.Context, params *lakeformation.DeleteObjectsOnCancelInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DeleteObjectsOnCancelOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DeregisterResource(ctx context.Context, params *lakeformation.DeregisterResourceInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DeregisterResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DescribeLakeFormationIdentityCenterConfiguration(ctx context.Context, params *lakeformation.DescribeLakeFormationIdentityCenterConfigurationInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DescribeLakeFormationIdentityCenterConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DescribeResource(ctx context.Context, params *lakeformation.DescribeResourceInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DescribeResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) DescribeTransaction(ctx context.Context, params *lakeformation.DescribeTransactionInput, optFns ...func(*lakeformation.Options)) (*lakeformation.DescribeTransactionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ExtendTransaction(ctx context.Context, params *lakeformation.ExtendTransactionInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ExtendTransactionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetDataCellsFilter(ctx context.Context, params *lakeformation.GetDataCellsFilterInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetDataCellsFilterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetDataLakeSettings(ctx context.Context, params *lakeformation.GetDataLakeSettingsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetDataLakeSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetEffectivePermissionsForPath(ctx context.Context, params *lakeformation.GetEffectivePermissionsForPathInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetEffectivePermissionsForPathOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetLFTag(ctx context.Context, params *lakeformation.GetLFTagInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetLFTagOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetQueryState(ctx context.Context, params *lakeformation.GetQueryStateInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetQueryStateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetQueryStatistics(ctx context.Context, params *lakeformation.GetQueryStatisticsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetQueryStatisticsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetResourceLFTags(ctx context.Context, params *lakeformation.GetResourceLFTagsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetResourceLFTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetTableObjects(ctx context.Context, params *lakeformation.GetTableObjectsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetTableObjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetTemporaryGluePartitionCredentials(ctx context.Context, params *lakeformation.GetTemporaryGluePartitionCredentialsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetTemporaryGluePartitionCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetTemporaryGlueTableCredentials(ctx context.Context, params *lakeformation.GetTemporaryGlueTableCredentialsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetTemporaryGlueTableCredentialsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetWorkUnitResults(ctx context.Context, params *lakeformation.GetWorkUnitResultsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetWorkUnitResultsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GetWorkUnits(ctx context.Context, params *lakeformation.GetWorkUnitsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GetWorkUnitsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) GrantPermissions(ctx context.Context, params *lakeformation.GrantPermissionsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.GrantPermissionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListDataCellsFilter(ctx context.Context, params *lakeformation.ListDataCellsFilterInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListDataCellsFilterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListLFTags(ctx context.Context, params *lakeformation.ListLFTagsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListLFTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListLakeFormationOptIns(ctx context.Context, params *lakeformation.ListLakeFormationOptInsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListLakeFormationOptInsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListPermissions(ctx context.Context, params *lakeformation.ListPermissionsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListPermissionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListResources(ctx context.Context, params *lakeformation.ListResourcesInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListResourcesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListTableStorageOptimizers(ctx context.Context, params *lakeformation.ListTableStorageOptimizersInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListTableStorageOptimizersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) ListTransactions(ctx context.Context, params *lakeformation.ListTransactionsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.ListTransactionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) Options() lakeformation.Options {
	ret := _m.Called()
...
func (_m *LakeformationClient) PutDataLakeSettings(ctx context.Context, params *lakeformation.PutDataLakeSettingsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.PutDataLakeSettingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) RegisterResource(ctx context.Context, params *lakeformation.RegisterResourceInput, optFns ...func(*lakeformation.Options)) (*lakeformation.RegisterResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) RemoveLFTagsFromResource(ctx context.Context, params *lakeformation.RemoveLFTagsFromResourceInput, optFns ...func(*lakeformation.Options)) (*lakeformation.RemoveLFTagsFromResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) RevokePermissions(ctx context.Context, params *lakeformation.RevokePermissionsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.RevokePermissionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) SearchDatabasesByLFTags(ctx context.Context, params *lakeformation.SearchDatabasesByLFTagsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.SearchDatabasesByLFTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) SearchTablesByLFTags(ctx context.Context, params *lakeformation.SearchTablesByLFTagsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.SearchTablesByLFTagsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) StartQueryPlanning(ctx context.Context, params *lakeformation.StartQueryPlanningInput, optFns ...func(*lakeformation.Options)) (*lakeformation.StartQueryPlanningOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) StartTransaction(ctx context.Context, params *lakeformation.StartTransactionInput, optFns ...func(*lakeformation.Options)) (*lakeformation.StartTransactionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) UpdateDataCellsFilter(ctx context.Context, params *lakeformation.UpdateDataCellsFilterInput, optFns ...func(*lakeformation.Options)) (*lakeformation.UpdateDataCellsFilterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) UpdateLFTag(ctx context.Context, params *lakeformation.UpdateLFTagInput, optFns ...func(*lakeformation.Options)) (*lakeformation.UpdateLFTagOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) UpdateLakeFormationIdentityCenterConfiguration(ctx context.Context, params *lakeformation.UpdateLakeFormationIdentityCenterConfigurationInput, optFns ...func(*lakeformation.Options)) (*lakeformation.UpdateLakeFormationIdentityCenterConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) UpdateResource(ctx context.Context, params *lakeformation.UpdateResourceInput, optFns ...func(*lakeformation.Options)) (*lakeformation.UpdateResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) UpdateTableObjects(ctx context.Context, params *lakeformation.UpdateTableObjectsInput, optFns ...func(*lakeformation.Options)) (*lakeformation.UpdateTableObjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *LakeformationClient) UpdateTableStorageOptimizer(ctx context.Context, params *lakeformation.UpdateTableStorageOptimizerInput, optFns ...func(*lakeformation.Options)) (*lakeformation.UpdateTableStorageOptimizerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewLakeformationClient creates a new instance of LakeformationClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLakeformationClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *LakeformationClient {
	mock := &LakeformationClient{}
	mock.Mock.Test(t)
