...
// KinesisanalyticsClient is an autogenerated mock type for the KinesisanalyticsClient type
type KinesisanalyticsClient struct {
	mock.Mock
}

// AddApplicationCloudWatchLoggingOption provides a mock function with given fields: ctx, params, optFns
func (_m *KinesisanalyticsClient) AddApplicationCloudWatchLoggingOption(ctx context.Context, params *kinesisanalytics.AddApplicationCloudWatchLoggingOptionInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.AddApplicationCloudWatchLoggingOptionOutput, error) {
...
func (_m *KinesisanalyticsClient) AddApplicationInput(ctx context.Context, params *kinesisanalytics.AddApplicationInputInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.AddApplicationInputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) AddApplicationInputProcessingConfiguration(ctx context.Context, params *kinesisanalytics.AddApplicationInputProcessingConfigurationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.AddApplicationInputProcessingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) AddApplicationOutput(ctx context.Context, params *kinesisanalytics.AddApplicationOutputInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.AddApplicationOutputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) AddApplicationReferenceDataSource(ctx context.Context, params *kinesisanalytics.AddApplicationReferenceDataSourceInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.AddApplicationReferenceDataSourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) CreateApplication(ctx context.Context, params *kinesisanalytics.CreateApplicationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.CreateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DeleteApplication(ctx context.Context, params *kinesisanalytics.DeleteApplicationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DeleteApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DeleteApplicationCloudWatchLoggingOption(ctx context.Context, params *kinesisanalytics.DeleteApplicationCloudWatchLoggingOptionInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DeleteApplicationCloudWatchLoggingOptionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DeleteApplicationInputProcessingConfiguration(ctx context.Context, params *kinesisanalytics.DeleteApplicationInputProcessingConfigurationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DeleteApplicationInputProcessingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DeleteApplicationOutput(ctx context.Context, params *kinesisanalytics.DeleteApplicationOutputInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DeleteApplicationOutputOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DeleteApplicationReferenceDataSource(ctx context.Context, params *kinesisanalytics.DeleteApplicationReferenceDataSourceInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DeleteApplicationReferenceDataSourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DescribeApplication(ctx context.Context, params *kinesisanalytics.DescribeApplicationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DescribeApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) DiscoverInputSchema(ctx context.Context, params *kinesisanalytics.DiscoverInputSchemaInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.DiscoverInputSchemaOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) ListApplications(ctx context.Context, params *kinesisanalytics.ListApplicationsInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) ListTagsForResource(ctx context.Context, params *kinesisanalytics.ListTagsForResourceInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) Options() kinesisanalytics.Options {
	ret := _m.Called()
...
func (_m *KinesisanalyticsClient) StartApplication(ctx context.Context, params *kinesisanalytics.StartApplicationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.StartApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) StopApplication(ctx context.Context, params *kinesisanalytics.StopApplicationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.StopApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) TagResource(ctx context.Context, params *kinesisanalytics.TagResourceInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) UntagResource(ctx context.Context, params *kinesisanalytics.UntagResourceInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *KinesisanalyticsClient) UpdateApplication(ctx context.Context, params *kinesisanalytics.UpdateApplicationInput, optFns ...func(*kinesisanalytics.Options)) (*kinesisanalytics.UpdateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewKinesisanalyticsClient creates a new instance of KinesisanalyticsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewKinesisanalyticsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *KinesisanalyticsClient {
	mock := &KinesisanalyticsClient{}
	mock.Mock.Test(t)
