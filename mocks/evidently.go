...
// EvidentlyClient is an autogenerated mock type for the EvidentlyClient type
type EvidentlyClient struct {
	mock.Mock
}

// BatchEvaluateFeature provides a mock function with given fields: ctx, params, optFns
func (_m *EvidentlyClient) BatchEvaluateFeature(ctx context.Context, params *evidently.BatchEvaluateFeatureInput, optFns ...func(*evidently.Options)) (*evidently.BatchEvaluateFeatureOutput, error) {
...
func (_m *EvidentlyClient) CreateExperiment(ctx context.Context, params *evidently.CreateExperimentInput, optFns ...func(*evidently.Options)) (*evidently.CreateExperimentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) CreateFeature(ctx context.Context, params *evidently.CreateFeatureInput, optFns ...func(*evidently.Options)) (*evidently.CreateFeatureOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) CreateLaunch(ctx context.Context, params *evidently.CreateLaunchInput, optFns ...func(*evidently.Options)) (*evidently.CreateLaunchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) CreateProject(ctx context.Context, params *evidently.CreateProjectInput, optFns ...func(*evidently.Options)) (*evidently.CreateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) CreateSegment(ctx context.Context, params *evidently.CreateSegmentInput, optFns ...func(*evidently.Options)) (*evidently.CreateSegmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) DeleteExperiment(ctx context.Context, params *evidently.DeleteExperimentInput, optFns ...func(*evidently.Options)) (*evidently.DeleteExperimentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) DeleteFeature(ctx context.Context, params *evidently.DeleteFeatureInput, optFns ...func(*evidently.Options)) (*evidently.DeleteFeatureOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) DeleteLaunch(ctx context.Context, params *evidently.DeleteLaunchInput, optFns ...func(*evidently.Options)) (*evidently.DeleteLaunchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) DeleteProject(ctx context.Context, params *evidently.DeleteProjectInput, optFns ...func(*evidently.Options)) (*evidently.DeleteProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) DeleteSegment(ctx context.Context, params *evidently.DeleteSegmentInput, optFns ...func(*evidently.Options)) (*evidently.DeleteSegmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) EvaluateFeature(ctx context.Context, params *evidently.EvaluateFeatureInput, optFns ...func(*evidently.Options)) (*evidently.EvaluateFeatureOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) GetExperiment(ctx context.Context, params *evidently.GetExperimentInput, optFns ...func(*evidently.Options)) (*evidently.GetExperimentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) GetExperimentResults(ctx context.Context, params *evidently.GetExperimentResultsInput, optFns ...func(*evidently.Options)) (*evidently.GetExperimentResultsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) GetFeature(ctx context.Context, params *evidently.GetFeatureInput, optFns ...func(*evidently.Options)) (*evidently.GetFeatureOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) GetLaunch(ctx context.Context, params *evidently.GetLaunchInput, optFns ...func(*evidently.Options)) (*evidently.GetLaunchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) GetProject(ctx context.Context, params *evidently.GetProjectInput, optFns ...func(*evidently.Options)) (*evidently.GetProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) GetSegment(ctx context.Context, params *evidently.GetSegmentInput, optFns ...func(*evidently.Options)) (*evidently.GetSegmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListExperiments(ctx context.Context, params *evidently.ListExperimentsInput, optFns ...func(*evidently.Options)) (*evidently.ListExperimentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListFeatures(ctx context.Context, params *evidently.ListFeaturesInput, optFns ...func(*evidently.Options)) (*evidently.ListFeaturesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListLaunches(ctx context.Context, params *evidently.ListLaunchesInput, optFns ...func(*evidently.Options)) (*evidently.ListLaunchesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListProjects(ctx context.Context, params *evidently.ListProjectsInput, optFns ...func(*evidently.Options)) (*evidently.ListProjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListSegmentReferences(ctx context.Context, params *evidently.ListSegmentReferencesInput, optFns ...func(*evidently.Options)) (*evidently.ListSegmentReferencesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListSegments(ctx context.Context, params *evidently.ListSegmentsInput, optFns ...func(*evidently.Options)) (*evidently.ListSegmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) ListTagsForResource(ctx context.Context, params *evidently.ListTagsForResourceInput, optFns ...func(*evidently.Options)) (*evidently.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) Options() evidently.Options {
	ret := _m.Called()
...
func (_m *EvidentlyClient) PutProjectEvents(ctx context.Context, params *evidently.PutProjectEventsInput, optFns ...func(*evidently.Options)) (*evidently.PutProjectEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) StartExperiment(ctx context.Context, params *evidently.StartExperimentInput, optFns ...func(*evidently.Options)) (*evidently.StartExperimentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) StartLaunch(ctx context.Context, params *evidently.StartLaunchInput, optFns ...func(*evidently.Options)) (*evidently.StartLaunchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) StopExperiment(ctx context.Context, params *evidently.StopExperimentInput, optFns ...func(*evidently.Options)) (*evidently.StopExperimentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) StopLaunch(ctx context.Context, params *evidently.StopLaunchInput, optFns ...func(*evidently.Options)) (*evidently.StopLaunchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) TagResource(ctx context.Context, params *evidently.TagResourceInput, optFns ...func(*evidently.Options)) (*evidently.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) TestSegmentPattern(ctx context.Context, params *evidently.TestSegmentPatternInput, optFns ...func(*evidently.Options)) (*evidently.TestSegmentPatternOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) UntagResource(ctx context.Context, params *evidently.UntagResourceInput, optFns ...func(*evidently.Options)) (*evidently.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) UpdateExperiment(ctx context.Context, params *evidently.UpdateExperimentInput, optFns ...func(*evidently.Options)) (*evidently.UpdateExperimentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) UpdateFeature(ctx context.Context, params *evidently.UpdateFeatureInput, optFns ...func(*evidently.Options)) (*evidently.UpdateFeatureOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) UpdateLaunch(ctx context.Context, params *evidently.UpdateLaunchInput, optFns ...func(*evidently.Options)) (*evidently.UpdateLaunchOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) UpdateProject(ctx context.Context, params *evidently.UpdateProjectInput, optFns ...func(*evidently.Options)) (*evidently.UpdateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *EvidentlyClient) UpdateProjectDataDelivery(ctx context.Context, params *evidently.UpdateProjectDataDeliveryInput, optFns ...func(*evidently.Options)) (*evidently.UpdateProjectDataDeliveryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewEvidentlyClient creates a new instance of EvidentlyClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewEvidentlyClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *EvidentlyClient {
	mock := &EvidentlyClient{}
	mock.Mock.Test(t)
