...
// PaymentcryptographydataClient is an autogenerated mock type for the PaymentcryptographydataClient type
type PaymentcryptographydataClient struct {
	mock.Mock
}

// DecryptData provides a mock function with given fields: ctx, params, optFns
func (_m *PaymentcryptographydataClient) DecryptData(ctx context.Context, params *paymentcryptographydata.DecryptDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.DecryptDataOutput, error) {
...
func (_m *PaymentcryptographydataClient) EncryptData(ctx context.Context, params *paymentcryptographydata.EncryptDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.EncryptDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) GenerateCardValidationData(ctx context.Context, params *paymentcryptographydata.GenerateCardValidationDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GenerateCardValidationDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) GenerateMac(ctx context.Context, params *paymentcryptographydata.GenerateMacInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GenerateMacOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) GeneratePinData(ctx context.Context, params *paymentcryptographydata.GeneratePinDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.GeneratePinDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) Options() paymentcryptographydata.Options {
	ret := _m.Called()
...
func (_m *PaymentcryptographydataClient) ReEncryptData(ctx context.Context, params *paymentcryptographydata.ReEncryptDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.ReEncryptDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) TranslatePinData(ctx context.Context, params *paymentcryptographydata.TranslatePinDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.TranslatePinDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) VerifyAuthRequestCryptogram(ctx context.Context, params *paymentcryptographydata.VerifyAuthRequestCryptogramInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.VerifyAuthRequestCryptogramOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) VerifyCardValidationData(ctx context.Context, params *paymentcryptographydata.VerifyCardValidationDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.VerifyCardValidationDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) VerifyMac(ctx context.Context, params *paymentcryptographydata.VerifyMacInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.VerifyMacOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *PaymentcryptographydataClient) VerifyPinData(ctx context.Context, params *paymentcryptographydata.VerifyPinDataInput, optFns ...func(*paymentcryptographydata.Options)) (*paymentcryptographydata.VerifyPinDataOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewPaymentcryptographydataClient creates a new instance of PaymentcryptographydataClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPaymentcryptographydataClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *PaymentcryptographydataClient {
	mock := &PaymentcryptographydataClient{}
	mock.Mock.Test(t)
