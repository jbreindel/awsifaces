...
// M2Client is an autogenerated mock type for the M2Client type
type M2Client struct {
	mock.Mock
}

// CancelBatchJobExecution provides a mock function with given fields: ctx, params, optFns
func (_m *M2Client) CancelBatchJobExecution(ctx context.Context, params *m2.CancelBatchJobExecutionInput, optFns ...func(*m2.Options)) (*m2.CancelBatchJobExecutionOutput, error) {
...
func (_m *M2Client) CreateApplication(ctx context.Context, params *m2.CreateApplicationInput, optFns ...func(*m2.Options)) (*m2.CreateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) CreateDataSetImportTask(ctx context.Context, params *m2.CreateDataSetImportTaskInput, optFns ...func(*m2.Options)) (*m2.CreateDataSetImportTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) CreateDeployment(ctx context.Context, params *m2.CreateDeploymentInput, optFns ...func(*m2.Options)) (*m2.CreateDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) CreateEnvironment(ctx context.Context, params *m2.CreateEnvironmentInput, optFns ...func(*m2.Options)) (*m2.CreateEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) DeleteApplication(ctx context.Context, params *m2.DeleteApplicationInput, optFns ...func(*m2.Options)) (*m2.DeleteApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) DeleteApplicationFromEnvironment(ctx context.Context, params *m2.DeleteApplicationFromEnvironmentInput, optFns ...func(*m2.Options)) (*m2.DeleteApplicationFromEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) DeleteEnvironment(ctx context.Context, params *m2.DeleteEnvironmentInput, optFns ...func(*m2.Options)) (*m2.DeleteEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetApplication(ctx context.Context, params *m2.GetApplicationInput, optFns ...func(*m2.Options)) (*m2.GetApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetApplicationVersion(ctx context.Context, params *m2.GetApplicationVersionInput, optFns ...func(*m2.Options)) (*m2.GetApplicationVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetBatchJobExecution(ctx context.Context, params *m2.GetBatchJobExecutionInput, optFns ...func(*m2.Options)) (*m2.GetBatchJobExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetDataSetDetails(ctx context.Context, params *m2.GetDataSetDetailsInput, optFns ...func(*m2.Options)) (*m2.GetDataSetDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetDataSetImportTask(ctx context.Context, params *m2.GetDataSetImportTaskInput, optFns ...func(*m2.Options)) (*m2.GetDataSetImportTaskOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetDeployment(ctx context.Context, params *m2.GetDeploymentInput, optFns ...func(*m2.Options)) (*m2.GetDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetEnvironment(ctx context.Context, params *m2.GetEnvironmentInput, optFns ...func(*m2.Options)) (*m2.GetEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) GetSignedBluinsightsUrl(ctx context.Context, params *m2.GetSignedBluinsightsUrlInput, optFns ...func(*m2.Options)) (*m2.GetSignedBluinsightsUrlOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListApplicationVersions(ctx context.Context, params *m2.ListApplicationVersionsInput, optFns ...func(*m2.Options)) (*m2.ListApplicationVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListApplications(ctx context.Context, params *m2.ListApplicationsInput, optFns ...func(*m2.Options)) (*m2.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListBatchJobDefinitions(ctx context.Context, params *m2.ListBatchJobDefinitionsInput, optFns ...func(*m2.Options)) (*m2.ListBatchJobDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListBatchJobExecutions(ctx context.Context, params *m2.ListBatchJobExecutionsInput, optFns ...func(*m2.Options)) (*m2.ListBatchJobExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListDataSetImportHistory(ctx context.Context, params *m2.ListDataSetImportHistoryInput, optFns ...func(*m2.Options)) (*m2.ListDataSetImportHistoryOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListDataSets(ctx context.Context, params *m2.ListDataSetsInput, optFns ...func(*m2.Options)) (*m2.ListDataSetsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListDeployments(ctx context.Context, params *m2.ListDeploymentsInput, optFns ...func(*m2.Options)) (*m2.ListDeploymentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListEngineVersions(ctx context.Context, params *m2.ListEngineVersionsInput, optFns ...func(*m2.Options)) (*m2.ListEngineVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListEnvironments(ctx context.Context, params *m2.ListEnvironmentsInput, optFns ...func(*m2.Options)) (*m2.ListEnvironmentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) ListTagsForResource(ctx context.Context, params *m2.ListTagsForResourceInput, optFns ...func(*m2.Options)) (*m2.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) Options() m2.Options {
	ret := _m.Called()
...
func (_m *M2Client) StartApplication(ctx context.Context, params *m2.StartApplicationInput, optFns ...func(*m2.Options)) (*m2.StartApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) StartBatchJob(ctx context.Context, params *m2.StartBatchJobInput, optFns ...func(*m2.Options)) (*m2.StartBatchJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) StopApplication(ctx context.Context, params *m2.StopApplicationInput, optFns ...func(*m2.Options)) (*m2.StopApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) TagResource(ctx context.Context, params *m2.TagResourceInput, optFns ...func(*m2.Options)) (*m2.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) UntagResource(ctx context.Context, params *m2.UntagResourceInput, optFns ...func(*m2.Options)) (*m2.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) UpdateApplication(ctx context.Context, params *m2.UpdateApplicationInput, optFns ...func(*m2.Options)) (*m2.UpdateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *M2Client) UpdateEnvironment(ctx context.Context, params *m2.UpdateEnvironmentInput, optFns ...func(*m2.Options)) (*m2.UpdateEnvironmentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewM2Client creates a new instance of M2Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewM2Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *M2Client {
	mock := &M2Client{}
