...
func (_m *ElasticacheClient) AddTagsToResource(ctx context.Context, params *elasticache.AddTagsToResourceInput, optFns ...func(*elasticache.Options)) (*elasticache.AddTagsToResourceOutput, error) {
...
func (_m *ElasticacheClient) AuthorizeCacheSecurityGroupIngress(ctx context.Context, params *elasticache.AuthorizeCacheSecurityGroupIngressInput, optFns ...func(*elasticache.Options)) (*elasticache.AuthorizeCacheSecurityGroupIngressOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) BatchApplyUpdateAction(ctx context.Context, params *elasticache.BatchApplyUpdateActionInput, optFns ...func(*elasticache.Options)) (*elasticache.BatchApplyUpdateActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) BatchStopUpdateAction(ctx context.Context, params *elasticache.BatchStopUpdateActionInput, optFns ...func(*elasticache.Options)) (*elasticache.BatchStopUpdateActionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CompleteMigration(ctx context.Context, params *elasticache.CompleteMigrationInput, optFns ...func(*elasticache.Options)) (*elasticache.CompleteMigrationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CopyServerlessCacheSnapshot(ctx context.Context, params *elasticache.CopyServerlessCacheSnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.CopyServerlessCacheSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CopySnapshot(ctx context.Context, params *elasticache.CopySnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.CopySnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateCacheCluster(ctx context.Context, params *elasticache.CreateCacheClusterInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateCacheClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateCacheParameterGroup(ctx context.Context, params *elasticache.CreateCacheParameterGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateCacheParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateCacheSecurityGroup(ctx context.Context, params *elasticache.CreateCacheSecurityGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateCacheSecurityGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateCacheSubnetGroup(ctx context.Context, params *elasticache.CreateCacheSubnetGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateCacheSubnetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateGlobalReplicationGroup(ctx context.Context, params *elasticache.CreateGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateReplicationGroup(ctx context.Context, params *elasticache.CreateReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateServerlessCache(ctx context.Context, params *elasticache.CreateServerlessCacheInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateServerlessCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateServerlessCacheSnapshot(ctx context.Context, params *elasticache.CreateServerlessCacheSnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateServerlessCacheSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateSnapshot(ctx context.Context, params *elasticache.CreateSnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateUser(ctx context.Context, params *elasticache.CreateUserInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) CreateUserGroup(ctx context.Context, params *elasticache.CreateUserGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.CreateUserGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DecreaseNodeGroupsInGlobalReplicationGroup(ctx context.Context, params *elasticache.DecreaseNodeGroupsInGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DecreaseNodeGroupsInGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DecreaseReplicaCount(ctx context.Context, params *elasticache.DecreaseReplicaCountInput, optFns ...func(*elasticache.Options)) (*elasticache.DecreaseReplicaCountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteCacheCluster(ctx context.Context, params *elasticache.DeleteCacheClusterInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteCacheClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteCacheParameterGroup(ctx context.Context, params *elasticache.DeleteCacheParameterGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteCacheParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteCacheSecurityGroup(ctx context.Context, params *elasticache.DeleteCacheSecurityGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteCacheSecurityGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteCacheSubnetGroup(ctx context.Context, params *elasticache.DeleteCacheSubnetGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteCacheSubnetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteGlobalReplicationGroup(ctx context.Context, params *elasticache.DeleteGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteReplicationGroup(ctx context.Context, params *elasticache.DeleteReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteServerlessCache(ctx context.Context, params *elasticache.DeleteServerlessCacheInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteServerlessCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteServerlessCacheSnapshot(ctx context.Context, params *elasticache.DeleteServerlessCacheSnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteServerlessCacheSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteSnapshot(ctx context.Context, params *elasticache.DeleteSnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteUser(ctx context.Context, params *elasticache.DeleteUserInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DeleteUserGroup(ctx context.Context, params *elasticache.DeleteUserGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DeleteUserGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeCacheEngineVersions(ctx context.Context, params *elasticache.DescribeCacheEngineVersionsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeCacheEngineVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeCacheParameterGroups(ctx context.Context, params *elasticache.DescribeCacheParameterGroupsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeCacheParameterGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeCacheParameters(ctx context.Context, params *elasticache.DescribeCacheParametersInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeCacheParametersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeCacheSecurityGroups(ctx context.Context, params *elasticache.DescribeCacheSecurityGroupsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeCacheSecurityGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeCacheSubnetGroups(ctx context.Context, params *elasticache.DescribeCacheSubnetGroupsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeCacheSubnetGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeEngineDefaultParameters(ctx context.Context, params *elasticache.DescribeEngineDefaultParametersInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeEngineDefaultParametersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeEvents(ctx context.Context, params *elasticache.DescribeEventsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeGlobalReplicationGroups(ctx context.Context, params *elasticache.DescribeGlobalReplicationGroupsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeGlobalReplicationGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeReplicationGroups(ctx context.Context, params *elasticache.DescribeReplicationGroupsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeReplicationGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeReservedCacheNodes(ctx context.Context, params *elasticache.DescribeReservedCacheNodesInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeReservedCacheNodesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeReservedCacheNodesOfferings(ctx context.Context, params *elasticache.DescribeReservedCacheNodesOfferingsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeReservedCacheNodesOfferingsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeServerlessCacheSnapshots(ctx context.Context, params *elasticache.DescribeServerlessCacheSnapshotsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeServerlessCacheSnapshotsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeServerlessCaches(ctx context.Context, params *elasticache.DescribeServerlessCachesInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeServerlessCachesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeServiceUpdates(ctx context.Context, params *elasticache.DescribeServiceUpdatesInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeServiceUpdatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeSnapshots(ctx context.Context, params *elasticache.DescribeSnapshotsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeSnapshotsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeUpdateActions(ctx context.Context, params *elasticache.DescribeUpdateActionsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeUpdateActionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeUserGroups(ctx context.Context, params *elasticache.DescribeUserGroupsInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeUserGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DescribeUsers(ctx context.Context, params *elasticache.DescribeUsersInput, optFns ...func(*elasticache.Options)) (*elasticache.DescribeUsersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) DisassociateGlobalReplicationGroup(ctx context.Context, params *elasticache.DisassociateGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.DisassociateGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ExportServerlessCacheSnapshot(ctx context.Context, params *elasticache.ExportServerlessCacheSnapshotInput, optFns ...func(*elasticache.Options)) (*elasticache.ExportServerlessCacheSnapshotOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) FailoverGlobalReplicationGroup(ctx context.Context, params *elasticache.FailoverGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.FailoverGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) IncreaseNodeGroupsInGlobalReplicationGroup(ctx context.Context, params *elasticache.IncreaseNodeGroupsInGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.IncreaseNodeGroupsInGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) IncreaseReplicaCount(ctx context.Context, params *elasticache.IncreaseReplicaCountInput, optFns ...func(*elasticache.Options)) (*elasticache.IncreaseReplicaCountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ListAllowedNodeTypeModifications(ctx context.Context, params *elasticache.ListAllowedNodeTypeModificationsInput, optFns ...func(*elasticache.Options)) (*elasticache.ListAllowedNodeTypeModificationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ListTagsForResource(ctx context.Context, params *elasticache.ListTagsForResourceInput, optFns ...func(*elasticache.Options)) (*elasticache.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyCacheCluster(ctx context.Context, params *elasticache.ModifyCacheClusterInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyCacheClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyCacheParameterGroup(ctx context.Context, params *elasticache.ModifyCacheParameterGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyCacheParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyCacheSubnetGroup(ctx context.Context, params *elasticache.ModifyCacheSubnetGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyCacheSubnetGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyGlobalReplicationGroup(ctx context.Context, params *elasticache.ModifyGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyReplicationGroup(ctx context.Context, params *elasticache.ModifyReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyReplicationGroupShardConfiguration(ctx context.Context, params *elasticache.ModifyReplicationGroupShardConfigurationInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyReplicationGroupShardConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyServerlessCache(ctx context.Context, params *elasticache.ModifyServerlessCacheInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyServerlessCacheOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyUser(ctx context.Context, params *elasticache.ModifyUserInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ModifyUserGroup(ctx context.Context, params *elasticache.ModifyUserGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.ModifyUserGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) Options() elasticache.Options {
	ret := _m.Called()
...
func (_m *ElasticacheClient) PurchaseReservedCacheNodesOffering(ctx context.Context, params *elasticache.PurchaseReservedCacheNodesOfferingInput, optFns ...func(*elasticache.Options)) (*elasticache.PurchaseReservedCacheNodesOfferingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) RebalanceSlotsInGlobalReplicationGroup(ctx context.Context, params *elasticache.RebalanceSlotsInGlobalReplicationGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.RebalanceSlotsInGlobalReplicationGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) RebootCacheCluster(ctx context.Context, params *elasticache.RebootCacheClusterInput, optFns ...func(*elasticache.Options)) (*elasticache.RebootCacheClusterOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) RemoveTagsFromResource(ctx context.Context, params *elasticache.RemoveTagsFromResourceInput, optFns ...func(*elasticache.Options)) (*elasticache.RemoveTagsFromResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) ResetCacheParameterGroup(ctx context.Context, params *elasticache.ResetCacheParameterGroupInput, optFns ...func(*elasticache.Options)) (*elasticache.ResetCacheParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) RevokeCacheSecurityGroupIngress(ctx context.Context, params *elasticache.RevokeCacheSecurityGroupIngressInput, optFns ...func(*elasticache.Options)) (*elasticache.RevokeCacheSecurityGroupIngressOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) StartMigration(ctx context.Context, params *elasticache.StartMigrationInput, optFns ...func(*elasticache.Options)) (*elasticache.StartMigrationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) TestFailover(ctx context.Context, params *elasticache.TestFailoverInput, optFns ...func(*elasticache.Options)) (*elasticache.TestFailoverOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ElasticacheClient) TestMigration(ctx context.Context, params *elasticache.TestMigrationInput, optFns ...func(*elasticache.Options)) (*elasticache.TestMigrationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
