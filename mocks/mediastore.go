...
// MediastoreClient is an autogenerated mock type for the MediastoreClient type
type MediastoreClient struct {
	mock.Mock
}

// CreateContainer provides a mock function with given fields: ctx, params, optFns
func (_m *MediastoreClient) CreateContainer(ctx context.Context, params *mediastore.CreateContainerInput, optFns ...func(*mediastore.Options)) (*mediastore.CreateContainerOutput, error) {
...
func (_m *MediastoreClient) DeleteContainer(ctx context.Context, params *mediastore.DeleteContainerInput, optFns ...func(*mediastore.Options)) (*mediastore.DeleteContainerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) DeleteContainerPolicy(ctx context.Context, params *mediastore.DeleteContainerPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.DeleteContainerPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) DeleteCorsPolicy(ctx context.Context, params *mediastore.DeleteCorsPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.DeleteCorsPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) DeleteLifecyclePolicy(ctx context.Context, params *mediastore.DeleteLifecyclePolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.DeleteLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) DeleteMetricPolicy(ctx context.Context, params *mediastore.DeleteMetricPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.DeleteMetricPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) DescribeContainer(ctx context.Context, params *mediastore.DescribeContainerInput, optFns ...func(*mediastore.Options)) (*mediastore.DescribeContainerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) GetContainerPolicy(ctx context.Context, params *mediastore.GetContainerPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.GetContainerPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) GetCorsPolicy(ctx context.Context, params *mediastore.GetCorsPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.GetCorsPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) GetLifecyclePolicy(ctx context.Context, params *mediastore.GetLifecyclePolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.GetLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) GetMetricPolicy(ctx context.Context, params *mediastore.GetMetricPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.GetMetricPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) ListContainers(ctx context.Context, params *mediastore.ListContainersInput, optFns ...func(*mediastore.Options)) (*mediastore.ListContainersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) ListTagsForResource(ctx context.Context, params *mediastore.ListTagsForResourceInput, optFns ...func(*mediastore.Options)) (*mediastore.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) Options() mediastore.Options {
	ret := _m.Called()
...
func (_m *MediastoreClient) PutContainerPolicy(ctx context.Context, params *mediastore.PutContainerPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.PutContainerPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) PutCorsPolicy(ctx context.Context, params *mediastore.PutCorsPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.PutCorsPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) PutLifecyclePolicy(ctx context.Context, params *mediastore.PutLifecyclePolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.PutLifecyclePolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) PutMetricPolicy(ctx context.Context, params *mediastore.PutMetricPolicyInput, optFns ...func(*mediastore.Options)) (*mediastore.PutMetricPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) StartAccessLogging(ctx context.Context, params *mediastore.StartAccessLoggingInput, optFns ...func(*mediastore.Options)) (*mediastore.StartAccessLoggingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) StopAccessLogging(ctx context.Context, params *mediastore.StopAccessLoggingInput, optFns ...func(*mediastore.Options)) (*mediastore.StopAccessLoggingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) TagResource(ctx context.Context, params *mediastore.TagResourceInput, optFns ...func(*mediastore.Options)) (*mediastore.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MediastoreClient) UntagResource(ctx context.Context, params *mediastore.UntagResourceInput, optFns ...func(*mediastore.Options)) (*mediastore.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMediastoreClient creates a new instance of MediastoreClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMediastoreClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MediastoreClient {
	mock := &MediastoreClient{}
	mock.Mock.Test(t)
