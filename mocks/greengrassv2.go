...
// Greengrassv2Client is an autogenerated mock type for the Greengrassv2Client type
type Greengrassv2Client struct {
	mock.Mock
}

// AssociateServiceRoleToAccount provides a mock function with given fields: ctx, params, optFns
func (_m *Greengrassv2Client) AssociateServiceRoleToAccount(ctx context.Context, params *greengrassv2.AssociateServiceRoleToAccountInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.AssociateServiceRoleToAccountOutput, error) {
...
func (_m *Greengrassv2Client) BatchAssociateClientDeviceWithCoreDevice(ctx context.Context, params *greengrassv2.BatchAssociateClientDeviceWithCoreDeviceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.BatchAssociateClientDeviceWithCoreDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) BatchDisassociateClientDeviceFromCoreDevice(ctx context.Context, params *greengrassv2.BatchDisassociateClientDeviceFromCoreDeviceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.BatchDisassociateClientDeviceFromCoreDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) CancelDeployment(ctx context.Context, params *greengrassv2.CancelDeploymentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.CancelDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) CreateComponentVersion(ctx context.Context, params *greengrassv2.CreateComponentVersionInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.CreateComponentVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) CreateDeployment(ctx context.Context, params *greengrassv2.CreateDeploymentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.CreateDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) DeleteComponent(ctx context.Context, params *greengrassv2.DeleteComponentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.DeleteComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) DeleteCoreDevice(ctx context.Context, params *greengrassv2.DeleteCoreDeviceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.DeleteCoreDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) DeleteDeployment(ctx context.Context, params *greengrassv2.DeleteDeploymentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.DeleteDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) DescribeComponent(ctx context.Context, params *greengrassv2.DescribeComponentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.DescribeComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) DisassociateServiceRoleFromAccount(ctx context.Context, params *greengrassv2.DisassociateServiceRoleFromAccountInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.DisassociateServiceRoleFromAccountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) GetComponent(ctx context.Context, params *greengrassv2.GetComponentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.GetComponentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) GetComponentVersionArtifact(ctx context.Context, params *greengrassv2.GetComponentVersionArtifactInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.GetComponentVersionArtifactOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) GetConnectivityInfo(ctx context.Context, params *greengrassv2.GetConnectivityInfoInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.GetConnectivityInfoOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) GetCoreDevice(ctx context.Context, params *greengrassv2.GetCoreDeviceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.GetCoreDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) GetDeployment(ctx context.Context, params *greengrassv2.GetDeploymentInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.GetDeploymentOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) GetServiceRoleForAccount(ctx context.Context, params *greengrassv2.GetServiceRoleForAccountInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.GetServiceRoleForAccountOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListClientDevicesAssociatedWithCoreDevice(ctx context.Context, params *greengrassv2.ListClientDevicesAssociatedWithCoreDeviceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListClientDevicesAssociatedWithCoreDeviceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListComponentVersions(ctx context.Context, params *greengrassv2.ListComponentVersionsInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListComponentVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListComponents(ctx context.Context, params *greengrassv2.ListComponentsInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListComponentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListCoreDevices(ctx context.Context, params *greengrassv2.ListCoreDevicesInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListCoreDevicesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListDeployments(ctx context.Context, params *greengrassv2.ListDeploymentsInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListDeploymentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListEffectiveDeployments(ctx context.Context, params *greengrassv2.ListEffectiveDeploymentsInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListEffectiveDeploymentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListInstalledComponents(ctx context.Context, params *greengrassv2.ListInstalledComponentsInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListInstalledComponentsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) ListTagsForResource(ctx context.Context, params *greengrassv2.ListTagsForResourceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) Options() greengrassv2.Options {
	ret := _m.Called()
...
func (_m *Greengrassv2Client) ResolveComponentCandidates(ctx context.Context, params *greengrassv2.ResolveComponentCandidatesInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.ResolveComponentCandidatesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) TagResource(ctx context.Context, params *greengrassv2.TagResourceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) UntagResource(ctx context.Context, params *greengrassv2.UntagResourceInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *Greengrassv2Client) UpdateConnectivityInfo(ctx context.Context, params *greengrassv2.UpdateConnectivityInfoInput, optFns ...func(*greengrassv2.Options)) (*greengrassv2.UpdateConnectivityInfoOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewGreengrassv2Client creates a new instance of Greengrassv2Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewGreengrassv2Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *Greengrassv2Client {
	mock := &Greengrassv2Client{}
	mock.Mock.Test(t)
