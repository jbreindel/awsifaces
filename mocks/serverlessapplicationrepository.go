...
// ServerlessapplicationrepositoryClient is an autogenerated mock type for the ServerlessapplicationrepositoryClient type
type ServerlessapplicationrepositoryClient struct {
	mock.Mock
}

// CreateApplication provides a mock function with given fields: ctx, params, optFns
func (_m *ServerlessapplicationrepositoryClient) CreateApplication(ctx context.Context, params *serverlessapplicationrepository.CreateApplicationInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.CreateApplicationOutput, error) {
...
func (_m *ServerlessapplicationrepositoryClient) CreateApplicationVersion(ctx context.Context, params *serverlessapplicationrepository.CreateApplicationVersionInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.CreateApplicationVersionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) CreateCloudFormationChangeSet(ctx context.Context, params *serverlessapplicationrepository.CreateCloudFormationChangeSetInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.CreateCloudFormationChangeSetOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) CreateCloudFormationTemplate(ctx context.Context, params *serverlessapplicationrepository.CreateCloudFormationTemplateInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.CreateCloudFormationTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) DeleteApplication(ctx context.Context, params *serverlessapplicationrepository.DeleteApplicationInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.DeleteApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) GetApplication(ctx context.Context, params *serverlessapplicationrepository.GetApplicationInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.GetApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) GetApplicationPolicy(ctx context.Context, params *serverlessapplicationrepository.GetApplicationPolicyInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.GetApplicationPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) GetCloudFormationTemplate(ctx context.Context, params *serverlessapplicationrepository.GetCloudFormationTemplateInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.GetCloudFormationTemplateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) ListApplicationDependencies(ctx context.Context, params *serverlessapplicationrepository.ListApplicationDependenciesInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.ListApplicationDependenciesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) ListApplicationVersions(ctx context.Context, params *serverlessapplicationrepository.ListApplicationVersionsInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.ListApplicationVersionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) ListApplications(ctx context.Context, params *serverlessapplicationrepository.ListApplicationsInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.ListApplicationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) Options() serverlessapplicationrepository.Options {
	ret := _m.Called()
...
func (_m *ServerlessapplicationrepositoryClient) PutApplicationPolicy(ctx context.Context, params *serverlessapplicationrepository.PutApplicationPolicyInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.PutApplicationPolicyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) UnshareApplication(ctx context.Context, params *serverlessapplicationrepository.UnshareApplicationInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.UnshareApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *ServerlessapplicationrepositoryClient) UpdateApplication(ctx context.Context, params *serverlessapplicationrepository.UpdateApplicationInput, optFns ...func(*serverlessapplicationrepository.Options)) (*serverlessapplicationrepository.UpdateApplicationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewServerlessapplicationrepositoryClient creates a new instance of ServerlessapplicationrepositoryClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewServerlessapplicationrepositoryClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *ServerlessapplicationrepositoryClient {
	mock := &ServerlessapplicationrepositoryClient{}
	mock.Mock.Test(t)
