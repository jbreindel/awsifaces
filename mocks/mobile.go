...
// MobileClient is an autogenerated mock type for the MobileClient type
type MobileClient struct {
	mock.Mock
}

// CreateProject provides a mock function with given fields: ctx, params, optFns
func (_m *MobileClient) CreateProject(ctx context.Context, params *mobile.CreateProjectInput, optFns ...func(*mobile.Options)) (*mobile.CreateProjectOutput, error) {
...
func (_m *MobileClient) DeleteProject(ctx context.Context, params *mobile.DeleteProjectInput, optFns ...func(*mobile.Options)) (*mobile.DeleteProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) DescribeBundle(ctx context.Context, params *mobile.DescribeBundleInput, optFns ...func(*mobile.Options)) (*mobile.DescribeBundleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) DescribeProject(ctx context.Context, params *mobile.DescribeProjectInput, optFns ...func(*mobile.Options)) (*mobile.DescribeProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) ExportBundle(ctx context.Context, params *mobile.ExportBundleInput, optFns ...func(*mobile.Options)) (*mobile.ExportBundleOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) ExportProject(ctx context.Context, params *mobile.ExportProjectInput, optFns ...func(*mobile.Options)) (*mobile.ExportProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) ListBundles(ctx context.Context, params *mobile.ListBundlesInput, optFns ...func(*mobile.Options)) (*mobile.ListBundlesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) ListProjects(ctx context.Context, params *mobile.ListProjectsInput, optFns ...func(*mobile.Options)) (*mobile.ListProjectsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *MobileClient) Options() mobile.Options {
	ret := _m.Called()
...
func (_m *MobileClient) UpdateProject(ctx context.Context, params *mobile.UpdateProjectInput, optFns ...func(*mobile.Options)) (*mobile.UpdateProjectOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewMobileClient creates a new instance of MobileClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMobileClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MobileClient {
	mock := &MobileClient{}
