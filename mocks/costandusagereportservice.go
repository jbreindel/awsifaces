...
// CostandusagereportserviceClient is an autogenerated mock type for the CostandusagereportserviceClient type
type CostandusagereportserviceClient struct {
	mock.Mock
}

// DeleteReportDefinition provides a mock function with given fields: ctx, params, optFns
func (_m *CostandusagereportserviceClient) DeleteReportDefinition(ctx context.Context, params *costandusagereportservice.DeleteReportDefinitionInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.DeleteReportDefinitionOutput, error) {
...
func (_m *CostandusagereportserviceClient) DescribeReportDefinitions(ctx context.Context, params *costandusagereportservice.DescribeReportDefinitionsInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.DescribeReportDefinitionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostandusagereportserviceClient) ListTagsForResource(ctx context.Context, params *costandusagereportservice.ListTagsForResourceInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostandusagereportserviceClient) ModifyReportDefinition(ctx context.Context, params *costandusagereportservice.ModifyReportDefinitionInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.ModifyReportDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostandusagereportserviceClient) Options() costandusagereportservice.Options {
	ret := _m.Called()
...
func (_m *CostandusagereportserviceClient) PutReportDefinition(ctx context.Context, params *costandusagereportservice.PutReportDefinitionInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.PutReportDefinitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostandusagereportserviceClient) TagResource(ctx context.Context, params *costandusagereportservice.TagResourceInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CostandusagereportserviceClient) UntagResource(ctx context.Context, params *costandusagereportservice.UntagResourceInput, optFns ...func(*costandusagereportservice.Options)) (*costandusagereportservice.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCostandusagereportserviceClient creates a new instance of CostandusagereportserviceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCostandusagereportserviceClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CostandusagereportserviceClient {
	mock := &CostandusagereportserviceClient{}
	mock.Mock.Test(t)
