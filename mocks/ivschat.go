...
// IvschatClient is an autogenerated mock type for the IvschatClient type
type IvschatClient struct {
	mock.Mock
}

// CreateChatToken provides a mock function with given fields: ctx, params, optFns
func (_m *IvschatClient) CreateChatToken(ctx context.Context, params *ivschat.CreateChatTokenInput, optFns ...func(*ivschat.Options)) (*ivschat.CreateChatTokenOutput, error) {
...
func (_m *IvschatClient) CreateLoggingConfiguration(ctx context.Context, params *ivschat.CreateLoggingConfigurationInput, optFns ...func(*ivschat.Options)) (*ivschat.CreateLoggingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) CreateRoom(ctx context.Context, params *ivschat.CreateRoomInput, optFns ...func(*ivschat.Options)) (*ivschat.CreateRoomOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) DeleteLoggingConfiguration(ctx context.Context, params *ivschat.DeleteLoggingConfigurationInput, optFns ...func(*ivschat.Options)) (*ivschat.DeleteLoggingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) DeleteMessage(ctx context.Context, params *ivschat.DeleteMessageInput, optFns ...func(*ivschat.Options)) (*ivschat.DeleteMessageOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) DeleteRoom(ctx context.Context, params *ivschat.DeleteRoomInput, optFns ...func(*ivschat.Options)) (*ivschat.DeleteRoomOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) DisconnectUser(ctx context.Context, params *ivschat.DisconnectUserInput, optFns ...func(*ivschat.Options)) (*ivschat.DisconnectUserOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) GetLoggingConfiguration(ctx context.Context, params *ivschat.GetLoggingConfigurationInput, optFns ...func(*ivschat.Options)) (*ivschat.GetLoggingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) GetRoom(ctx context.Context, params *ivschat.GetRoomInput, optFns ...func(*ivschat.Options)) (*ivschat.GetRoomOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) ListLoggingConfigurations(ctx context.Context, params *ivschat.ListLoggingConfigurationsInput, optFns ...func(*ivschat.Options)) (*ivschat.ListLoggingConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) ListRooms(ctx context.Context, params *ivschat.ListRoomsInput, optFns ...func(*ivschat.Options)) (*ivschat.ListRoomsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) ListTagsForResource(ctx context.Context, params *ivschat.ListTagsForResourceInput, optFns ...func(*ivschat.Options)) (*ivschat.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) Options() ivschat.Options {
	ret := _m.Called()
...
func (_m *IvschatClient) SendEvent(ctx context.Context, params *ivschat.SendEventInput, optFns ...func(*ivschat.Options)) (*ivschat.SendEventOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) TagResource(ctx context.Context, params *ivschat.TagResourceInput, optFns ...func(*ivschat.Options)) (*ivschat.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) UntagResource(ctx context.Context, params *ivschat.UntagResourceInput, optFns ...func(*ivschat.Options)) (*ivschat.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) UpdateLoggingConfiguration(ctx context.Context, params *ivschat.UpdateLoggingConfigurationInput, optFns ...func(*ivschat.Options)) (*ivschat.UpdateLoggingConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *IvschatClient) UpdateRoom(ctx context.Context, params *ivschat.UpdateRoomInput, optFns ...func(*ivschat.Options)) (*ivschat.UpdateRoomOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewIvschatClient creates a new instance of IvschatClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIvschatClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *IvschatClient {
	mock := &IvschatClient{}
