...
// SupportappClient is an autogenerated mock type for the SupportappClient type
type SupportappClient struct {
	mock.Mock
}

// CreateSlackChannelConfiguration provides a mock function with given fields: ctx, params, optFns
func (_m *SupportappClient) CreateSlackChannelConfiguration(ctx context.Context, params *supportapp.CreateSlackChannelConfigurationInput, optFns ...func(*supportapp.Options)) (*supportapp.CreateSlackChannelConfigurationOutput, error) {
...
func (_m *SupportappClient) DeleteAccountAlias(ctx context.Context, params *supportapp.DeleteAccountAliasInput, optFns ...func(*supportapp.Options)) (*supportapp.DeleteAccountAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) DeleteSlackChannelConfiguration(ctx context.Context, params *supportapp.DeleteSlackChannelConfigurationInput, optFns ...func(*supportapp.Options)) (*supportapp.DeleteSlackChannelConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) DeleteSlackWorkspaceConfiguration(ctx context.Context, params *supportapp.DeleteSlackWorkspaceConfigurationInput, optFns ...func(*supportapp.Options)) (*supportapp.DeleteSlackWorkspaceConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) GetAccountAlias(ctx context.Context, params *supportapp.GetAccountAliasInput, optFns ...func(*supportapp.Options)) (*supportapp.GetAccountAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) ListSlackChannelConfigurations(ctx context.Context, params *supportapp.ListSlackChannelConfigurationsInput, optFns ...func(*supportapp.Options)) (*supportapp.ListSlackChannelConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) ListSlackWorkspaceConfigurations(ctx context.Context, params *supportapp.ListSlackWorkspaceConfigurationsInput, optFns ...func(*supportapp.Options)) (*supportapp.ListSlackWorkspaceConfigurationsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) Options() supportapp.Options {
	ret := _m.Called()
...
func (_m *SupportappClient) PutAccountAlias(ctx context.Context, params *supportapp.PutAccountAliasInput, optFns ...func(*supportapp.Options)) (*supportapp.PutAccountAliasOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) RegisterSlackWorkspaceForOrganization(ctx context.Context, params *supportapp.RegisterSlackWorkspaceForOrganizationInput, optFns ...func(*supportapp.Options)) (*supportapp.RegisterSlackWorkspaceForOrganizationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *SupportappClient) UpdateSlackChannelConfiguration(ctx context.Context, params *supportapp.UpdateSlackChannelConfigurationInput, optFns ...func(*supportapp.Options)) (*supportapp.UpdateSlackChannelConfigurationOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewSupportappClient creates a new instance of SupportappClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSupportappClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *SupportappClient {
	mock := &SupportappClient{}
	mock.Mock.Test(t)
