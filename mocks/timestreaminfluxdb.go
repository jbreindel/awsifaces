...
// TimestreaminfluxdbClient is an autogenerated mock type for the TimestreaminfluxdbClient type
type TimestreaminfluxdbClient struct {
	mock.Mock
}

// CreateDbInstance provides a mock function with given fields: ctx, params, optFns
func (_m *TimestreaminfluxdbClient) CreateDbInstance(ctx context.Context, params *timestreaminfluxdb.CreateDbInstanceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.CreateDbInstanceOutput, error) {
...
func (_m *TimestreaminfluxdbClient) CreateDbParameterGroup(ctx context.Context, params *timestreaminfluxdb.CreateDbParameterGroupInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.CreateDbParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) DeleteDbInstance(ctx context.Context, params *timestreaminfluxdb.DeleteDbInstanceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.DeleteDbInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) GetDbInstance(ctx context.Context, params *timestreaminfluxdb.GetDbInstanceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.GetDbInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) GetDbParameterGroup(ctx context.Context, params *timestreaminfluxdb.GetDbParameterGroupInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.GetDbParameterGroupOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) ListDbInstances(ctx context.Context, params *timestreaminfluxdb.ListDbInstancesInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.ListDbInstancesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) ListDbParameterGroups(ctx context.Context, params *timestreaminfluxdb.ListDbParameterGroupsInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.ListDbParameterGroupsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) ListTagsForResource(ctx context.Context, params *timestreaminfluxdb.ListTagsForResourceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) Options() timestreaminfluxdb.Options {
	ret := _m.Called()
...
func (_m *TimestreaminfluxdbClient) TagResource(ctx context.Context, params *timestreaminfluxdb.TagResourceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) UntagResource(ctx context.Context, params *timestreaminfluxdb.UntagResourceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *TimestreaminfluxdbClient) UpdateDbInstance(ctx context.Context, params *timestreaminfluxdb.UpdateDbInstanceInput, optFns ...func(*timestreaminfluxdb.Options)) (*timestreaminfluxdb.UpdateDbInstanceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewTimestreaminfluxdbClient creates a new instance of TimestreaminfluxdbClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTimestreaminfluxdbClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *TimestreaminfluxdbClient {
	mock := &TimestreaminfluxdbClient{}
	mock.Mock.Test(t)
