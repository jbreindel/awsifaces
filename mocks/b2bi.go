...
// B2biClient is an autogenerated mock type for the B2biClient type
type B2biClient struct {
	mock.Mock
}

// CreateCapability provides a mock function with given fields: ctx, params, optFns
func (_m *B2biClient) CreateCapability(ctx context.Context, params *b2bi.CreateCapabilityInput, optFns ...func(*b2bi.Options)) (*b2bi.CreateCapabilityOutput, error) {
...
func (_m *B2biClient) CreatePartnership(ctx context.Context, params *b2bi.CreatePartnershipInput, optFns ...func(*b2bi.Options)) (*b2bi.CreatePartnershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) CreateProfile(ctx context.Context, params *b2bi.CreateProfileInput, optFns ...func(*b2bi.Options)) (*b2bi.CreateProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) CreateTransformer(ctx context.Context, params *b2bi.CreateTransformerInput, optFns ...func(*b2bi.Options)) (*b2bi.CreateTransformerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) DeleteCapability(ctx context.Context, params *b2bi.DeleteCapabilityInput, optFns ...func(*b2bi.Options)) (*b2bi.DeleteCapabilityOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) DeletePartnership(ctx context.Context, params *b2bi.DeletePartnershipInput, optFns ...func(*b2bi.Options)) (*b2bi.DeletePartnershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) DeleteProfile(ctx context.Context, params *b2bi.DeleteProfileInput, optFns ...func(*b2bi.Options)) (*b2bi.DeleteProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) DeleteTransformer(ctx context.Context, params *b2bi.DeleteTransformerInput, optFns ...func(*b2bi.Options)) (*b2bi.DeleteTransformerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) GetCapability(ctx context.Context, params *b2bi.GetCapabilityInput, optFns ...func(*b2bi.Options)) (*b2bi.GetCapabilityOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) GetPartnership(ctx context.Context, params *b2bi.GetPartnershipInput, optFns ...func(*b2bi.Options)) (*b2bi.GetPartnershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) GetProfile(ctx context.Context, params *b2bi.GetProfileInput, optFns ...func(*b2bi.Options)) (*b2bi.GetProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) GetTransformer(ctx context.Context, params *b2bi.GetTransformerInput, optFns ...func(*b2bi.Options)) (*b2bi.GetTransformerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) GetTransformerJob(ctx context.Context, params *b2bi.GetTransformerJobInput, optFns ...func(*b2bi.Options)) (*b2bi.GetTransformerJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) ListCapabilities(ctx context.Context, params *b2bi.ListCapabilitiesInput, optFns ...func(*b2bi.Options)) (*b2bi.ListCapabilitiesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) ListPartnerships(ctx context.Context, params *b2bi.ListPartnershipsInput, optFns ...func(*b2bi.Options)) (*b2bi.ListPartnershipsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) ListProfiles(ctx context.Context, params *b2bi.ListProfilesInput, optFns ...func(*b2bi.Options)) (*b2bi.ListProfilesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) ListTagsForResource(ctx context.Context, params *b2bi.ListTagsForResourceInput, optFns ...func(*b2bi.Options)) (*b2bi.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) ListTransformers(ctx context.Context, params *b2bi.ListTransformersInput, optFns ...func(*b2bi.Options)) (*b2bi.ListTransformersOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) Options() b2bi.Options {
	ret := _m.Called()
...
func (_m *B2biClient) StartTransformerJob(ctx context.Context, params *b2bi.StartTransformerJobInput, optFns ...func(*b2bi.Options)) (*b2bi.StartTransformerJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) TagResource(ctx context.Context, params *b2bi.TagResourceInput, optFns ...func(*b2bi.Options)) (*b2bi.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) TestMapping(ctx context.Context, params *b2bi.TestMappingInput, optFns ...func(*b2bi.Options)) (*b2bi.TestMappingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) TestParsing(ctx context.Context, params *b2bi.TestParsingInput, optFns ...func(*b2bi.Options)) (*b2bi.TestParsingOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) UntagResource(ctx context.Context, params *b2bi.UntagResourceInput, optFns ...func(*b2bi.Options)) (*b2bi.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) UpdateCapability(ctx context.Context, params *b2bi.UpdateCapabilityInput, optFns ...func(*b2bi.Options)) (*b2bi.UpdateCapabilityOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) UpdatePartnership(ctx context.Context, params *b2bi.UpdatePartnershipInput, optFns ...func(*b2bi.Options)) (*b2bi.UpdatePartnershipOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) UpdateProfile(ctx context.Context, params *b2bi.UpdateProfileInput, optFns ...func(*b2bi.Options)) (*b2bi.UpdateProfileOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *B2biClient) UpdateTransformer(ctx context.Context, params *b2bi.UpdateTransformerInput, optFns ...func(*b2bi.Options)) (*b2bi.UpdateTransformerOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewB2biClient creates a new instance of B2biClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewB2biClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *B2biClient {
	mock := &B2biClient{}
