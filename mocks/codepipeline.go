...
// CodepipelineClient is an autogenerated mock type for the CodepipelineClient type
type CodepipelineClient struct {
	mock.Mock
}

// AcknowledgeJob provides a mock function with given fields: ctx, params, optFns
func (_m *CodepipelineClient) AcknowledgeJob(ctx context.Context, params *codepipeline.AcknowledgeJobInput, optFns ...func(*codepipeline.Options)) (*codepipeline.AcknowledgeJobOutput, error) {
...
func (_m *CodepipelineClient) AcknowledgeThirdPartyJob(ctx context.Context, params *codepipeline.AcknowledgeThirdPartyJobInput, optFns ...func(*codepipeline.Options)) (*codepipeline.AcknowledgeThirdPartyJobOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) CreateCustomActionType(ctx context.Context, params *codepipeline.CreateCustomActionTypeInput, optFns ...func(*codepipeline.Options)) (*codepipeline.CreateCustomActionTypeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) CreatePipeline(ctx context.Context, params *codepipeline.CreatePipelineInput, optFns ...func(*codepipeline.Options)) (*codepipeline.CreatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) DeleteCustomActionType(ctx context.Context, params *codepipeline.DeleteCustomActionTypeInput, optFns ...func(*codepipeline.Options)) (*codepipeline.DeleteCustomActionTypeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) DeletePipeline(ctx context.Context, params *codepipeline.DeletePipelineInput, optFns ...func(*codepipeline.Options)) (*codepipeline.DeletePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) DeleteWebhook(ctx context.Context, params *codepipeline.DeleteWebhookInput, optFns ...func(*codepipeline.Options)) (*codepipeline.DeleteWebhookOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) DeregisterWebhookWithThirdParty(ctx context.Context, params *codepipeline.DeregisterWebhookWithThirdPartyInput, optFns ...func(*codepipeline.Options)) (*codepipeline.DeregisterWebhookWithThirdPartyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) DisableStageTransition(ctx context.Context, params *codepipeline.DisableStageTransitionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.DisableStageTransitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) EnableStageTransition(ctx context.Context, params *codepipeline.EnableStageTransitionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.EnableStageTransitionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) GetActionType(ctx context.Context, params *codepipeline.GetActionTypeInput, optFns ...func(*codepipeline.Options)) (*codepipeline.GetActionTypeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) GetJobDetails(ctx context.Context, params *codepipeline.GetJobDetailsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.GetJobDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) GetPipeline(ctx context.Context, params *codepipeline.GetPipelineInput, optFns ...func(*codepipeline.Options)) (*codepipeline.GetPipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) GetPipelineExecution(ctx context.Context, params *codepipeline.GetPipelineExecutionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.GetPipelineExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) GetPipelineState(ctx context.Context, params *codepipeline.GetPipelineStateInput, optFns ...func(*codepipeline.Options)) (*codepipeline.GetPipelineStateOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) GetThirdPartyJobDetails(ctx context.Context, params *codepipeline.GetThirdPartyJobDetailsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.GetThirdPartyJobDetailsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) ListActionExecutions(ctx context.Context, params *codepipeline.ListActionExecutionsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListActionExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) ListActionTypes(ctx context.Context, params *codepipeline.ListActionTypesInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListActionTypesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) ListPipelineExecutions(ctx context.Context, params *codepipeline.ListPipelineExecutionsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListPipelineExecutionsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) ListPipelines(ctx context.Context, params *codepipeline.ListPipelinesInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListPipelinesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) ListTagsForResource(ctx context.Context, params *codepipeline.ListTagsForResourceInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListTagsForResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) ListWebhooks(ctx context.Context, params *codepipeline.ListWebhooksInput, optFns ...func(*codepipeline.Options)) (*codepipeline.ListWebhooksOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) Options() codepipeline.Options {
	ret := _m.Called()
...
func (_m *CodepipelineClient) PollForJobs(ctx context.Context, params *codepipeline.PollForJobsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PollForJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PollForThirdPartyJobs(ctx context.Context, params *codepipeline.PollForThirdPartyJobsInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PollForThirdPartyJobsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutActionRevision(ctx context.Context, params *codepipeline.PutActionRevisionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutActionRevisionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutApprovalResult(ctx context.Context, params *codepipeline.PutApprovalResultInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutApprovalResultOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutJobFailureResult(ctx context.Context, params *codepipeline.PutJobFailureResultInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutJobFailureResultOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutJobSuccessResult(ctx context.Context, params *codepipeline.PutJobSuccessResultInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutJobSuccessResultOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutThirdPartyJobFailureResult(ctx context.Context, params *codepipeline.PutThirdPartyJobFailureResultInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutThirdPartyJobFailureResultOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutThirdPartyJobSuccessResult(ctx context.Context, params *codepipeline.PutThirdPartyJobSuccessResultInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutThirdPartyJobSuccessResultOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) PutWebhook(ctx context.Context, params *codepipeline.PutWebhookInput, optFns ...func(*codepipeline.Options)) (*codepipeline.PutWebhookOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) RegisterWebhookWithThirdParty(ctx context.Context, params *codepipeline.RegisterWebhookWithThirdPartyInput, optFns ...func(*codepipeline.Options)) (*codepipeline.RegisterWebhookWithThirdPartyOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) RetryStageExecution(ctx context.Context, params *codepipeline.RetryStageExecutionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.RetryStageExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) StartPipelineExecution(ctx context.Context, params *codepipeline.StartPipelineExecutionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.StartPipelineExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) StopPipelineExecution(ctx context.Context, params *codepipeline.StopPipelineExecutionInput, optFns ...func(*codepipeline.Options)) (*codepipeline.StopPipelineExecutionOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) TagResource(ctx context.Context, params *codepipeline.TagResourceInput, optFns ...func(*codepipeline.Options)) (*codepipeline.TagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) UntagResource(ctx context.Context, params *codepipeline.UntagResourceInput, optFns ...func(*codepipeline.Options)) (*codepipeline.UntagResourceOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) UpdateActionType(ctx context.Context, params *codepipeline.UpdateActionTypeInput, optFns ...func(*codepipeline.Options)) (*codepipeline.UpdateActionTypeOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func (_m *CodepipelineClient) UpdatePipeline(ctx context.Context, params *codepipeline.UpdatePipelineInput, optFns ...func(*codepipeline.Options)) (*codepipeline.UpdatePipelineOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// NewCodepipelineClient creates a new instance of CodepipelineClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCodepipelineClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CodepipelineClient {
	mock := &CodepipelineClient{}
	mock.Mock.Test(t)
